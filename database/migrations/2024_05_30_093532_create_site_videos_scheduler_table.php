...
class CreateSiteVideosSchedulerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('site_videos_scheduler', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('site_videos_scheduler');
    }
}
