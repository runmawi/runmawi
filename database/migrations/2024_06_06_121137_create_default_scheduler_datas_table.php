...
class CreateDefaultSchedulerDatasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('default_scheduler_datas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('default_scheduler_datas');
    }
}
