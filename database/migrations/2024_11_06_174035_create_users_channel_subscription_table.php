...
class CreateUsersChannelSubscriptionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('users_channel_subscription', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('users_channel_subscription');
    }
}
