    ...
    public function run()
    {
        ...
        $Menu = [
                ...
                [   
                    'user_id' => 1, 
                    'order_id' => 37,
                    'video_name' => 'watchlater_videos' ,
                    'header_name' =>  ucwords('watchlater videos'), 
                    'url' => '',
                    'created_at' => Carbon::now(),
                    'updated_at' => null,
                ],
                ...
                [   
                    'user_id' => 1, 
                    'order_id' => 38,
                    'video_name' => 'wishlist_videos' ,
                    'header_name' => ucwords('wishlist videos'), 
                    'url' => '',
                    'created_at' => Carbon::now(),
                    'updated_at' => null,
                ],
                ...
                [   
                    'user_id' => 1, 
                    'order_id' => 39,
                    'video_name' => 'latest_episode_videos' ,
                    'header_name' => ucwords('latest episode & videos'), 
                    'url' => '',
                    'created_at' => Carbon::now(),
                    'updated_at' => null,
                ],
                ...
                [   
                    'user_id' => 1, 
                    'order_id' => 40,
                    'video_name' => 'live_artist' ,
                    'header_name' => ucwords('live stream artists'), 
                    'url' => '',
                    'created_at' => Carbon::now(),
                    'updated_at' => null,
                ],
