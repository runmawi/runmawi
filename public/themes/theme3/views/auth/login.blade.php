...
<body>
        ...
        <div class="container-fluid">
            <div class="row p-2 align-items-center">
                ...
                <div class="col-md-4 text-right">
                    <a data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="<?= URL::to('/login') ?>"
                        class=" mr-2" style="color:#fff!important;font-weight:500!important;">SIGN IN</a>
                    <button type="submit" class="btn signup"
                        style="color:#fff!important;font-size:16px;font-weight:700;border-radius:30px;">Subscribe
                        Now</button>
                </div>
            </div>
        </div>
    ...
    <section class="sign-in-page"
        style="background:url('<?php echo URL::to('/') . '/public/uploads/settings/' . $settings->login_content; ?>') no-repeat scroll 0 0;;background-size: cover;height:100vh;">
        <div class="container">
            <div id="myModal" class="modal fade" id="staticBackdrop" data-bs-backdrop="static"
                                        ...
                                        <div class="sign-user_card">
                                            <div class="sign-in-page-data">
                                                <div class="sign-in-from  m-auto" align="center">
                                                    ...
                                                    <div class="demo_cred">
                                                        <p class="links"
                                                            style="font-weight: 600; border-bottom: 2px dashed #fff;">
                                                            Demo Login</p>
                                                        <p class="links"><strong>Email</strong>: admin@admin.com</p>
                                                        <p class="links mb-0"><strong>Password</strong>: Webnexs123!@#
                                                        </p>
                                                    </div>
                                                    <?php } else  { ?>
                                                    <?php } ?>
                                                    ...
                                                    @if (count($errors) > 0)
                                                        @foreach ($errors->all() as $message)
                                                            <div class="alert alert-danger display-hide"
                                                                id="successMessage">
                                                                <button id="successMessage" class="close"
                                                                    data-close="alert"></button>
                                                                <span>{{ $message }}</span>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                    <a class="sig text-white mt-3" href="{{ route('signup') }}"
                                                        style=""> Do you have an Flicknexs account? </a>
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-11">
                                                                <div role="group" class="form-group">
                                                                    ...
                                                                    <label for="year"
                                                                        class="d-block form-control-placeholder"
                                                                        required="required">{{ __('Email Address') }}</label>
                                                                </div>
                                                                ...
                                                                <div class="form-group" style="  margin-top: 20px;">    
                                                                    <div role="group" class="form-group">
                                                                        ...
                                                                        <label for="year"
                                                                            class="d-block form-control-placeholder"
                                                                            required="required">{{ __('PASSWORD') }}</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="sign-info mt-5 mb-3">
                                                                    <button type="submit" class="btn signup"
                                                                        style="width:80%;color:#fff!important;letter-spacing: 1.5px;font-size:20px;">SIGN
                                                                        IN</button>
                                                                </div>
                                                                <div class="links text-center mt-3">
                                                                        <a href="{{ route('Reset_Password') }}"
                                                                            class="f-link">Can't Login?</a>
                                                                </div>

                                                                <div class="row align-items-center mt-3">
                                                                    <div class="col-md-5 p-0"> <img class="w-100"
                                                                            src="<?php echo URL::to('/assets/img/l3.png'); ?>"></div>
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="d-flex justify-content-center  links">
                                                                    ...
                                                                    <p class="text-left agree">By continuing, you agree
                                                                        terms and conditions and privacy notes</p>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" id=""
                                                                        name="" value=""
                                                                        class="mb-2 mr-1" checked>
                                                                    <label for="vehicle1"> Keep me signed
                                                                        in</label><br>
                                                                </div>
                                                            </div>
                                                        </div>
