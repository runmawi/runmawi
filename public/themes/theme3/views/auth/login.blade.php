...
<body>
    ...
    <section class="sign-in-page" style="background:url('{{ URL::to('/') }}/public/uploads/settings/{{ $settings->login_content }}') no-repeat scroll 0 0; background-size: cover;">
        <div class="container">
            <div class="login-div row mb-4 align-items-center height-self-center">
                <div class="col-lg-7 col-12">
                    <h1 class="km">{{ $settings->login_text }}</h1>
                </div>
                            ...
                            <div class="sign-in-from m-auto" align="center">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        @if ($theme_mode == "light" && !empty($theme->light_mode_logo))
                                            <img alt="apps-logo" class="apps" src="{{ URL::to('/') }}/public/uploads/settings/{{ $theme->light_mode_logo }}" style="margin-bottom:1rem;">
                                        @elseif($theme_mode != "light" && !empty($theme->dark_mode_logo))
                                            <img alt="apps-logo" class="apps" src="{{ URL::to('/') }}/public/uploads/settings/{{ $theme->dark_mode_logo }}" style="margin-bottom:1rem;">
                                        @else
                                            <img alt="apps-logo" class="apps" src="{{ URL::to('/') }}/public/uploads/settings/{{ $settings->logo }}" style="margin-bottom:1rem;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="mt-4">
                                    ...
                                    <div class="form-group">
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="{{ __('E-Mail') }}" value="{{ old('email') }}" autocomplete="email" autofocus>
                                    </div>
                                    ...
                                    <div class="position-relative">
                                        <span class="input-group-btn" id="eyeSlash">
                                            <button class="btn btn-theme3 reveal" onclick="visibility1()" type="button"><i class="fa fa-eye-slash" aria-hidden="true"></i></button>
                                        </span>
                                        <span class="input-group-btn" id="eyeShow" style="display: none;">
                                            <button class="btn btn-theme3 reveal" onclick="visibility1()" type="button"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        </span>
                                    </div>
                                    ...
                                    <div class="sign-info">
                                        <button type="submit" class="btn btn-hover ab" style="width:100%;color:#fff!important;">{{ __('LOGIN') }}</button>
                                    </div>
                                            ...
                                            @if ($system_settings != null && $system_settings->facebook == 1)
                                                <div>
                                                    <a href="{{ url('/auth/redirect/facebook') }}" class="">
                                                        <img alt="apps-logo" src="{{ URL::to('/') }}/assets/img/fb.png" width="30" style="margin-bottom:1rem;">
                                                    </a>
                                                </div>
                                            @endif
                                            ...
                                            @if ($system_settings != null && $system_settings->google == 1)
                                                <div>
                                                    <a href="{{ url('/auth/redirect/google') }}" class="">
                                                        <img alt="apps-logo" src="{{ URL::to('/') }}/assets/img/google.png" width="30" style="margin-bottom:1rem;">
                                                    </a>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <div class="">
                                    <div class="text-left links">
                                        {{ __("Not having an account ?") }} <a href="{{ route('signup') }}" class="text-primary ml-2">{{ __('Click Here') }}</a> {{ ' to Sign Up!'}}
                                    </div>
                                </div>
                            </div>
                        </div>
