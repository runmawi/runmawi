  ...
  M57.5,45.6L55,48l0.6,3.5l-3.1-1.7l-3.1,1.7L50,48l-2.5-2.4l3.5-0.5l1.5-3.1l1.5,3.1L57.5,45.6z" />
    ...
    <head>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-8">
                                            <input type="text" name="tv_code" id="tv_code"
                                                value="@if (!empty($UserTVLoginCode->tv_code)) {{ $UserTVLoginCode->tv_code . ' ' . $UserTVLoginCode->uniqueId }} @endif" />
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-right">
                                    <a type="button" class="text-white font-size-13" data-toggle="collapse"
                                        data-target="#user_DOB">Add</a>
                                </div>
                            </div>


                            <form id="DOB" accept-charset="UTF-8" action="{{ URL::to('user/DOB') }}"
                                enctype="multipart/form-data" method="post">
                                @csrf
                                <input type="hidden" name="users_id" value="{{ $user->id }}" />
                                <input type="hidden" name="email" value="{{ $user->email }}" />
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-8">
                                            <input type="date" id="DOB" name="DOB"
                                                value="@if (!empty($user->DOB)) {{ $user->DOB }} @endif">
                        ...
                        <div class="row align-items-center justify-content-end">
                            <div class="col-md-8 d-flex justify-content-between mt-1 mb-2">
                              ...
                              <div class="mt-3 row align-items-center">
                                  ...
                                  <div class="col-md-9"> <!-- <form action="<?php if (isset($ref)) {
                                      echo URL::to('/') . '/register1?ref=' . $ref . '&coupon=' . $coupon;
                                  } else {
                                      echo URL::to('/') . '/register1';
                                  } ?>" method="POST" id="stripe_plan" class="stripe_plan" name="member_signup" enctype="multipart/form-data">
        ...
        <div class="col-sm-12 mt-4 text-center targetDiv" id="div2">
            ...
            <?php }else{ ?>
            <div class="d-flex justify-content-center"> <img class="rounded-circle img-fluid d-block  mb-3"
                    height="100" width="100" src="<?= $user->provider_avatar ?>" alt="profile-bg" /></div>
            <?php } ?>
            <h4 class="mb-3"><?php if(!empty($user->username)): ?><?= $user->username ?><?php endif; ?></h4>
                    ...
                    <div class="sign-user_card" style="height: 400px;">
                       ...
                       <?php  if($user_role == 'registered'){ ?>
                           ...
                           <?php }elseif($user_role == 'subscriber'){ ?>
                              ...
                              <br>
                           <h5 class="card-title mb-0">Available Specification :</h5><br>
                           <h6> Video Quality : <p> <?php if ($plans != null) {
                               $plans->video_quality;
                           } else {
                               ' ';
                           } ?></p></h6>
                           <h6> Video Resolution : <p> <?php if ($plans != null) {
                               $plans->resolution;
                           } else {
                               ' ';
                           } ?>  </p></h6>
                           <h6> Available Devices : <p> <?php if ($plans != null) {
                               $plans->devices_name;
                           } else {
                               ' ';
                           } ?> </p></h6>
