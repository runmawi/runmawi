    ...
    <div class="row justify-content-center page-height">	
			...
			<div class="login-block ">
                ...
                <div class="d-flex justify-content-between">
                    <h4 class="my_profile text-black" style="color: #000 !important;"> <i class="fa fa-edit"></i> {{  __('Transaction History') }}</h4>
                    <a href="<?php echo URL::to('/myprofile') ?>">
                    <button class="btn btn-primary">{{ __('Back') }}</button></a>
                </div>
                <hr>
                <!-- <div class="bg-strip">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 style="color: black;">Make payment</h5>
                        </div>
                    </div>
