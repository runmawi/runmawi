        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.data.status == true) {
                    ...
                    const iconClass = response.data.watchlater_status == "Add" ? 'fal fa-minus' : 'ri-add-circle-fill';
                    ...
                    $('.video-watchlater').removeClass('fal fa-minus ri-add-circle-fill').addClass(iconClass);
