@php
     ...
     include( public_path('themes/theme3/views/video-js-Player/Livestream/live-ads.blade.php'));
     include( public_path('themes/theme3/views/video-js-Player/Livestream/live-player-script.blade.php'));
@endphp
...
<!-- Style -->
<link rel="preload" href="{{ URL::to('public/themes/theme3/assets/css/style.css') }}" as="style">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-xs-12">
                        <ul class="list-inline p-0 mt-4 share-icons music-play-lists">
                                ...
                                <?php include(public_path('themes/theme3/views/partials/live-social-share.php')) ; ?>                   
                        </ul>
                    </div>
                </div>
            ...
            <?php if( App\CommentSection::first() != null && App\CommentSection::pluck('livestream')->first() == 1 ): ?>
                <div class="">
                    <div class=" mar-left video-list you-may-like overflow-hidden mt-3">
                        ...
                        <?php include(public_path('themes/theme3/views/comments/index.blade.php')) ; ?>                   
                    </div>
                </div>
            <?php endif; ?>
            ...
            @if ( count($Related_videos) > 0 )
                <div class="">
                    <div class=" video-list you-may-like overflow-hidden">
                        ...
                        <div class="slider">   
                        <?php include(public_path('themes/theme3/views/partials/live_related_video.blade.php')) ; ?>
                        </div>
                    </div>
                </div>
            @endif
