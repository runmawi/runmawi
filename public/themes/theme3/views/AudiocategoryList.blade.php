                    ...
                    <ul class="favorites-slider list-inline  row p-0 mb-0">
                        @if(isset($category_list)) 
                            @foreach($category_list as $category_lists)
                                <li class="slide-item">
                                    <a href="{{ URL::to('/audios/category').'/'.$category_lists->slug   }}">
                                        <div class="block-images position-relative">
                                            <div class="img-box">
                                                <img src="<?php echo URL::to('/').'/public/uploads/audios/'.$category_lists->image;  ?>" class="img-fluid" alt="">
                                            </div>
                                            <div class="block-description">
                                                
                                            <div class="hover-buttons">
                                                <a class="" href="{{ URL::to('/audios/category').'/'.$category_lists->slug   }}">
                        ...
                        @foreach($category_list as $category_lists)
                            <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                                <a href="{{ URL::to('/audios/category').'/'.$category_lists->slug   }} ">
                                    <div class="block-images position-relative">
                                        <div class="img-box">
                                            <img src="<?php echo URL::to('/').'/public/uploads/audios/'.$category_lists->image;  ?>" class="img-fluid w-100" alt="">
                                        </div>
