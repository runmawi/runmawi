                    ...
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <div id="menuToggle">
                                ...
                                <span></span>
                                <span></span>
                                <ul id="menu" class="overflow-scroll nav navbar-nav <?php if (Session::get('locale') == 'arabic') {
                                    echo 'navbar-right';
                                } else {
                                    echo 'navbar-left';
                                } ?>">
                            ...
                            <a href="<?php echo URL::to('/') . '/searchResult'; ?>" class="search-toggle device-search mt-1"
                            ...
                            <form role="search" action="<?php echo URL::to('/') . '/searchResult'; ?>" method="POST">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="search" class="searches" id="searches"
                                        autocomplete="off" placeholder="Search movies,series">
                                </div>
                            </form>
                        </div>
