...
if (empty($new_date) || Auth::user()->role == 'admin') {
    ...
    if (!Auth::guest()) {
        ...
        if (
            !empty($ppv_video_play) || $video_access == 'free' || Auth::user()->role == 'registered' ||
            ...
            if (
                $ppv_exist > 0 || $video_access == 'free' || Auth::user()->subscribed() && $video->type != "" ||
                    ...
                    <div class=" page-height">
                            ...
                            <?php elseif ($video->type == ''): ?>
                                ...
                                <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                    ...
                                    <video <?= $autoplay ?> muted id="video" crossorigin playsinline allow="autoplay" class="adstime_url"
                                        ...
                                        <source src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '.m3u8'; ?>"
                                    ...
                                    <input type="hidden" id="hls_m3u8" name="hls_m3u8"
                                        value="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '.m3u8'; ?>">
                                </div>
                            </div>
                        ...
                        <?php elseif ($video->type == 'aws_m3u8'): ?>
                            ...
                            <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                ...
                                <video <?= $autoplay ?> muted id="video" allow="<?= $autoplay ?>" crossorigin playsinline class="adstime_url"
                                    poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                    data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                        ...
                        <?php elseif ($video->type == 'mp4_url'): ?>
                            ...
                            <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                <video id="videoPlayer" muted <?= $autoplay ?> class="adstime_url"
                                    poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                    data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                        ...
                        <?php else: ?>
                            ...
                            <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                <video id="videoPlayer" muted class="adstime_url"
                                    poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                    data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                    ...
                    <?php else: ?>
                        ...
                        <div id="subscribers_only">
                            <div class="container-fluid">
                                ...
                                <h4>Sorry, this video is only available to
                                ...
                                <?php else: ?>
                                    ...
                                    <form method="get" action="<?= URL::to('signup') ?>">
                                        <button id="button">Signup Now <?php if ($video->access == 'subscriber'): ?>to Become a
                                                Subscriber<?php elseif ($video->access == 'registered'): ?>for
            ...
            <?php } elseif (
                $ppv_exist > 0 || $video_access == 'free' || Auth::user()->subscribed() && $pack == "Business" || Auth::user()->role == 'admin' && $pack == "Business" || Auth::user()->role == "subscriber" && $pack == "Business"
                ...
                if (!empty($video->path)) { ?>
                    ...
                    <div id="video_container" class="fitvid" style="z-index: 9999;">
                        <video id="video" autoplay muted class="adstime_url" controls crossorigin playsinline
                            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                ...
                <?php if ($video->type == 'embed'): ?>
                    ...
                    <div id="subscribers_only"
                        style="background: linear-gradient(rgba(0,0,0, 0),rgba(0,0,0, 100)), url(<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>); background-repeat: no-repeat; background-size: cover; height: 500px; margin-top: 20px;padding-top:150px;">
                        <div class="container-fluid">
                            <h2 class="text-left"><?php echo $video->title; ?></h2>
                ...
                <?php elseif ($video->type == '' && ($video->processed_low != 100 || $video->processed_low == null)): ?>
                    ...
                    <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                        <video id="" class="adstime_url" muted
                            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                            data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                ...
                <?php elseif ($video->type == '' && ($video->processed_low == 100 || $video->processed_low != null)): ?>
                    ...
                    <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                        ...
                        <video id="PPV_free_duration_videoPlayer" controls crossorigin playsinline
                            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                            data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'>
                            <source type="application/x-mpegURL"
                                src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '.m3u8'; ?>">
                ...
                <?php elseif ($video->type == 'mp4_url'): ?>
                    ...
                    <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                        <video id="PPV_free_duration_videoPlayer_MP4"
                            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                            data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                            <track kind="captions" label="English captions" src="/path/to/captions.vtt" srclang="en" default />
                            <source src="<?php if (!empty($video->mp4_url)) {
                ...
                <?php elseif ($video->type == 'm3u8_url'): ?>
                    ...
                    <video id="PPV_free_duration_videoPlayer_M3U8_url" allow="<?= $autoplay ?>"
                        poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                        data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                        <source src="<?php if (!empty($video->m3u8_url)) {
                            echo $video->m3u8_url;
                ...
                <div id="subscribers_only"
                    style="background: linear-gradient(rgba(0,0,0, 0),rgba(0,0,0, 100)),url(<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>); background-position:center; background-repeat: no-repeat; background-size: cover; height: 500px; margin-top: 20px;">
                    <div id="subscribers_only">
                        <div class="clear"></div>
                        <div class="container-fluid">
                            ...
                            <div style="padding-top:8%;">
                                ...
                                <h4>
                                    ...
                                    <?php if ($video->access == 'subscriber'): ?>                <?php elseif ($video->access == 'registered'): ?>Registered
                                        Users<?php endif; ?>
                                </h4>
                                    ...
                                    <?php } elseif (Auth::guest()) { ?>
                                        ...
                                        <form method="get" action="<?= URL::to('signup') ?>">
                                            <button id="button" style="margin-top: 0%;">Signup Now
                                                <?php if ($video->access == 'subscriber'): ?>to Purchase this video
                ...
                <div id="subscribers_only"
                    ...
                    <div id="subscribers_only">
                        ...
                        <div style="position: absolute;top: 20%;left: 20%;width: 100%;">
                            ...
                            <?php if (!Auth::guest() && $video->ppv_price != '' && $video->ppv_price != null || $video->global_ppv == 1) { ?>
                                <button style="margin-top: 1%;" data-toggle="modal" data-target="#exampleModalCenter"
                                    bclass="view-count rent-video btn btn-primary">
                                    <?php echo __('Purchase Now'); ?>
                                </button>
                            <?php } ?>
                        ...
                        <?php } else if ($video->access == 'subscriber' && $video->global_ppv == 1 && Auth::user()->role == 'subscriber') { ?>
                                ...
                                <div id="subscribers_only"
                                    ...
                                    <div id="subscribers_only">
                                        ...
                                        <?php if (!Auth::guest() && $video->access == 'subscriber' || !Auth::guest() && $video->access == 'ppv' || !Auth::guest() && $video->access == 'guest' && !empty($video->ppv_price)) { ?>
                                                ...
                                                <form method="get" action="<?= route('payment_becomeSubscriber') ?>">
                                                    <button style="margin-left: 27%;margin-top: 0%;" class="btn btn-primary"
                                                        id="button">Purchase to watch this video
                                                    </button>
                                                </form>
                                        ...
                                        <?php } else { ?>
                                                ...
                                                <form method="get" action="<?= URL::to('signup') ?>">
                                                    <button id="button" style="margin-top: 0%;">Signup Now
                                                    <?php if ($video->access == 'subscriber'): ?>to Purchase
                                        ...
                                        <?php if ($video->type == 'embed'): ?>
                                                ...
                                                <div id="subscribers_only"
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div>
                                                            <a href="<?= URL::to('/signup') ?>" class="btn btn-primary">Become a Subscriber to
                                                                watch this vide</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <?php elseif ($video->type == '' && ($video->processed_low != 100 || $video->processed_low == null)): ?>
                                                ...
                                                <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                                    <video id="" <?= $autoplay ?> class="adstime_url"
                                                        poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                                        data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                                                        ...
                                                        <source
                                                            src="<?php if (!empty($video->mp4_url)) {
                                                                echo $video->mp4_url;
                                                            } else {
                                                                echo $video->trailer;
                                                            } ?>"
                                        ...
                                        <?php elseif ($video->type == '' && ($video->processed_low == 100 || $video->processed_low != null)): ?>
                                                ...
                                                <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                                    ...
                                                    <video id="PPV_free_duration_videoPlayer" <?= $autoplay ?> controls crossorigin playsinline
                                                        poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                                        data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'>
                                                        <source type="application/x-mpegURL"
                                                            src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '.m3u8'; ?>">
                                        ...
                                        <?php elseif ($video->type == 'mp4_url'): ?>
                                                ...
                                                <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                                    <video id="PPV_free_duration_videoPlayer_MP4" <?= $autoplay ?>
                                                        poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                                        data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                                                        <track kind="captions" label="English captions" src="/path/to/captions.vtt" srclang="en"
                                                            default />
                                        ...
                                        <?php elseif ($video->type == 'm3u8_url'): ?>
                                                ...
                                                <video <?= $autoplay ?> id="PPV_free_duration_videoPlayer_M3U8_url" allow="<?= $autoplay ?>"
                                                    poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                                    data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                                                    <source
                                                        src="<?php if (!empty($video->m3u8_url)) {
                                                            echo $video->m3u8_url;
                                                        } else {
                                                            echo $video->trailer;
                                                        } ?>"
                                            ...
                                            <div id="subscribers_only"
                                                ...
                                                <div id="subscribers_only">
                                                    ...
                                                    <?php if (!Auth::guest() && $video->access == 'subscriber') { ?>
                                                            <form method="get" action="<?= route('payment_becomeSubscriber') ?>">
                                                                <button style="margin-left: 27%;margin-top: 0%;" class="btn btn-primary"
                                                                    id="button">Purchase to watch this
                                                                    video</button>
                                                            </form>
                                                    ...
                                                    <?php } elseif (Auth::guest()) { ?>
                                                            <form method="get" action="<?= URL::to('signup') ?>">
                                                                <button id="button" style="margin-top: 0%;">Signup Now
                                                                <?php if ($video->access == 'subscriber'): ?>to Purchase this video
                                                                <?php elseif ($video->access == 'registered'): ?>for
                                                                        Free!<?php endif; ?></button>
                                                            </form>
                                                    <?php }
                                ...
                                <div id="subscribers_only"
                                    ...
                                    <div id="subscribers_only">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <form method="get" action="<?= URL::to('signup') ?>">
                                                <button id="button">Signup Now <?php if ($video->access == 'subscriber'): ?>to Become
                                                        a
                                                        Subscriber<?php elseif ($video->access == 'registered'): ?>for
                                                        Free!<?php endif; ?></button>
                                            </form>
                                ...
                                <div id="subscribers_only"
                                    style="background: linear-gradient(rgba(0,0,0, 0.5),rgba(0,0,0, 100)), url(<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>); background-repeat: no-repeat; background-size: cover; height: 550px; margin-top: 20px;padding-top:100px;">
                                    ...
                                    <p class="countdown mb-0" id="demo"></p>
                                    <hr>
                                </div>
                            <?php } ?>
                            ...
                            <?php if (Auth::guest()) { ?>
                                ...
                                <div id="video" class="adstime_url" class="fitvid" style="margin: 0 auto;">
                                    <video id="videoPlayer" class="adstime_url" muted
                                ...
                                <?php if (Auth::guest()): ?>
                                    ...
                                    <?php elseif ($video->type == 'file'): ?>
                                        ...
                                        <div id="video sda" class="fitvid" style="margin: 0 auto;">
                                            ...
                                            <video id="videoPlayer" muted <?= $autoplay ?> class=""
                                                poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>"
                                                controls data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'
                                                src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '.m3u8'; ?>"
                                                type="application/x-mpegURL">
                                                <source
                                                    src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '_1_500.m3u8'; ?>"
                                                    type='application/x-mpegURL' label='360p' res='360' />
                                                <source
                                                    src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '_0_250.m3u8'; ?>"
                                                    type='application/x-mpegURL' label='480p' res='480' />
                                                <source
                                                    src="<?php echo URL::to('/storage/app/public/') . '/' . $video->path . '_2_1000.m3u8'; ?>"
                                    ...
                                    <?php elseif ($video->type == 'aws_m3u8'): ?>
                                        ...
                                        <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                            <video <?= $autoplay ?> muted id="video" allow="<?= $autoplay ?>" class="adstime_url"
                                                poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>"
                                                controls data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'
                                                type="video/mp4">
                                                <source src="<?php echo $video->m3u8_url; ?>" type='application/x-mpegURL'
                                                    label='auto'>
                                    ...
                                    <?php elseif ($video->type == 'm3u8_url'): ?>
                                        ...
                                        <video <?= $autoplay ?> muted id="video" class="adstime_url"
                                            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                                            data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                                            ...
                                            <video <?= $autoplay ?> id="videoPlayer" muted class="adstime_url"
                                                poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>"
                                                controls data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'
                                                src="<?php echo $video->trailer; ?>" type="video/mp4">
                        ...
                        <?php if (!empty($video->url_link)) { ?>
                            <div class="text-white" id="url_linkdetails">
                                <p class="trending-dec w-100 mb-0 text-white"><a href="<?php echo __($video->url_link); ?>"
                                        target="_blank" data-toggle="tooltip" data-placement="left" title=<?php echo __($video->url_link); ?> class="fa fa-info-circle">
                                    </a></p>
                            </div>
                        <?php } ?>
                        ...
                        <div class=" page-height">
                            ...
                            <div class="container-fluid video-details">
                                                ...
                                                <ol class="breadcrumb">
                                                    ...
                                                    <?php foreach ($category_name as $key => $video_category_name) { ?>
                                                        ...
                                                        <li class="breadcrumb-item">
                                                            <a class="black-text"
                                                                href="<?= route('video_categories', [$video_category_name->categories_slug]) ?>">
                                ...
                                <?php if (!empty($video->pdf_files)) { ?>
                                    ...
                                    <div class="text-white">
                                        <a href="<?php echo __(URL::to('/') . '/public/uploads/videoPdf/' . $video->pdf_files); ?>"
                                            style="font-size:48px; color: #a51212 !important;"
                                            class="fa fa-file-pdf-o video_pdf" width="" height="" download></a>
                                    </div>
                                <?php } ?>
                                                    ...
                                                    <li class="slide-item ">
                                                        <a
                                                            ...
                                                            <div class="block-images position-relative">
                                                                ...
                                                                <div class="">
                                                                    <a
                                                                        href="<?php echo __(URL::to('/') . '/artist/' . $artist->artist_slug); ?>"></a>
                                                                </div>
                                                            </div>
           ...
           <p class="trending-dec w-100 mb-0 text-white"><?php echo __($video->description); ?></p>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title text-center" id="exampleModalLongTitle" style="">
                                                    Rent Now</h4>
                                            ...
                                            <div class="modal-body">
                                                <div class="row justify-content-between">
                                                    <div class="col-sm-4 p-0" style="">
                                                        <img class="img__img w-100"
                                                            src="<?php echo URL::to('/') . '/public/uploads/images/' . $video->image; ?>"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <a type="button" class="mb-3 mt-3" data-dismiss="modal"
                                                            style="font-weight:400;">Amount: <span class="pl-2"
                                                                ...
                                                                <?php if ($video->access == 'ppv' && $video->ppv_price != null && $CurrencySetting == 1) {
                                                                    echo __(Currency_Convert(@$video->ppv_price));
                                                                } else if ($video->access == 'ppv' && $video->ppv_price != null && $CurrencySetting == 0) {
                                                                    echo __(@$video->ppv_price);
                                                                } ?></span></a><br>
                                                        ...
                                                        if (
                                                            @$Razorpay_payment_settings->payment_type == "Razorpay" || @$Stripepayment->payment_type == "Stripe" || @$PayPalpayment->payment_type == "PayPal"
                                                            ...
                                                            <?php } elseif ($Stripepayment != null && $Stripepayment->live_mode == 0 && $Stripepayment->stripe_status == 1) { ?>
                                                                <!-- Stripe - Test Mode -->
                                                            ...
                                                            <?php } elseif ($PayPalpayment != null && $PayPalpayment->paypal_live_mode == 0 && $PayPalpayment->paypal_status == 1) { ?>
                                                                <!-- paypal - Test Mode -->
                                            ...
                                            <div class="modal-footer">
                                                <div class="Stripe_button">
                                                    ...
                                                    <a
                                                        onclick="pay(<?php if ($video->access == 'ppv' && $video->ppv_price != null && $CurrencySetting == 1) {
                                                            echo PPV_CurrencyConvert($video->ppv_price);
                                                        } else if ($video->access == 'ppv' && $video->ppv_price != null && $CurrencySetting == 0) {
                                                            echo __(@$video->ppv_price);
                                                        } ?>)">
                                                        <button type="button"
                                ...
                                <?php if (isset($videos_category_next)) { ?>
                                    <div class="next_cat_video" style="display: none;">
                                        <?= $videos_category_next->slug ?>
                                    </div>
                                <?php } elseif (isset($videos_category_prev)) { ?>
                                    <div class="prev_cat_video" style="display: none;">
                                        <?= $videos_category_prev->slug ?>
                                    </div>
                                <?php } ?>
...
-->
                        ...
                        <div class=" container-fluid video-list you-may-like overflow-hidden">
                            <h4 class="Continue Watching" style="color:#fffff;"><?php echo __('Recomended Videos'); ?>
                            </h4>
                            <div class="slider"
                                data-slick='{"slidesToShow": 4, "slidesToScroll": 4, "autoplay": false}'>
