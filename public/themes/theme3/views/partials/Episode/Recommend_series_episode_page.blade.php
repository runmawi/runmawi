...
<div class="favorites-contens">
    <ul class="favorites-slider list-inline  row p-0 mb-0">
        <?php  foreach($series_lists as $series_list): ?>
            <li class="slide-item">
                ...
                <a href="<?php echo URL::to('play_series/'. $series_list->slug); ?>">
                    ...
                    <div class="mt-2">
                        <div class="movie-time d-flex align-items-center  my-2">
                            <a href="<?php echo URL::to('play_series/'. $series_list->slug); ?> ">
                                <h6 class="mr-1"><?php echo strlen($series_list->title) > 15 ? substr($series_list->title, 0, 15) . '...' : $series_list->title; ?> </h6>
                            </a>
                        ...
                        <span class="text-white">
                            ...
                            <?= gmdate('H:i:s', $series_list->duration) ?>
                        </span>
                    </div>
