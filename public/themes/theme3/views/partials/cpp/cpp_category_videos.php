        ...
        <div class="row">
            <div class="col-sm-12 page-height">
                <div class="iq-main-header align-items-center justify-content-between">
                    <h4 class="vid-title">Video Category</h4>                     
                </div>
                            ...
                            <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                                <a href="<?php echo URL::to('category').'/'.$videos_Category->slug  ?> ">
                                    <div class="block-images position-relative">
                                        <div class="img-box">
                                            <img src="<?php echo URL::to('/').'/public/uploads/images/'.@$videos_Category->image;  ?>" class="img-fluid w-100" alt="">
                                        </div>
                            
                                        <div class="block-description" >
                                                <a href="<?php echo URL::to('category').'/'.$videos_Category->slug  ?>">
                                                    <h6><?php  echo (strlen(@$videos_Category->title) > 17) ? substr(@$videos_Category->title,0,18).'...' : @$videos_Category->title; ?></h6>
                                                </a>
