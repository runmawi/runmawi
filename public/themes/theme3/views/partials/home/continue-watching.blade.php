            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title"><a href="<?php echo URL::to('continue-watching-list') ?>">{{ ucwords('continue watching') }}</a></h4>
                        <h4 class="main-title"><a href="<?php echo URL::to('continue-watching-list') ?>">{{ ucwords('view all') }}</a></h4>
                    </div>
