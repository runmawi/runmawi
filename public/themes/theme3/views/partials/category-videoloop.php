                ...
                <ul class="favorites-slider list-inline row p-0 mb-0">
                    ...
                    <?php  if(isset($Episode_videos)) :
                       foreach($Episode_videos as $Episode): ?>
                        <li class="slide-item">
                            <div class="block-images position-relative">  <!-- block-images -->
                                <a href="<?php echo URL::to('episode/play_series') ?><?= '/'.$Episode->series_title->slug .'/'. $Episode->slug ?>">
                            ...
                            <div class="block-description">
                                <div class="hover-buttons">
                                    <a type="button" class="text-white btn-cl" href="<?php echo URL::to('episode/play_series') ?><?= '/'.$Episode->series_title->slug .'/'. $Episode->slug ?>">
                                        <img class="ply" src="<?php echo URL::to('/').'/assets/img/default_play_buttons.svg';  ?>" />
                                    </a>
                                </div>
                            </div>
