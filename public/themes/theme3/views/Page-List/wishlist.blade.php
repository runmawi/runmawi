                            ...
                            @forelse($wishlist_pagelist as $key => $wishlist)
                                <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                                    <div class="block-images position-relative">
                                        ...
                                        <a href="{{ URL::to('category/videos/'.$wishlist->slug ) }}">

                                            <div class="img-box">
                                                <img src="{{ $wishlist->image ?  URL::to('public/uploads/images/'.$wishlist->image) : default_vertical_image_url() }}" class="img-fluid" alt="">
                                            </div>
                                            <div class="block-description">
                                                

                                                <div class="hover-buttons">
                                                    <a class="" href="{{ URL::to('category/videos/'.$wishlist->slug ) }}">
