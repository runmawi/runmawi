   ...
   {{-- <div id="loading">
      ...
      <div class="main-content">
         ...
         @forelse ($order_settings as $key => $item)
            ...
            @if( $item == 'latest_videos' && $home_settings->latest_videos == 1 ) 
            ...
            @if( $item == 'featured_videos' && $home_settings->featured_videos == 1 ) 
            ...
            @if( $item == 'live_videos' && $home_settings->live_videos == 1 ) 
                     ...
                     <div class="topten-contens">
                        ...
                        <ul id="top-ten-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                           <li>
                              ...
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/01.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.html">
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/02.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.html">
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/03.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.html">
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/04.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.html">
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/05.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                           <li>
                              <a href="movie-details.html">
                              <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/top-10/06.jpg" class="img-fluid w-100" alt="">
                              </a>
                           </li>
                        </ul>
                        ...
                        <ul class="list-inline favorites-slider row p-0 mb-0">
                           <li class="slide-item">
                              <a href="movie-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/suggested/01.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Blood Block</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/suggested/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Mission Moon</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/suggested/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Unknown Land</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/suggested/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Friends</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="movie-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/suggested/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/01.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/02.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/03.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/04.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/05.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                           <li>
                              <a href="javascript:void(0);">
                                 <div class="movie-slick position-relative">
                                    <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/06.jpg" class="img-fluid" alt="">
                                 </div>
                              </a>
                           </li>
                        </ul>
                        <ul id="trending-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/01.jpg);">
                                       ...
                                       <div id="trending-data1" class="overview-tab tab-pane fade active show">
                                          <div class="trending-info align-items-center w-100 animated fadeInUp">
                                             ...
                                             <div class="d-flex align-items-center series mb-4">
                                                <a href="javascript:void(0);"><img src="https://localhost/flicknexs/public/themes/theme6/assets/images/trending/trending-label.png"
                                       ...
                                       <div id="trending-data2" class="overlay-tab tab-pane fade">
                                          <div
                                             ...
                                             <a href="show-details.html" tabindex="0">
                                                <div class="channel-logo">
                                                   <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/logo.png" class="c-logo" alt="stramit">
                                                </div>
                                             </a>
                                             <h1 class="trending-text big-title text-uppercase">the hero camp</h1>
                                                ...
                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.html">
                                                         <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/episodes/01.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.html">
                                                         <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/episodes/02.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.html">
                                                         <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/episodes/03.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.html">
                                                         <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/episodes/04.jpg" class="img-fluid" alt="">
                                                         </a>
                                                   ...
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         <a href="show-details.html">
                                                         <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/episodes/05.jpg" class="img-fluid" alt="">
                                                         </a>
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/02.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/03.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/04.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/05.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                           ...
                           <li>
                              <div class="tranding-block position-relative"
                                 style="background-image: url(https://localhost/flicknexs/public/themes/theme6/assets/images/trending/06.jpg);">
                                 <div class="trending-custom-tab">
                                    <div class="tab-title-info position-relative">
                                       <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center"
                                          role="tablist">
                        ...
                        <ul class="favorites-slider list-inline row p-0 mb-0">
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/tvthrillers/01.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/tvthrillers/02.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/tvthrillers/03.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Arrival 1999</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/tvthrillers/04.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h6>Night Mare</h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                           ...
                           <li class="slide-item">
                              <a href="show-details.html">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/tvthrillers/05.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
