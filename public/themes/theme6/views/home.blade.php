      ...
      <div class="main-content">
         ...
         @forelse ($order_settings as $key => $item) 
            ...
            @if( $item == 'latest_viewed_Videos' && $home_settings->latest_viewed_Videos == 1 ) {{-- Latest Viewed Videos --}}
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/latest_viewed_Videos', [ 'order_settings_list' => $order_settings_list ])->content() !!}
            @endif
            
            @if( $item == 'latest_viewed_Livestream' && $home_settings->latest_viewed_Livestream == 1 ) {{-- Latest Viewed Livestream    --}}
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/latest_viewed_Livestream', [ 'order_settings_list' => $order_settings_list ])->content() !!}
            @endif
            
            @if( $item == 'latest_viewed_Audios' && $home_settings->latest_viewed_Audios == 1 ) {{-- Latest Viewed Audios    --}}
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/latest_viewed_Audios', [ 'order_settings_list' => $order_settings_list ])->content() !!}
            @endif
            
            @if( $item == 'latest_viewed_Episode' && $home_settings->latest_viewed_Episode == 1 ) {{-- Latest Viewed Episode   --}}
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/latest_viewed_Episode', [ 'order_settings_list' => $order_settings_list ])->content() !!}
            @endif
            ...
            @if( !Auth::guest() && $item == 'my_play_list' && $home_settings->my_playlist == 1 ) {{-- MY PlayList --}}
               ...
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/my-playlist', [ 'data' => $MyPlaylist ,'order_settings_list' => $order_settings_list ])->content() !!}
            @endif

            @if( $item == 'video_play_list' && $home_settings->video_playlist == 1 ) {{-- Video PlayList  --}}
               <?php $AdminVideoPlaylist = App\AdminVideoPlaylist::get(); ?>
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/playlist-videos', [ 'data' => $AdminVideoPlaylist ,'order_settings_list' => $order_settings_list ])->content() !!}
            @endif
            ...
            @if(  $item == 'Leaving_soon_videos' && $home_settings->Leaving_soon_videos == 1 )     
               {!! Theme::uses('theme6')->load('public/themes/theme6/views/partials/home/Going-to-expiry-videos', ['order_settings_list' => $order_settings_list ])->content() !!}
            @endif
...
<?php
   ...
   include(public_path('themes/theme6/views/partials/home/HomePage-wishlist-watchlater-script.blade.php')) ; 
?>