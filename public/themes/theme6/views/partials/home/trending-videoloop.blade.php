                                ...
                                <li class="slide-item">
                                    <a href="{{ URL::to('category/videos/'.$featured_videos->slug ) }}">
                                        <div class="block-images position-relative">
                                            <div class="img-box">
                                                <img src="{{  URL::to('public/uploads/images/'.$featured_videos->image) }}" class="img-fluid" alt="">
                                            </div>
                                            <div class="block-description">
                                                <h6> {{ strlen($featured_videos->title) > 17 ? substr($featured_videos->title, 0, 18) . '...' : $featured_videos->title }}
                                                </h6>
                                                <div class="movie-time d-flex align-items-center my-2">
                                                    ...
                                                    <span class="text-white">
                                                        {{ $featured_videos->duration != null ? gmdate('H:i:s', $featured_videos->duration) : null }}
                                                    </span>
                                                </div>
