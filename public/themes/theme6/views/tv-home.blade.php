        ...
        <div class="main-content">
            ...
            {{-- <section id="iq-favorites">
                <div class="container-fluid overflow-hidden">
                    <div class="row">
                        <div class="col-sm-12 ">
                            @php include(public_path('themes/theme6/views/partials/home/free_content.blade.php')) @endphp
                        </div>
                    </div>
                </div>
            </section> --}}
            ...
            <!-- <section id="iq-favorites">
                <div class="container-fluid overflow-hidden">
                    <div class="row">
                        <div class="col-sm-12 ">
                            {{-- @php include(public_path('themes/theme6/views/partials/home/latest-episodes.php')) @endphp --}}
                        </div>
                    </div>
                </div>
            </section> -->
