@php
     ...
     include( public_path('themes/theme6/views/video-js-Player/Livestream/live-ads.blade.php'));
     include( public_path('themes/theme6/views/video-js-Player/Livestream/live-player-script.blade.php'));
@endphp
