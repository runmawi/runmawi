...
<link href="<?= asset('public/themes/theme6/assets/css/video-js/videojs.min.css') ?>" rel="stylesheet">
<!-- <link href="https://unpkg.com/@videojs/themes@1/dist/fantasy/index.css" rel="stylesheet"> -->
<link href="https://cdn.jsdelivr.net/npm/videojs-hls-quality-selector@1.1.4/dist/videojs-hls-quality-selector.min.css" rel="stylesheet">
<link href="<?= URL::to('node_modules/videojs-settings-menu/dist/videojs-settings-menu.css') ?>" rel="stylesheet">
<link href="<?= asset('public/themes/theme6/assets/css/video-js/videos-player.css') ?>" rel="stylesheet">
<link href="<?= asset('public/themes/theme6/assets/css/video-js/video-end-card.css') ?>" rel="stylesheet">


<!-- Style -->
<link rel="preload" href="<?= URL::to('public/themes/theme6/assets/css/style.css') ?>" as="style">
...
include(public_path('themes/theme6/views/livevideo_ads.blade.php')); 
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-xs-12">
                 <ul class="list-inline p-0 mt-4 share-icons music-play-lists">
                    ...
                    @php
                        include(public_path('themes/theme6/views/partials/live-social-share.php'));
                    @endphp                    
                  </ul>
            </div>
            ...
            <?php if( App\CommentSection::first() != null && App\CommentSection::pluck('livestream')->first() == 1 ): ?>
                <div class="">
                    <div class=" container-fluid video-list you-may-like overflow-hidden">
                        ...
                        @php
                            include(public_path('themes/theme6/views/comments/index.blade.php'));
                        @endphp
                    </div>
                </div>
            <?php endif; ?>
...
@php
    include(public_path('themes/theme6/views/m3u_file_live.blade.php'));
    include(public_path('themes/theme6/views/footer.blade.php'));
    include public_path('themes/theme6/views/livevideo_player_script.blade.php');
@endphp