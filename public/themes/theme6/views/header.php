...
body.light-theme {
    background: <?php echo GetLightBg();
    ?> !important;
}
...
body.light-theme .btn1 {
    border: 1px solid <?php echo GetLightText();
    ?> !important;
    color: <?php echo GetLightText();
    ?> !important;
}
...
@media (min-width:1025px) {
    li.logout_mobile_view.menu-item {
                ...
                <div class="row">
                    <div class="col-sm-12 mt-2">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <?php if($theme_mode == "light" && !empty(@$theme->light_mode_logo)){  ?>
                            <a class="navbar-brand mb-0" href="<?php echo URL::to('home') ?>"> <img alt="logo"
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="menu-main-menu-container">
                                    ...
                                    <ul id="top-menu"
                                        class=" mt-2 nav navbar-nav <?php if ( Session::get('locale') == 'arabic') { echo "navbar-right"; } else { echo "navbar-left";}?>">
                                 ...
                                 ?>
                                        <li class="dropdown menu-item">
                                            ...
                                            <ul class="dropdown-menu categ-head">
                                                ...
                                                <li>
                                                    <a class="dropdown-item cont-item"
                                                        href="<?php echo URL::to('audio/').'/'.$category->name;?>">
                                                        <?php echo $category->name;?>
                                                    </a>
                                                </li>
                                                <?php } ?>
                                            ...
                                            <ul class="dropdown-menu categ-head">
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dropdown-item cont-item text-primary"
                                                        href="<?php echo URL::to('/series/list');?>">
                                                        <?php echo 'More...';?>
                                                    </a>
                                                    <?php endif; ?>
                                        ...
                                        <div class="col-lg-12 align-items-center justify-content-center appk">
                                            ...
                                            <div class=" small m-0 text-white ">
                                                <div class="map1">
                                                    ...
                                                    <a href="<?= $app_settings->android_url ?>"><img class=""
                                                            height="60" width="100"
                                                            src="<?php echo  URL::to('/assets/img/apps1.png')?>" /></a>
                                                    <?php } ?>
                                                    <?php if(!empty($app_settings->ios_url)){ ?>
                                                    <a href="<?= $app_settings->ios_url ?>"><img class="" height="60"
                                                            width="100"
                                                            src="<?php echo  URL::to('/assets/img/apps.png')?>" /></a>
                                                    <?php } ?>
                                                    <?php if(!empty($app_settings->android_tv)){ ?>
                                                    <a href="<?= $app_settings->android_tv ?>">
                                                        <img class="" height="60" width="100"
                                                            src="<?php echo  URL::to('/assets/img/and.png')?>" /></a>
                                                    <?php } ?>
                                                </div>
                        ...
                        if(!Auth::guest() && !empty($ModeratorsUser)){ ?>
                                            <div class="iq-search-bar ml-auto">
                                                <form method="POST" action="<?php echo URL::to('cpp/home') ?>"
                                                    class="mt-4">
                                                    ...
                                                    <input id="password" type="hidden" name="password"
                                                        value="<?=  @$ModeratorsUser->password ?>"
                                                        autocomplete="current-password">
                                                    <button type="submit" class="btn btn-primary "
                                                        style="margin-top: 0%;margin-left: 5%;">CPP Portal </button>
                                                </form>
                                            </div>
                                            <?php }if(!Auth::guest() && !empty($Channel)){ ?>
                                            <div class="iq-search-bar ml-auto">
                                                <form method="POST" action="<?php echo URL::to('channel/home') ?>"
                                                    class="mt-4">
                                                    <input type="hidden" name="_token" id="token"
                                                        value="<?= csrf_token() ?>">
                                                    <input id="email" type="hidden" name="email"
                                                    ...
                                                    <input id="password" type="hidden" name="password"
                                                        ...
                                                        autocomplete="current-password">
                                                    <button type="submit" class="btn btn-primary"
                                                        style="margin-top: 0%;margin-left: 5%;">Visit Channel Portal
                                                    </button>
                                                </form>
                                            </div>
                                            <?php } ?>
                                        ...
                                        <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                                            <li class="hidden-xs">
                                                <div id="navbar-search-form">
                                                    <form id="" role="search"
                                                        action="<?php echo URL::to('searchResult');?>" method="POST">
                                ...
                                <div class="iq-search-bar ml-auto">
                                    <form method="POST" action="<?php echo URL::to('cpp/home') ?>" class="mt-4">
                                        ...
                                        <button type="submit" class="btn bd "
                                            style="margin-top: -20%;margin-left: -14%;">Visit CPP Portal </button>
                                    </form>
                                </div>
                                <?php }if(!Auth::guest() && !empty($Channel)){ ?>
                                <div class="iq-search-bar ml-auto">
                                    <form method="POST" action="<?php echo URL::to('channel/home') ?>" class="mt-4">
                                        ...
                                        <button type="submit" class="btn bd"
                                            style="margin-top: -17%;margin-left: -8%;">Visit Channel Portal </button>
                                    </form>
                                </div>
                                <?php } ?>
                            </div>
