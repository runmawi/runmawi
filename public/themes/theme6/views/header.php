               ...
               <div class="row">
                  <div class="col-sm-12">
                     <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <a class="navbar-brand" href="index.html"> <img class="img-fluid logo" src="https://localhost/flicknexs/public/themes/theme6/assets/images/logo.png"
                           alt="streamit" /> </a>
                              ...
                              <div class="navbar-right position-relative">
                                 <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                                             ...
                                             <div class="iq-card-body">
                                                <a href="#" class="iq-sub-card">
                                                   <div class="media align-items-center">
                                                      <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/notify/thumb-1.jpg" class="img-fluid mr-3"
                                                         alt="streamit" />
                                                ...
                                                <a href="#" class="iq-sub-card">
                                                   <div class="media align-items-center">
                                                      <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/notify/thumb-2.jpg" class="img-fluid mr-3"
                                                         alt="streamit" />
                                                      <div class="media-body">
                                                ...
                                                <a href="#" class="iq-sub-card">
                                                   <div class="media align-items-center">
                                                      <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/notify/thumb-3.jpg" class="img-fluid mr-3"
                                                         alt="streamit" />
                                                      <div class="media-body">
                                    ...
                                    <li>
                                       ...
                                       <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/user/user.jpg" class="img-fluid avatar-40 rounded-circle"
                                          alt="user">
                                       </a>
                        ...
                        <div class="navbar-right menu-right">
                           <ul class="d-flex align-items-center list-inline m-0">
                              ...
                              <li class="nav-item nav-icon">
                                 ...
                                 <img src="https://localhost/flicknexs/public/themes/theme6/assets/images/user/user.jpg" class="img-fluid avatar-40 rounded-circle" alt="user">
                                 </a>
                                 <div class="iq-sub-dropdown iq-user-dropdown">
                                    <div class="iq-card shadow-none m-0">
                                       <div class="iq-card-body p-0 pl-3 pr-3">
