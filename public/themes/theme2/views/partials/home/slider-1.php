    ...
    foreach ($sliders as $key => $slider_video): ?>
        ...
        <div class="item <?php if ($key == 0) {
            ...
            <div class="slide slick-bg s-bg-1 lazy"
                style="background:linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo URL::to('/') . '/public/uploads/videocategory/' . $slider_video->slider; ?>') no-repeat;background-size:cover;background-position:center; ">
...
<?php if (isset($live_banner)):
    foreach ($live_banner as $key => $slider_video): ?>
        ...
        <a href="<?= URL::to('/') ?><?= '/live' . '/' . $slider_video->slug ?>">
            <div class="slide slick-bg s-bg-1 lazy"
                style="background:linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo URL::to('/') . '/public/uploads/images/' . $slider_video->player_image; ?>') no-repeat;background-size:cover;background-position:center;  ">
                <div class="container-fluid position-relative h-100">
                    <div class="slider-inner h-100">
                        <div class="row align-items-center bl h-100">
...
<?php if (isset($live_event_banners)):
    foreach ($live_event_banners as $key => $live_event_banner): ?>
        ...
        <a href="<?= route('live_event_play', $live_event_banner->slug) ?>">
            <div class="slide slick-bg s-bg-1 lazy"
                style="background:linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo URL::to('/') . '/public/uploads/images/' . $live_event_banner->player_image; ?>') no-repeat;background-size:cover;background-position:center;   ">
                <div class="container-fluid position-relative h-100">
                    <div class="slider-inner h-100">
                        <div class="row align-items-center bl h-100">
                            <div class="col-xl-5 col-lg-12 col-md-12">
...
<?php if (isset($video_banners)):
    foreach ($video_banners as $key => $videos): ?>
        ...
        <a href="<?php echo URL::to('/') ?><?= '/category/videos/' . $videos->slug ?>">
            <div class="slide slick-bg s-bg-1 lazy"
                style="background:linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo URL::to('/') . '/public/uploads/images/' . $videos->player_image; ?>'); background-repeat:no-repeat;background-size:cover;background-position: center;">
                <div class="container-fluid position-relative h-100">
                        ...
                        <div class="col-md-12">
                            <div id="video-trailer" class="mfp-hide">
                                <video id="videoPlayer"
                                    poster="<?php echo URL::to('/') . '/public/uploads/images/' . $videos->player_image; ?>"
                                    class="" controls src="<?= $videos->trailer; ?>" type="application/x-mpegURL"></video>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php if (isset($series_sliders)):
    foreach ($series_sliders as $key => $series_slider): ?>
        ...
        <a href="<?php echo URL::to('/') ?><?= '/play_series' . '/' . $series_slider->slug ?>">
            <div class="slide slick-bg s-bg-1 lazy"
                style="background:linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo URL::to('/') . '/public/uploads/images/' . $series_slider->player_image; ?>'); background-repeat:no-repeat;background-size:cover;background-position:center; ">
                <div class="container-fluid position-relative h-100">
                    <div class="slider-inner h-100">
