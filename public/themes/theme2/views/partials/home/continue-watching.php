        ...
        <li class="slide-item">
            <a href="<?php echo URL::to('category') ?><?= '/videos/' . $cont_video->slug ?>">
                <div class="block-images position-relative">
                    <!-- block-images -->
                    <div class="img-box">
                        <img loading="lazy" data-src="<?php echo URL::to('/').'/public/uploads/images/'.$cont_video->player_image;  ?>" class="img-fluid lazyload w-100" alt="">
                       <!-- <video width="100%" height="auto" class="play-video" poster="<?php echo URL::to('/').'/public/uploads/images/'.$cont_video->player_image;  ?>" data-play="hover">
