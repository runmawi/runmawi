...
<meta property="og:description" content="<?php 
    ...
    <link href="<?php echo URL::to('public/themes/theme2/assets/css/font/font.css'); ?>" rel="stylesheet">
...
<body>
    ...
    <header id="main-header">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <?php if($theme_mode == "light" && !empty(@$theme->light_mode_logo)){  ?>
                            <a class="navbar-brand mb-0" href="<?php echo URL::to('home'); ?>"> <img src="<?php echo URL::to('/') . '/public/uploads/settings/' . $theme->light_mode_logo; ?>"
                                    class="c-logo" alt="<?php echo $settings->website_name; ?>"> </a>
                            <?php }elseif($theme_mode != "light" && !empty(@$theme->dark_mode_logo)){ ?>
                            <a class="navbar-brand mb-0" href="<?php echo URL::to('home'); ?>"> <img src="<?php echo URL::to('/') . '/public/uploads/settings/' . $theme->dark_mode_logo; ?>"
                                    class="c-logo" alt="<?php echo $settings->website_name; ?>"> </a>
                            <?php }else { ?>
                            <a class="navbar-brand mb-0" href="<?php echo URL::to('home'); ?>"> <img src="<?php echo URL::to('/') . '/public/uploads/settings/' . $settings->logo; ?>"
                                    class="c-logo" alt="<?php echo $settings->website_name; ?>"> </a>
                            <?php } ?>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <li class="dropdown menu-item col-sm-6">
                                    <div class="btn-close" data-toggle="collapse">
                                        <a type="button" class="navbar-toggler c-toggler  border-0" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="border-top: none; float:right">
                                 ...
                                 <li class="menu-item">
                                    ...
                                    <ul id="top-menu" class="nav navbar-nav <?php if (Session::get('locale') == 'arabic') {
                                        ...
                                        <li class="dropdown menu-item dskdflex">
                                            <a class="dropdown-toggle justify-content-between" id="down" href="<?php echo URL::to('/') . $menu->url; ?>"
                                        ...
                                        if(!Auth::guest() && !empty($ModeratorsUser)){ ?>
                                            <div class="iq-search-bar ml-auto ">
                                                <form method="POST" action="<?php echo URL::to('cpp/home'); ?>" class="mt-4">
                                                    ...
                                                    <div class="logout_mobile_view menu-item col-sm-6 channel_contentpr">
                            ...
                            <div class="col-sm-12 d-flex justify-content-around channel_contentpr mt-2">
                                <div class="row ">
                                    ...
                                    <li class="logout_mobile_view menu-item col-sm-12 myp">
                                        <a class="btn btn-primary" style="float:right;" href="<?php echo URL::to('myprofile') ?>">
                                                            ...
                                                            <div class="right-icon">
                                                                <svg version="1.1" id="Layer_1"
                                                                    ...
                                                                    <g>
                                                                        ...
                                                                        <path class="st0"
                                                                            d="M56.7,42.9c-1.5-1.5-3.5-2.2-5.5-2.2c-0.3,0-0.5-0.2-0.5-0.5V8.7c0-0.3-0.1-0.6-0.3-0.8s-0.5-0.3-0.8-0.3H13.5
		...
		c0,0.5-0.4,0.9-0.9,0.9s-0.9-0.4-0.9-0.9V17.5c0-3.3,2.7-6,6-6h10.4c3.3,0,6,2.7,6,6v10.4C46.6,28.4,46.2,28.7,45.8,28.7z" />
                                                                        <path class="st0"
                                                                            d="M42.3,23.6H28.5c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9h13.8c0.5,0,0.9,0.4,0.9,0.9
		...
		s0.4-0.9,0.9-0.9h4.2c1,0,1.9,0.8,1.9,1.9V52C55.3,52.5,54.9,52.9,54.4,52.9L54.4,52.9z" />
                                                                        <path class="st0"
                                                                            d="M30.2,46c-0.2,0-0.3,0-0.4-0.1c-0.3-0.2-0.4-0.4-0.4-0.7V31.3c0-0.3,0.2-0.6,0.4-0.7c0.3-0.2,0.6-0.2,0.9,0
                                                        ...
                                                        <div class="media align-items-center">
                                                            <div class="right-icon">
                                                                <svg version="1.1" id="Layer_1"
                                                                    ...
                                                                    <path class="st0"
                                                                        d="M11.2,22.1v23.2c0,1.4,0.5,2.7,1.5,3.6c1,1,2.3,1.5,3.6,1.5h37.7c1.4,0,2.7-0.5,3.6-1.5c1-1,1.5-2.3,1.5-3.6
