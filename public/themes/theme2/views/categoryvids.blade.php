            ...
            <div class="modal-content" style="background-color: transparent !important;">
                ...
                <div class="modal-body playvid">
                    ...
                    <div id="video_container" class="fitvid">
                        <video id="videojs-seek-buttons-player" onplay="playstart()" class="video-js vjs-default-skin"
                            ...
                            poster="<?= URL::to('/public/') . '/uploads/images/' . $category_video->image ?>"
                    ...
                    <div id="video_container" class="fitvid" atyle="z-index: 9999;">
                        <video id="videojs-seek-buttons-player" onplay="playstart()" class="video-js vjs-default-skin"
                            controls poster="<?= Config::get('site.uploads_url') . '/images/' . $video->image ?>"
                            data-setup='{ "playbackRates": [0.5, 1, 1.5, 2] }' width="100%" style="width:100%;"
                            data-authenticated="<?= !Auth::guest() ?>">
                ...
                <div class="modal-footer" align="center">
                    <button type="button" class="close btn btn-primary" data-dismiss="modal" aria-hidden="true"
                        onclick="document.getElementById('framevid').pause();" id="<?= $category_video->id ?>"><span
...
<div class="modal fade thumb-cont" id="myModal<?= $category_video->id ?>"
    style="background:url('<?php echo URL::to('/') . '/public/uploads/images/' . $category_video->image; ?>') no-repeat;background-size: cover;">
        ...
        <div class="tab-content">
            <div id="overview<?= $category_video->id ?>" class="container tab-pane active"><br>
                ...
                <p class="movie-rating">
                    <span class="thumb-star-rate"><i
                            class="fa fa-star fa-w-18"></i><?= $category_video->rating ?></span>
                    <span class="viewers"><i class="fa fa-eye"></i>(<?= $category_video->views ?>)</span>
                    <span class="running-time"><i
                            class="fa fa-clock-o"></i><?= gmdate('H:i:s', $category_video->duration) ?></span>
                </p>
                <p>Welcome</p>
                <a class="btn btn-hover" href="<?php echo URL::to('category'); ?><?= '/videos/' . $category_video->slug ?>"><i
            ...
            <div id="trailer<?= $category_video->id ?>" class="container tab-pane "><br>
                ...
                <div class="block expand">
                    ...
                    <a class="block-thumbnail-trail"
                        href="<? URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">


                        <?php if (!empty($category_video->trailer)) { ?>
                        <video class="trail-vid" width="30%" height="auto" class="play-video"
                            poster="<?php echo URL::to('/') . '/public/uploads/images/' . $category_video->image; ?>" data-play="hover" muted="muted">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab"
                        href="#overview<?= $category_video->id ?>">OVERVIEW</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#trailer<?= $category_video->id ?>">TRAILER AND
                        MORE</a>
                </li>
                <li class="nav-item">
