                           ...
                           <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                              <a href="<?php echo URL::to('home') ?>">
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img loading="lazy" data-src="<?php echo URL::to('/').'/public/uploads/images/'.$latest_video->player_image;  ?>" class="img-fluid" alt="">
                                  ...
                                  <div>
                                    ...
                                    <div class="movie-time my-2">
                                       ...
                                       <?php if($ThumbnailSetting->rating == 1 && $latest_video->rating != null) { ?>
                                       <span class="text-white">
                                    ...
                                    <div class="movie-time my-2">
                                          ...
                                          <?php  if ( ($ThumbnailSetting->published_year == 1) && ( $latest_video->year != null ) ) { ?>
                                          <span class="text-white">
