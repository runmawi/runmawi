            ...
            <div class="sign-user_card">
               <div class="row align-items-center">
                  <div class="col-lg-4 mb-3 bdr">
                     ...
                     <br><br>
                     <span style="font-size: 25px">{{ (__('Account Settings')) }}</span>
                  ...
                  <div class="col-lg-8 mb-3">
                     ...
                     <div class="targetDiv" id="div1">
                        <div class=" d-flex justify-content-between mb-3">
                           ...
                           <?php } ?>
                           <span style="font-size: 1.5em" class="mb-3"><?php if(!empty($user->username)): ?><?= $user->username ?><?php endif; ?></span>
                        </div>
                     ...
                     <div class="col-sm-12 text-center targetDiv" id="div2">
                        ...
                        <?php } ?>
                        <span style="font-size: 1.5em; font-weight:500;" class="mb-3"><?php if(!empty($user->username)): ?><?= $user->username ?><?php endif; ?></span>
                        <span style="font-size: 1.5em; font-weight:500;" class="mb-3"><?php if(!empty($user->role)): ?><?= $user->role ?><?php endif; ?> as on <?php if(!empty($user->created_at)): ?><?= $user->created_at ?><?php endif; ?></span>
                        <span class="mb-3"></span>
                        
                        <div class="text-center">
                           <?php  if($user_role == 'registered'){ ?>
                              <span style="font-size: 18px;"><?php echo 'Registered'." " .'(Free)'; ?> {{ __('Subscription') }}</span>                                       
                              <h6></h6>                                       
                           <?php }elseif($user_role == 'subscriber'){ ?>
                              <span style="font-size: 20px;"><?php echo $role_plan." " .'__(Paid User)'; ?></span>
                              <br>       
                              <span style="font-size: 18px;" class="card-title mb-0">{{ __('Available Specification') }} :</span><br>
                              <span style="font-size: 18px;"> {{ __('Video Quality') }} : <p> <?php if($plans != null || !empty($plans)) {  echo $plans->video_quality ; } else { ' ';} ?></p></span>  
                              <span style="font-size: 18px;"> {{ __('Video Resolution') }} : <p> <?php if($plans != null || !empty($plans)) {  echo $plans->resolution ; } else { ' ';} ?>  </p></span>                               
                              <span style="font-size: 18px;"> {{ __('Available Devices') }} : <p> <?php if($plans != null || !empty($plans) ) {  echo $devices_name ; } else { ' ';} ?> </p></span>                                                                                                                   
                              <!--<h6>Subscription</h6>-->
                           <?php } ?>
                        </div>
                     ...
                     <div class="targetDiv" id="div4">
                        <div class="mb-3" id="updatepic"></div>
                     </div>
                  
                     <div class="targetDiv" id="div5">
                        <div class=" mb-3">
                           <span style="font-size: 24px;" class="card-title mb-0">{{ __('Preference for videos') }}</span>
                           <form action="{{ route('users-profile-Preference') }}" method="POST"  >
                              @csrf
                              <input type="hidden" name="user_id" value="<?= $user->id ?>" />

                              <div class="col-sm-9 form-group p-0 mt-3">
                                 <label><span style="font-size: 16px">{{ __('Preference Language') }}</span></label>
                              ...
                              <div class="col-sm-9 form-group p-0 mt-3">
                                 <label><span style="font-size: 16px">{{ __('Preference Genres') }}</span"></label>
                        ...
                        <div class="iq-card" id="recentviews" style="background-color:#191919;">
                           <div class="iq-card-header d-flex justify-content-between" >
                              <div class="iq-header-title mb-3">
                                 <span style="font-size: 1.4em" class="card-title">{{ __('Recently Viewed Items') }}</span>
                              </div>
                           </div>
