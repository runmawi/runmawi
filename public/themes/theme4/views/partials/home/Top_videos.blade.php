                ...
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="channels-list">
                        <div class="channel-row">
                            <div id="trending-slider-nav" class="video-list top-videos">
                        ...
                        <div id="videoInfo" class="top-videos-dropdown" style="display:none;">
...
<script>
    ...
    var elem = document.querySelector('.top-videos');
    ...
    document.querySelectorAll('.top-videos .item').forEach(function(item) {
        item.addEventListener('click', function() {
            ...
            document.querySelectorAll('.top-videos-dropdown .caption').forEach(function(caption) {
                caption.style.display = 'none';
            });
            document.querySelectorAll('.top-videos-dropdown .thumbnail').forEach(function(thumbnail) {
                thumbnail.style.display = 'none';
            });

            var selectedCaption = document.querySelector('.top-videos-dropdown .caption[data-index="' + index + '"]');
            var selectedThumbnail = document.querySelector('.top-videos-dropdown .thumbnail[data-index="' + index + '"]');
            if (selectedCaption && selectedThumbnail) {
                selectedCaption.style.display = 'block';
                selectedThumbnail.style.display = 'block';
            }

            document.getElementsByClassName('top-videos-dropdown')[0].style.display = 'flex';
        });
    });


    $('body').on('click', '.drp-close', function() {
        $('.top-videos-dropdown').hide();
    });
</script>
