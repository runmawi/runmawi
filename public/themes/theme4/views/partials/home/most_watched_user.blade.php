            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="trending-contens">
                                ...
                                <li class="slick-slide">
                                    <a href="javascript:;">
                                        <div class="movie-slick position-relative">
                                            ...
                                            @else
                                                <img src="{{ $video->image ?  URL::to('public/uploads/images/'.$video->image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="Videos">
                                            @endif
                                        </div>
                                    </a>
                                </li>
                        ...
                        <ul id="trending-slider user-videos-slider" class="list-inline p-0 m-0 align-items-center user-videos-slider theme4-slider" style="display:none;">
                            @foreach ($data as $key => $video )
                                <li class="slick-slide">
