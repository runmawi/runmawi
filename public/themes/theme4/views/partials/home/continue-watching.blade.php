            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="trending-contens">
                        ...
                        <ul id="trending-slider cnt-videos-slider" class="list-inline p-0 m-0 align-items-center cnt-videos-slider theme4-slider">
                            @foreach ($data as $key => $video_details )
                                <li class="slick-slide">
                        ...
                        <div class="modal-content" style="border:none; background:transparent;">
                            <div class="modal-body">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img  src="{{ $video_details->player_image ?  URL::to('public/uploads/images/'.$video_details->player_image) : default_horizontal_image_url() }}" alt="video_details" width="100%">
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="row">
