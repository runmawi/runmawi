            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="trending-contens">
                        ...
                        <ul id="trending-slider Latest-Episode-slider" class="list-inline p-0 m-0 align-items-center Latest-Episode-slider theme4-slider">
                                                        ...
                                                        <div class="caption pl-4">
                                                            ...
                                                            <div class="p-btns">
                                                                <div class="d-flex align-items-center p-0">
                                                                    ...
                                                                    <a class="btn btn-hover button-groups mr-2" tabindex="0" data-bs-toggle="modal" data-bs-target="{{ '#Home-Latest-episodes-Modal-'.$key }}"><i class="fas fa-info-circle mr-2" aria-hidden="true"></i> More Info </a>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="modal-content" style="border:none; background:transparent;">
                            <div class="modal-body">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img  src="{{ $episode_details->player_image ?  URL::to('public/uploads/images/'.$episode_details->player_image) : default_horizontal_image_url() }}" alt="episode_details" width="100%">
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="row">
