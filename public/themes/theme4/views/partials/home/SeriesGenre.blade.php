                                    ...
                                    <a href="javascript:void(0);">
                                        <div class="movie-slick position-relative">
                                            @if ( compress_responsive_image_enable() == 1)
                                                <img class="img-fluid position-relative" alt="{{ $seriesGenre->title }}" src="{{ $seriesGenre->image ?  URL::to('public/uploads/images/'.$seriesGenre->image) : default_vertical_image_url() }}"
                                                    srcset="{{ URL::to('public/uploads/PCimages/'.$seriesGenre->responsive_image.' 860w') }},
                                                    {{ URL::to('public/uploads/Tabletimages/'.$seriesGenre->responsive_image.' 640w') }},
                                                    {{ URL::to('public/uploads/mobileimages/'.$seriesGenre->responsive_image.' 420w') }}" >
                                            @else
                                                ...
                                                <div id="" class="overview-tab tab-pane fade active show">
                                                    <div class="trending-info align-items-center w-100 animated fadeInUp">
                                                                        ...
                                                                        <a href="{{ URL::to('play_series/'.$series_details->slug) }}">
                                                                            <div class=" position-relative">
                                                                                <img src="{{ $series_details->image ?  URL::to('public/uploads/images/'.$series_details->image) : default_vertical_image_url() }}" class="img-fluid" alt="Videos">                                                                                <div class="controls">
                                                                                    ...
                                                                                    <nav ><button class="moreBTN" tabindex="0" data-bs-toggle="modal" data-bs-target="{{ '#Home-SeriesGenre-series-Modal-'.$key.'-'.$series_key  }}"><i class="fas fa-info-circle"></i><span>More info</span></button></nav>
                                                        ...
                                                        <div class="dropdown_thumbnail">
                                                            @if ( compress_responsive_image_enable() == 1)
                                                                <img  alt="latest_series" src="{{$seriesGenre->player_image ?  URL::to('public/uploads/images/'.$seriesGenre->player_image) : default_horizontal_image_url() }}"
                                                                    srcset="{{ URL::to('public/uploads/PCimages/'.$seriesGenre->responsive_player_image.' 860w') }},
                                                                    {{ URL::to('public/uploads/Tabletimages/'.$seriesGenre->responsive_player_image.' 640w') }},
                                                                    {{ URL::to('public/uploads/mobileimages/'.$seriesGenre->responsive_player_image.' 420w') }}" >
                                                            @else
