            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-name pl-5"><a href="{{ $order_settings_list[10]->url ? URL::to($order_settings_list[10]->url) : null }} ">{{ optional($order_settings_list[10])->header_name }}</a></h4>
                        <h4 class="main-name"><a href="{{ $order_settings_list[10]->url ? URL::to($order_settings_list[10]->url) : null }} ">{{ 'View all' }}</a></h4>
                    </div>

                    <div class="favorites-contens">
                            <ul id="trending-slider-nav" class="schedule-nav list-inline p-0 ml-5 row align-items-center">
