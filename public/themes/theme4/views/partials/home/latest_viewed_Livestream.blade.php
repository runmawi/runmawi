                ...
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="channels-list">
                        <div class="channel-row">
                            <div id="trending-slider-nav" class="video-list live-viewed-video">
                        ...
                        <div id="videoInfo" class="live-viewed-dropdown" style="display:none;">
...
<script>
    ...
    var elem = document.querySelector('.live-viewed-video');
    ...
    document.querySelectorAll('.live-viewed-video .item').forEach(function(item) {
        item.addEventListener('click', function() {
            ...
            document.querySelectorAll('.live-viewed-dropdown .caption').forEach(function(caption) {
                caption.style.display = 'none';
            });
            document.querySelectorAll('.live-viewed-dropdown .thumbnail').forEach(function(thumbnail) {
                thumbnail.style.display = 'none';
            });

            var selectedCaption = document.querySelector('.live-viewed-dropdown .caption[data-index="' + index + '"]');
            var selectedThumbnail = document.querySelector('.live-viewed-dropdown .thumbnail[data-index="' + index + '"]');
            if (selectedCaption && selectedThumbnail) {
                selectedCaption.style.display = 'block';
                selectedThumbnail.style.display = 'block';
            }

            document.getElementsByClassName('live-viewed-dropdown')[0].style.display = 'flex';
        });
    });


    $('body').on('click', '.drp-close', function() {
        $('.live-viewed-dropdown').hide();
    });
</script>
