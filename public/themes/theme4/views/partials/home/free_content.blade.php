            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="trending-contens">
                                ...
                                <li class="slick-slide">
                                    <a href="javascript:void(0);">
                                        <div class="movie-slick position-relative">
                                            ...
                                            @else
                                                <img src="{{ $episode_details->image ? URL::to('public/uploads/images/'.$episode_details->image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="episode_details">
                                            @endif 
                                        </div>
                                    </a>
                                </li>
                        ...
                        <ul id="trending-slider Free-Content-Episode-slider" class="list-inline p-0 m-0 align-items-center Free-Content-Episode-slider theme4-slider" style="display:none;">
