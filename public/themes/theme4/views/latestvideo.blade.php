            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="iq-main-header align-items-center justify-content-between">
                        <h4 class="main-title mar-left">{{ "Latest Videos" }}</h4>
                    </div>
                            ...
                            @foreach ($latestvideo['latest_videos'] as $key => $latest_video)
                                <div class="network-image">
                                    <div class="movie-sdivck position-relative">
                                        <img src="{{ $latest_video->image ?  URL::to('public/uploads/images/'.$latest_video->image) : default_vertical_image_url() }}" class="img-fluid w-100" alt="Videos" width="300" height="200">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                @endif
                                                                <a href="{{ URL::to('category/videos/'.$latest_video->slug) }}" class="btn btn-hover button-groups mr-2 mt-3" tabindex="0">
