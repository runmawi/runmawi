...
@if (count($albums) > 0)
    ...
    <div class="container-fluid mt-3">
        <h4 class="main-title">{{ __('Album') }}</h4>
    </div>
...
@if (count($artist_audios) > 0)
    <div class="container-fluid mt-3">
        <h4 class="main-title">{{ __('Audio') }}</h4>
    </div>
        ...
        <div class="favorites-contens">
            <ul class="favorites-slider list-inline  row p-0 mb-0">
                @foreach ($artist_series as $key => $artist_serie)
                    <li class="slide-item">
                        <a href="{{ URL::to('play_series/' . $artist_serie->id) }}">
                            <div class="block-images position-relative">
                                <div class="img-box">
                                    <img loading="lazy"
                                        data-src="{{ URL::to('public/uploads/images/' . $artist_serie->image) }}"
                                        alt="" class="img-fluid loading w-100">
                                </div>
                                ...
                                <div class="block-description">
                                    <div class="hover-buttons text-white">
                                        <a href="{{ URL::to('play_series/' . $artist_serie->id) }}">
                                            <h6 class="">{{ $artist_serie->title }}</h6>
                                            <p>{{ $artist_serie->year }}</p>
                                        </a>
