      ...
      <div class="main">
         ...
         <div class="main-content">
            ...
            @if( !Auth::guest() && !is_null($continue_watching_setting) &&  $continue_watching_setting == 1 )
               {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/continue-watching', ['data' => $cnt_watching, 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
            @endif
            ...
            @forelse ($order_settings as $key => $item) 
               ...
               @if( $item == 'audios' && $home_settings->audios == 1 )        {{-- Audios --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest-audios', ['data' => $latest_audios, 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif

               @if( $item == 'series' && $home_settings->series == 1 )        {{-- series  --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest-series', ['data' => $latest_series, 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if( $item == 'ContentPartner' && $home_settings->content_partner == 1 )        {{-- content partner  --}}
                  ...
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/ContentPartners', ['data' => $ModeratorsUser , 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if( $item == 'ChannelPartner' && $home_settings->channel_partner == 1 )        {{-- channel partner  --}}
                  ...
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/ChannelPartners', ['data' => $channels, 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if( $item == 'Series_Genre' && $home_settings->SeriesGenre == 1 )        {{-- Series Genre  --}}
                  ...
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/SeriesGenre', ['data' => $parentCategories, 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif

               @if( $item == 'Series_Genre_videos' && $home_settings->SeriesGenre_videos == 1 ) {{-- series Based on Category  --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/series-based-categories', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if( $item == 'live_category' && $home_settings->live_category == 1 ) {{-- LiveStream Based on Category  --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/livestreams-based-categories', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if( $item == 'Audio_Genre_audios' && $home_settings->AudioGenre_audios == 1 ) {{-- Audios Based on Category  --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/Audios-based-categories', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif

               @if( $item == 'latest_viewed_Videos' && $home_settings->latest_viewed_Videos == 1 ) {{-- Latest Viewed Videos --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest_viewed_Videos', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               
               @if( $item == 'latest_viewed_Livestream' && $home_settings->latest_viewed_Livestream == 1 ) {{-- Latest Viewed Livestream    --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest_viewed_Livestream', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               
               @if( $item == 'latest_viewed_Audios' && $home_settings->latest_viewed_Audios == 1 ) {{-- Latest Viewed Audios    --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest_viewed_Audios', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               
               @if( $item == 'latest_viewed_Episode' && $home_settings->latest_viewed_Episode == 1 ) {{-- Latest Viewed Episode   --}}
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/latest_viewed_Episode', [ 'order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
               ...
               @if(  $item == 'Leaving_soon_videos' && $home_settings->Leaving_soon_videos == 1 )     
                  {!! Theme::uses('theme4')->load('public/themes/theme4/views/partials/home/Going-to-expiry-videos', ['order_settings_list' => $order_settings_list , 'multiple_compress_image' => $multiple_compress_image ])->content() !!}
               @endif
