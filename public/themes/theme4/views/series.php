                                                        ...
                                                        <div class="caption pl-5">
                                                            ...
                                                            <div class="p-btns">
                                                                <div class="d-flex align-items-center p-0">
                                                                    <a href="<?php echo URL::to('episode').'/'.$series->slug.'/'.$episodes->slug;?>" class="btn btn-hover button-groups mr-2" tabindex="0"><i class="fa fa-play mr-2" aria-hidden="true"></i> Play Now </a>
                                                                    <a href="<?php echo URL::to('episode').'/'.$series->slug.'/'.$episodes->slug;?>" class="btn btn-hover button-groups mr-2" tabindex="0"><i class="fa fa-play mr-2" aria-hidden="true"></i> More Info </a>
                                                                </div>
                                                            </div>
                                                        </div>
