                ...
                @if (($latest_videos_pagelist)->isNotEmpty())
                    ...
                    <div class="trending-contens sub_dropdown_image mt-3" id="home-latest-videos-container">
                        <div id="trending-slider-nav" class="series-networks-slider-nav list-inline p-0 mar-left row align-items-center">
                            ...
                            @forelse($latest_videos_pagelist as $key => $latest_videos)
                                <div class="network-image">
                                    <div class="movie-sdivck position-relative">
                                        <img src="{{ $latest_videos->image ?  URL::to('public/uploads/images/'.$latest_videos->image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="Videos" width="300" height="200">                                        
                                        
                                        <div class="controls">        
                                            <a href="{{ URL::to('category/videos/'.$latest_videos->slug) }}">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            <div class="col-lg-6 mb-3">
                                                                <img  src="{{ $latest_videos->player_image ?  URL::to('public/uploads/images/'.$latest_videos->player_image) : $default_vertical_image_url }}" alt="modal">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="row">
                                                                    <div class="col-lg-10 col-md-10 col-sm-10">
                                                                        <h2 class="caption-h2">{{ optional($latest_videos)->title }}</h2>
                                                                    </div>
                                                                ...
                                                                <div class="trending-dec">{!! html_entity_decode( $latest_videos->description ) ??  $latest_videos->description  !!}</div>
                                                            
                                                                    <a href="{{ URL::to('category/videos/'.$latest_videos->slug) }}" class="btn btn-hover button-groups mr-2 mt-3" tabindex="0">
