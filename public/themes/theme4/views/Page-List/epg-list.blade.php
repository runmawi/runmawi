                            ...
                            @forelse($epg_pagelist as $key => $epg_channel_data)
                                <div class="network-image">
                                    <div class="movie-sdivck position-relative">
                                        <img src="{{ $epg_channel_data->image_url }}" class="img-fluid w-100" alt="Videos" width="300" height="200">
                                        ...
                                        <div class="controls">        
                                            ...
                                            <nav>
                                                <button class="moreBTN" tabindex="0" data-bs-toggle="modal" data-bs-target="#Home-epg-channel-Modal-{{ $key }}"><i class="fas fa-info-circle"></i><span>More info</span></button>
                                            </nav>
                                        </div>
                                    </div>
                                </div>
