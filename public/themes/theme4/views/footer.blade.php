         ...
         <div class="container-fluid">
            <div class="block-space">
             ...
             <div class="col-lg-12 text-center d-flex justify-content-center">
                                        <img class="mt-2 mb-3" height="" width="" src="<?php echo  URL::to('/assets/img/gk.png')?>" style="margin-top:-20px;">

             </div>
              <p class="mb-0  font-size-14 text-body text-center bb p-2"><?php echo $settings->website_name ; ?> - <?php echo Carbon::now()->year ; ?> All Rights Reserved</p>
            </div>
