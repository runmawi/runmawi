        ...
        <div class="row">
            <div class="col-sm-12 overflow-hidden">
                <div class="iq-main-header d-flex align-items-center justify-content-between">
                    <h4 class="main-title mar-left"><?= __('Media in My Wishlist') ?></h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="network-image">
                            <div class="movie-sdivck position-relative">
                                ...
                                <div class="controls">     
                                    ...
                                    <nav>
                                        <button class="moreBTN" tabindex="0" data-bs-toggle="modal" data-bs-target="#whishlist-{{ $key }}"><i class="fas fa-info-circle"></i><span>More info</span></button>
                                    </nav>
                                </div>
                            </div>
                        </div>
                          ...
                          <!-- Modal -->
                        <div class="modal fade info_model" id="whishlist-{{ $key }}" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="network-image">
                            <div class="movie-sdivck position-relative">
                                ...
                                <div class="controls">     
                                    ...
                                    <nav>
                                        <button class="moreBTN" tabindex="0" data-bs-toggle="modal" data-bs-target="#whishlist-episode-{{ $key }}"><i class="fas fa-info-circle"></i><span>More info</span></button>
                                    </nav>
                                </div>
                            </div>
                        </div>
                         ...
                         <!-- Modal -->
                        <div class="modal fade info_model" id="whishlist-episode-{{ $key }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" style="max-width:100% !important;">
                                <div class="container">
                                    <div class="modal-content" style="border:none; background:transparent;">
                                        <div class="modal-body">
