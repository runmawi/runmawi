   ...
   <div class=" page-height">
     <?php 
         ...
         <?php  elseif($video->type == ''):  ?>
          ...
          <video autoplay id="video"   allow="autoplay" class="adstime_url" controls crossorigin playsinline poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' >
      <source 
