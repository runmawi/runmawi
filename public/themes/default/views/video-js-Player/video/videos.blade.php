    ...
    <div class="container-fluid p-0" style="position:relative">
        ...
        @if ( $videodetail->users_video_visibility_status)
            ...
            @else
                ...
                <div class="titlebutton">{{$videodetail->title}}</div>

                <!-- <button class="custom-skip-forward-button" allowfullscreen>
                ...
                <button class="custom-skip-backward-button" allowfullscreen>
