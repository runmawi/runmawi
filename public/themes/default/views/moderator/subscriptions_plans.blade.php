...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-7">
                    <div class="flick1">
                        ...
                        <div class="medium-heading text-white"> {{ !is_null($SiteTheme) &&  !is_null($SiteTheme->signup_cpp_title) ? $SiteTheme->signup_cpp_title : null  }} </div>
    ...
    <script>
        ...
        $(".stripe_button").click(function() {
            ...
            $.ajax({
                url: "{{ route('CPP_Stripe_authorization_url') }}",
                beforeSend: function () {
                    swal({
                        title: "Loading...",
                        text: "Please wait",
