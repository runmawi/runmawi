...
<section class="ContentPartner-header" style="background-color: rgba(0, 0, 0, 0.45);background-blend-mode: multiply;">
    <img src="<?php echo URL::to('/') . '/public/uploads/moderator_albums/' . @$Content_Partner->banner; ?>" alt="contentpartner-banner" style="height:75vh;
        width:93%;opacity:0.8;position:relative;left:3%;filter: brightness(0.8) contrast(0.8) saturate(0.6);border-radius:20px;" class="contentpartner-banner">
</section>            
@else
<section class="ContentPartner-header" style="background-color: rgba(0, 0, 0, 0.45);background-blend-mode: multiply;">
    <img src="<?= URL::to('/') . '/public/uploads/images/' . $settings->default_horizontal_image ?>" alt="contentpartner-banner" style="height:75vh;
            width:93%;opacity:0.8;position:relative;left:3%;filter: brightness(0.8) contrast(0.8) saturate(0.6);border-radius:20px;" class="contentpartner-banner">
</section> 
@endif
...
<div class='Content_home' style="position: relative; bottom: 40%;">
    <?php 
...
<!-- <script>
        window.addEventListener('scroll', function() {
            ...
            document.querySelector('.ContentPartner-header').style.opacity = newOpacity;
        });
</script> -->   
