...
<?php if(!empty($settings->website_name)){ ?><meta property="og:site_name" content="<?php echo $settings->website_name ;?>" /><?php } ?>
   ...
   <link rel="preload" fetchpriority="high" href="https://runmawi.tv/public/uploads/images/player-image-1737718190.webp" as="image"/>
...
<style>
.fullpage-loader{position:fixed;top:0;left:0;height:100%;width:100%;overflow:hidden;background:#000;z-index:9999;opacity:1;transition:opacity .5s;display:flex;justify-content:center;align-items:center}.fullpage-loader__logo{position:relative}.fullpage-loader__logo:after{content:'';height:100%;width:100%;position:absolute;top:0;left:0;animation:shine 2.5s infinite cubic-bezier(.42,0,.58,1);background:rgba(255,255,255,.8);background:linear-gradient(to right,rgba(255,255,255,0) 0%,rgba(255,255,255,1) 50%,rgba(255,255,255,0) 100%)}@keyframes shine{0%{transform:translateX(-100%) skew(-30deg)}100%{transform:translateX(200%) skew(-30deg)}}.fullpage-loader--invisible{opacity:0}svg{height:30px;width:30px}.mk{display:none}#main-header,.svg{color:#fff}#videoPlayer{width:100%;height:100%;margin:20px auto}i.fas.fa-child,i.fa.fa-eercast{font-size:35px;color:white}span.kids,span.family{color:#f7dc59}a.navbar-brand.iconss{font-size:19px;font-style:italic;font-family:ui-rounded}.switch{position:relative;display:inline-block;width:50px;height:20px}.switch input{opacity:0;width:0;height:0}.sliderk{position:absolute;cursor:pointer;top:0;left:0;right:0;bottom:0;background-color:#ddd;transition:.4s}.sliderk:before{position:absolute;content:"";height:15px;width:15px;left:5px;bottom:2px;background-color:white;transition:.4s}input:checked+.sliderk{background-color:#2196F3}input:focus+.sliderk{box-shadow:0 0 1px #2196F3}input:checked+.sliderk:before{transform:translateX(26px)}li.logout_mobile_view.col-sm-6.myp h6{font-weight:600}.sliderk.round{border-radius:34px}.sliderk.round:before{border-radius:50%}body{background:#000}body.dark-theme{background:<?php echo $GetDarkBg; ?>!important}body.dark-theme i,body.dark-theme .navbar-right .iq-sub-dropdown,body.dark-theme header#main-header.menu-sticky,body.dark-theme h1,body.dark-theme h2,body.dark-theme h3,body.dark-theme h4,body.dark-theme h5,body.dark-theme h6,body.dark-theme .navbar-collapse,body.dark-theme header .navbar ul li.menu-item a,body.dark-theme .vpageBanner .content .right,body.dark-theme .vpageBanner .content .right .utilities,body.dark-theme a,body.dark-theme p,body.dark-theme .share-icons.music-play-lists li span i,body.dark-theme ol.breadcrumb,body.dark-theme ul.list-group.home-search,.iq-search-bar .search-input,body.dark-theme header#main-header,body.dark-theme .breadcrumb i,body.dark-theme #home-slider p,body.dark-theme #home-slider h2,body.dark-theme header .st0,.st2,body.dark-theme header .st6,.st3,.st1,body.dark-theme header .st5,body.dark-theme header h1,body.dark-theme header h2,body.dark-theme header h3,body.dark-theme header h4,body.dark-theme header h5,body.dark-theme header h6,body.dark-theme header .cont-item:hover,body.dark-theme header .dropdown-menu.categ-head{color:<?php echo $GetDarkText; ?>!important;background:<?php echo $GetDarkBg; ?>!important}body.light-theme{background:<?php echo $GetLightBg; ?>!important}body.light-theme #home-slider .container-fluid.position-relative.h-100{background:linear-gradient(1deg,rgb(255,255,255) 0%,transparent 0%),linear-gradient(90deg,rgb(240,240,240) 50%,transparent 50%)}body.light-theme h4,body.light-theme p,body.light-theme span,body.light-theme .block-description p.epi-name,body.light-theme header#main-header,body.light-theme footer,body.light-theme .copyright,body.light-theme .dropdown-item.cont-item,body.light-theme .s-icon,body.light-theme .search-toggle:hover,header .navbar ul li.menu-item a:hover,body.light-theme .dropdown-menu.categ-head,body.light-theme .navbar-right .iq-sub-dropdown,body.light-theme ul.list-group.home-search,body.light-theme .iq-search-bar .search-input,body.light-theme .list-group-item a,body.light-theme .searchbox h6,body.light-theme .iq-card-body h6,body.light-theme h1,body.light-theme h2,body.light-theme h3,body.light-theme h4,body.light-theme h5,body.light-theme h6,body.light-theme .media-body h6,body.light-theme .block-description h6,body.light-theme .movie-time i,body.light-theme #translator-table_filter input[type="search"],body.light-theme li.breadcrumb-item,body.light-theme .p-tag1,body.light-theme .p-tag,body.light-theme .movie-time span,body.light-theme .block-description a,body.light-theme .block-description,body.light-theme header .navbar ul li,body.light-theme .slick-nav i,body.light-theme h2,body.light-theme h5,body.light-theme .filter-option-inner-inner,body.light-theme .vid-title,body.light-theme .trending-info h1,body.light-theme .text-detail,body.light-theme .share-icons.music-play-lists li span i,body.light-theme .btn1,body.light-theme .trending-dec,body.light-theme .no_vid_avail,body.light-theme h6.trash{color:<?php echo $GetLightText; ?>!important;background:<?php echo $GetLightBg; ?>!important}body.light-theme .block-description{background-image:linear-gradient(to bottom,rgb(243 244 247 / 30%),rgb(247 243 243 / 90%),rgb(247 244 244 / 90%),rgb(235 227 227 / 90%));backdrop-filter:blur(2px)}body.light-theme .search-toggle:hover,header .navbar ul li.menu-item a:hover{color:rgb(0,82,204)!important;font-weight:500}body.light-theme .btn1{border:1px solid <?php echo $GetLightText; ?>!important}.Search_error_class{color:red}@media (min-width:1025px), (min-width:801px){li.logout_mobile_view.menu-item{display:none!important}}@media (max-width:991px){header .navbar ul li.menu-item a{border-top:1px solid <?php echo $GetDarkText; ?>!important}}.navbar-right .transdropdownlist{width:150px}#languageSearch{width:116px;font-size:12px;right:5px;position:relative}.navbar-toggler{border:none}.pagination a{color:#000!important}@media (max-width:768px) and (max-width:480px){.fullpage-loader__logo .video-js{width:500px}}     
</style>
