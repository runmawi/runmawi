   ...
   <header id="main-header">
    ...
    color: white;"></i></a>
                     ...
                     <?php if(!Auth::guest()){ ?>
                           ...
                           <!-- <div class="col-sm-12 d-flex justify-content-around channel_contentpr logout_mobile_view mt-2">
                              <div class="row ">
                              <div class="col-sm-6  menu-item pt-3">
                              <li class="logout_mobile_view channel_contentpr" style="display:none;">
                                       <a href="<?php echo URL::to('login') ?>" class="iq-sub-card">
                                          <div class="media align-items-center">
