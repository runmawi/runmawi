...
<style type="text/css">
   ...
   .dropdown-menu.share-icons.show {display: inline-block;}
   ul.share-icon-aud li {display: inline-block; padding: 0 6px;}
   .dropdown-menu.share-icons.show a{color: #000;}
                        ...
                        <div class="album_container">
                           ...
                           <div class="overlay_blur">
                              ...
                              <ul class="p-0 share-icon-aud">
                                 ...
                                 <li>
                                 <!-- <a aria-hidden="true" class="albumfavorite <?php echo albumfavorite($album->id);?>" data-authenticated="<?= !Auth::guest() ?>" data-album_id="<?= $album->id ?>"><?php if(albumfavorite($album->id) == "active"): ?><i id="ff" class="ri-heart-line" aria-hidden="true"></i><?php else: ?><i id="ff" class="ri-heart-fill" aria-hidden="true"></i><?php endif; ?></a> -->
                                 </li>
                                 <li>
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu share-icons" aria-labelledby="dropdownMenuButton"  style="background-color: white;border:1px solid white;padding: 0;">
               ...
               <li class="slide-item">
                  <a href="<?php echo URL('/').'/album/'.$other_album->slug;?>">
                     <div class="block-images position-relative">
                        <!-- block-images -->
                        <div class="img-box">
                           <img loading="lazy" src="<?= URL::to('/public/uploads/albums/' . $other_album->album) ?>" alt="<?php echo ucfirst($other_album->albumname);?>" class="img-fluid loading w-100">
                        </div>
                        <div class="block-description">
                           <div class="hover-buttons text-white">
                              <a class="d-flex justify-content-center align-items-center" href="<?php echo URL('/').'/album/'.$other_album->slug;?>">
...
<script>
   $(document).ready(function(){
      ...
      image.src = '<?php echo URL::to('/public/uploads/images/');?>' + '/' + listAudio[0].player_image
   });
</script>
<script>
     ...
     var audioppv_id  = listAudio[index].id
      ...
      if(access == 'guest'){
         ...
         if(countaudioppv.length > 0 || role == 'subscriber'){
               ...
               document.getElementById('audio_img').src = player_images + '/' + listAudio[index].player_image;
