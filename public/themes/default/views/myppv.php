                          ...
                          <a href="<?php echo URL::to('home') ?>">
                             <div class=" position-relative">
                                ...
                                <a  href="<?php echo URL::to('play_series') ?><?='/' . $series->slug ?>">
                                   <img src="<?php echo URL::to('/') . '/public/uploads/images/' . $series->image; ?>" class="img-fluid" alt="">
                                     </a>                                    
                                </div>
                                <div class="block-description">
                                    <a  href="<?php echo URL::to('play_series') ?><?='/' . $series->slug ?>">
                                   <h6><?php echo __($series->title); ?></h6>
                                    </a>
                                   <div class="movie-time d-flex align-items-center my-2">
                                      <div class="badge badge-secondary p-1 mr-2"><?php echo $series->age_restrict ?></div>
                                      <span class="text-white"><i class="fa fa-clock-o"></i> <?=gmdate('H:i:s', $series->duration); ?></span>
                                   </div>
