                            ...
                            @forelse($category_list as $category_lists)
                                <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                                    ...
                                    <div class="block-images position-relative">
                                        <div class="border-bg">
                                        <div class="img-box">
                                            <a class="playTrailer" aria-label="{{ $category_lists->name }}" href="{{ URL::to('/series/category').'/'.$category_lists->slug    }}">
                                        ...
                                        <a aria-label="{{ $category_lists->name }}" href="{{ URL::to('/series/category').'/'.$category_lists->slug    }}">
                                            <div class="hover-buttons text-white">
                                                ...
                                                <a class="epi-name mt-2 mb-0 btn" aria-label="{{ $category_lists->name }}" href="{{ URL::to('/series/category').'/'.$category_lists->slug    }}">
