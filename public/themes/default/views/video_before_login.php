...
<input type="hidden" name="current_time" id="current_time"
   value="<?php if (isset ($watched_time)) {
      echo $watched_time;
   } else {
      echo "0";
   } ?>">
...
<?php if (Auth::guest() && $video->access == "guest" && empty ($video->ppv_price) && $video->free_duration_status != 1) { ?>
      ...
      <div class=" page-height">
            ...
            <div id="video_container" class="fitvid">
               <?php if (!empty ($video->embed_code)) { ?>
                  <div class="plyr__video-embed" id="player">
                     <iframe
                        src="<?php if (!empty ($video->embed_code)) {
         ...
         <?php elseif ($video->type == '' && $video->processed_low == 100 || $video->processed_low != null): ?>
            ...
            <div id="video_container" class="fitvid" atyle="z-index: 9999;">
               ...
               <video id="video" <?= $autoplay ?> class="adstime_url" controls crossorigin playsinline
                  poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
   ...
   <?php } elseif ($video->free_duration_status == 1 && $video->free_duration != null) { ?>
            ...
            <div class="container-fluid">
               ...
               <div>
                  <a href="<?= URL::to('/signup') ?>" class="btn btn-primary">
                     <?php echo __('Become a Subscriber to watch this video'); ?>
                  </a>
               </div>
               <div class="text-white col-lg-5 p-0">
                  <a href="<?= URL::to('/become a') ?>" class="btn btn-primary" class="mb-3 btn btn-primary"
                     ...
                     <?php elseif ($video->access == 'registered'): ?>
                        <?php echo __('Registered Users'); ?>
                     <?php endif; ?>
                  </a>
               </div>
               <h4 class="mb-3" style="color: red;">
                  <?php echo __('Sorry, this video is only available to Subscribers / PPV Rent'); ?>
               </h4>
               <a href="<?= URL::to('/becomesubscriber') ?>" class="btn btn-primary" class="mb-3 btn btn-primary"
                  style="color: white;background-color: red !important;padding: 10px;border-radius: 20px !important;">
                  To Become a
                  <?php if ($video->access == 'subscriber'): ?>
                     Subscriber
                  <?php elseif ($video->access == 'registered'): ?>
                     <?php echo __('Registered User'); ?>
                  <?php endif; ?>
               </a>
            </div>
         </div>
      ...
      <?php elseif ($video->type == '' && ($video->processed_low != 100 || $video->processed_low == null)): ?>
         ...
         <div id="video_container" class="fitvid" atyle="z-index: 9999;">
            <video id="" class="adstime_url" poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>"
      ...
      <?php elseif ($video->type == 'm3u8_url'): ?>
         ...
         <video id="PPV_free_duration_videoPlayer_M3U8_url"
            poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
            data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}' type="video/mp4">
            <source src="<?php if (!empty ($video->m3u8_url)) {
               echo $video->m3u8_url;
   ...
   <?php } else { ?>
      ...
      <?php if (!empty ($video->path) && $video->path != "public") {
         $hls = "hls";
      } else {
         $hls = "";
      } ?>
...
<input type="hidden" class="videocategoryid" data-videocategoryid="<?= $video->video_category_id ?>"
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="bc-icons-2">
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a class="black-text" href="<?= route('latest-videos') ?>">
                     <?= ucwords('videos') ?>
                  </a>
               ...
               <?php foreach ($category_name as $key => $video_category_name) { ?>
                  ...
                  <li class="breadcrumb-item">
                     <a class="black-text"
                        href="<?php echo route('video_categories', [$video_category_name->categories_slug]) ?>">
               ...
               <li class="breadcrumb-item"><a class="black-text">
                     <?php echo (strlen($video->title) > 50) ? ucwords(substr($video->title, 0, 120) . '...') : ucwords($video->title); ?>
                  </a></li>
            </ol>
         </div>
      </div>
...
<div class="container-fluid video-details">
         ...
         <div class="col-sm-9 col-md-9 col-xs-12">
            ...
            <?php if ($video->enable_video_title_image == 1 && $video->video_title_image != null) { ?>
               <div class="d-flex col-md-6">
                  <img src="<?= URL::to('public/uploads/images/' . $video->video_title_image) ?>" class="c-logo"
                     alt="<?= $video->title ?>">
               </div>
               <!-- Video Title  -->
            <?php } else { ?>
         ...
         <div class="col-sm-3 col-md-3 col-xs-12">
            <div class=" d-flex mt-4 pull-right">
               <?php if ($video->trailer != '') { ?>
                  ...
                  <div style=" display: none;" class="skiptrailer btn btn-default skip">
                     <?php echo __('Skip'); ?>
                  </div>
               <?php } ?>
            </div>
   ...
   <div class="d-flex align-items-center text-white text-detail">
      <span class="badge badge-secondary p-3">
         <?php echo __($video->age_restrict); ?>
      </span>
      <span class="ml-3">
         <?php echo __($time); ?>
      </span>
      ...
      <div class="row">
         <div class="col-sm-6 col-md-6 col-xs-12">
            <ul class="list-inline p-0 mt-4 share-icons music-play-lists">
               <!-- Watchlater -->
               <li><span class="watchlater <?php if (isset ($watchlatered->id)): ?>active<?php endif; ?>"
                     data-authenticated="<?= !Auth::guest() ?>" data-videoid="<?= $video->id ?>"><i <?php if (isset ($watchlatered->id)): ?> class="ri-add-circle-fill" <?php else: ?>
                           class="ri-add-circle-line" <?php endif; ?>></i></span></li>
               <!-- Wishlist -->
               <li><span class="mywishlist <?php if (isset ($mywishlisted->id)): ?>active<?php endif; ?>"
                     data-authenticated="<?= !Auth::guest() ?>" data-videoid="<?= $video->id ?>"><i <?php if (isset ($mywishlisted->id)): ?> class="ri-heart-fill" <?php else: ?> class="ri-heart-line" <?php endif; ?>></i></span></li>
               ...
               <li>
                  ...
                  if (($user->role != "subscriber" && $user->role != "admin")) { ?>
                     <a href="<?php echo URL::to('/becomesubscriber'); ?>"><span
                           class="view-count btn btn-primary subsc-video">
   ...
   <?php if (Auth::guest()) { ?>
      <div class="row">
         <div class="col-sm-6 col-md-6 col-xs-12">
            <ul class="list-inline p-0 mt-4 share-icons music-play-lists">
               <!-- Watchlater -->
               <li><span class="watchlater <?php if (($Watchlater != null)): ?>active<?php endif; ?>"
                     data-authenticated="<?= Auth::guest() ?>" data-videoid="<?= $video->id ?>"><i <?php if (($Watchlater != null)): ?> class="ri-add-circle-fill" <?php else: ?> class="ri-add-circle-line" <?php endif; ?>></i></span></li>

               <!-- Wishlist -->
               <li><span class="mywishlist <?php if ($wishlisted != null): ?>active<?php endif; ?>"
                     data-authenticated="<?= Auth::guest() ?>" data-videoid="<?= $video->id ?>"><i <?php if ($wishlisted != null): ?> class="ri-heart-fill" <?php else: ?> class="ri-heart-line" <?php endif; ?>></i></span>
               </li>
         ...
         <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <ul class="list-inline p-0 mt-4 rental-lists">
               ...
               <?php } elseif ($video->access == "subscriber") { ?>
                  <li>
                     <a href="<?php echo URL::to('/login'); ?>"><span class="view-count btn btn-primary subsc-video">
                           <?php echo __('Subscribe'); ?>
                        </span></a>
                  </li>
                  <li>
   ...
   <div class="col-sm-4 p-0">
      <div>
         <?php if ($video->trailer != '' && $video->trailer_type != " " && $video->trailer_type != "null" && $ThumbnailSetting->trailer == 1) { ?>
            <div class="img__wrap">
               <img class="img__img " src="<?php echo URL::to('/') . '/public/uploads/images/' . $video->player_image; ?>"
               ...
               <div class="modal-dialog">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        ...
                        <?php } else { ?>
                           <video id="videos" <?= $autoplay ?> class="adstime_url"
                              poster="<?= URL::to('/') . '/public/uploads/images/' . $video->player_image ?>" controls
                              data-setup='{"controls": true, "aspectRatio":"16:9", "fluid": true}'
                              type="application/x-mpegURL">
                              <source type="application/x-mpegURL" src="<?php echo $video->trailer; ?>">
   ...
   <?php if (!empty ($video->pdf_files)) { ?>
      ...
      <p class="p1">
         <?php echo __('Download the E-Paper'); ?>
      </p>
      <div class="text-white">
         <a href="<?php echo __(URL::to('/') . '/public/uploads/videoPdf/' . $video->pdf_files); ?>"
            style="font-size:48px; color: #a51212 !important;" class="fa fa-file-pdf-o video_pdf" width="" height=""
            download></a>
      </div>
   <?php } ?>
   <?php
   ...
   <?php if (isset ($videonext)) { ?>
      <div class="next_video" style="display: none;">
         <?= $videonext->slug ?>
      </div>
   ...
   <?php } elseif (isset ($videoprev)) { ?>
      <div class="prev_video" style="display: none;">
         <?= $videoprev->slug ?>
      </div>
      <div class="next_url" style="display: none;">
         <?= $url ?>
