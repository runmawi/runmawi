                        ...
                        <div class="block-images position-relative">
                            ...
                            <div class="img-box">
                                <a class="playTrailer" href="<?php echo URL::to('play_series'); ?><?= '/' . $series_video->slug ?>">
                                    <img class="img-fluid w-100" loading="lazy" src="<?php echo URL::to('/') . '/public/uploads/images/' . $series_video->image; ?>"  alt="cate">
                                </a>
                                ...
                                <a class="playTrailer" href="<?php echo URL::to('play_series'); ?><?= '/' . $series_video->slug ?>">
                                    <img class="img-fluid w-100" loading="lazy" src="<?php echo URL::to('/') . '/public/uploads/images/' . $series_video->player_image; ?>" alt="cate">
