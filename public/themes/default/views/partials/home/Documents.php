...
<a href="<?php if ($order_Documents_settings_list->header_name) { echo URL::to('/').'/'.$order_Documents_settings_list->url ;} else { echo "" ; } ?>">
  ...
  <?php if( $settings->homepage_views_all_button_status == 1 ):?>
    <h4 class="main-title view-all"><a href="<?php if ($order_Documents_settings_list->header_name) { echo URL::to('/').'/'.$order_Documents_settings_list->url ;} else { echo "" ; } ?>"><?php echo (__('View all')); ?></a></h4> 
  <?php endif; ?>
</div>
