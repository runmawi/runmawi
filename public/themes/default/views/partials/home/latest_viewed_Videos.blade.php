                                ...
                                <li class="slide-item">
                                    <div class="block-images position-relative">
                                        <div class="border-bg">
                                            <div class="img-box">
                                                <a class="playTrailer" href="{{ URL::to('category/videos/' . $latest_view_video->slug) }}">
                                                    <img class="img-fluid w-100" loading="lazy" data-src="{{ $latest_view_video->image ? URL::to('/public/uploads/images/' . $latest_view_video->image) : $default_vertical_image_url }}" alt="{{ $latest_view_video->title }}">
                                                </a>
                                        ...
                                        <div class="block-description">
                                            <a class="playTrailer" href="{{ URL::to('category/videos/' . $latest_view_video->slug) }}">
                                                <img class="img-fluid w-100" loading="lazy" data-src="{{ $latest_view_video->player_image ? URL::to('/public/uploads/images/' . $latest_view_video->player_image) : $default_vertical_image_url }}" alt="{{ $latest_view_video->title }}">
                                            </a>
                                            @if($ThumbnailSetting->free_or_cost_label == 1)
                                                @switch(true)
                                                    @case($latest_view_video->access == 'subscriber')
