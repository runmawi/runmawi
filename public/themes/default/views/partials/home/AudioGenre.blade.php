                                      ...
                                      <div class="border-bg">
                                          <div class="img-box">
                                              <a class="playTrailer" href="{{ url('/audios/category/' . $Audio_Category->slug) }}">
                                                  <img data-src="{{ $Audio_Category->image ? URL::to('/public/uploads/audios/' . $Audio_Category->image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="{{ $Audio_Category->name }}">
                                              </a>
                                          </div>
                                      </div>
                                      <div class="block-description">
                                          <a class="playTrailer" href="{{ url('/audios/category/' . $Audio_Category->slug) }}">
                                              <img src="{{ $Audio_Category->banner_image ? URL::to('/public/uploads/audios/' . $Audio_Category->banner_image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="{{ $Audio_Category->name }}">
                                          </a>
