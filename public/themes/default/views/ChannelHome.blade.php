...
if(count($latest_video) > 0 || count($livetream) > 0 || count($latest_series) > 0 || count($audios) > 0){
    ...
    <section id="iq-favorites">
        <div class="container-fluid overflow-hidden">
            <div class="row">
                <div class="col-sm-12 ">
                    <?php include public_path('themes/default/views/partials/home/latest-videos.blade.php');  ?>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="iq-favorites">
        <div class="container-fluid overflow-hidden">
            <div class="row">
                <div class="col-sm-12 ">
                    <?php
                    include public_path('themes/default/views/partials/home/live-videos.blade.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <section id="iq-favorites">
        <div class="container-fluid overflow-hidden">
            <div class="row">
                <div class="col-sm-12 ">
                    <?php
                    include public_path('themes/default/views/partials/home/latest-series.blade.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <section id="iq-favorites">
        <div class="container-fluid overflow-hidden">
            <div class="row">
                <div class="col-sm-12 ">
                    <?php
                    include public_path('themes/default/views/partials/home/latest-audios.blade.php');
                    ?>
                </div>
            </div>
        </div>
