                            ...
                            @if(!empty(@$ChannelSignupMenu) && @$ChannelSignupMenu->mobile)
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="mobile_number" type="text" maxlength="8" minlength="8" class="form-control @error('email') is-invalid @enderror" name="mobile_number" placeholder="{{ __('Enter Mobile Number') }}" value="{{ old('mobile_number') }}" required autocomplete="off" autofocus> 
