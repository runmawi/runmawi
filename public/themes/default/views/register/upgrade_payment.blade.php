                    ...
                    <div class="col-md-12">
                        <div class="data-plans row align-items-center m-0 p-0">
                            @foreach( $plans_data_signup_checkout as $key => $plan ) 
                                ...
                                <div style="" class="col-md-4 plan_details p-0"  data-plan-id={{ 'active'.$plan->id  }}  data-plan-price={{ Currency_Convert($plan->price) }} data-plan_id={{  $plan->plan_id  }} data-payment-type={{ $plan->payment_type }} onclick="plan_details(this)">
