                        ...
                        <div class="col-12 pt-3">
                            ...
                            <div class="row pt-4" >
                                <div class="col-lg-6 col-md-12 mb-4"> 
                                    ...
                                    <div>
                                    <button style="background:#000000!important;color: #ffff!important; padding: 5px 100px !important; margin:0%;  cursor:pointer; border:none; "  class="ugc-button" >Share Profile</button>
                                    </div>
                         ...
                         <a href="{{ url('ugc/video-player/' . $eachugcvideos->slug) }}" class="m-1">
                                    <div class="ugc-videos" style="position: relative;" >
                                        ...
                                        <div class="ugc-actions">
                                            <div style="border-radius: 7px; background-color:#000000; padding:2px 5px;">
