                                        ...
                                        <div class="border-bg">
                                            <div class="img-box">
                                                <a class="playTrailer" href="{{ URL::to($base_url. '/' . $audio->slug) }}">
                                                    <img data-src="{{ $audio->image ? URL::to('/public/uploads/audios/' . $audio->image) : $default_vertical_image_url }}" src="{{ $audio->image ? URL::to('/public/uploads/audios/' . $audio->image) : $default_vertical_image_url }}" class="img-fluid w-100" alt="{{ $audio->name }}">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="block-description">
                                            <div class="hover-buttons text-white">
                                                ...
                                                <a href="{{ URL::to($base_url. '/' . $audio->slug) }}">
                                                    <p class="epi-name text-left m-0 mt-3">{{ $audio->name }}</p>
                                                </a>
                                            </div>
                                        </div>
