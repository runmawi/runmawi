...
<style>
   ...
   #series_container .staticback-btn{ display: inline-block; position: absolute; background: transparent; z-index: 1; left:1%; color: white; border: none; cursor: pointer;  font-size:25px; top:5%;}
   .vjs-icon-hd:before{display:none;}
   #series_bg { padding: 20px; background: #202933; border-radius: 20px;}
         ...
         if (Auth::guest()){
            ...
            if ($episode_play_access > 0 ){
               ...
               <div id="series_container">
                     <!-- <video id="videoPlayer"  <?= $autoplay ?> class="video-js vjs-theme5-nemisha-skin" controls preload="auto" poster="<?=URL::to('/') . '/public/uploads/images/' . $episode->player_image ?>"  data-setup="{}" width="100%" style="width:100%;" data-authenticated="<?=!Auth::guest() ?>">
                        ...
                        <?php  if(@$playerui_settings['subtitle'] == 1 ){ if(isset($episodesubtitles)){
                           ...
                           <track kind="captions" src="<?= $episodesubtitles_file->url ?>"
                              ...
                              label="<?= $episodesubtitles_file->shortcode ?>" theme5-nemisha>
                           <?php } } } ?>
                     </video> -->
                  <div id="subscribers_only"style="background: linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 1.3)) , url(<?= URL::to('/') . '/public/uploads/images/' . $episode->player_image ?>); background-repeat: no-repeat; background-size: cover;">
...
<div class="container-fluid series-details">
   <div id="series_title">
      ...
      @if(count($season) > 0)
         @php
               include public_path('themes/theme5-nemisha/views/partials/Episode/Other_episodes_list.blade.php');
         @endphp
      @endif
      @if(count($series_lists) > 0)
         @php
               include public_path('themes/theme5-nemisha/views/partials/Episode/Recommend_series_episode_page.blade.php');
         @endphp
      @endif
