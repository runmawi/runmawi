...
<div id="ShortsMinis" class="shorts-minis"  onclick="toggleShortsMinis()">
    ...
    <div id="shorts-content" style="display: none; position: relative;" >
        <div id="close-btn" onclick="closeShortsMinis(event)" style="position: absolute; top: 10px; left: -60px; font-size: 15px; cursor: pointer;  background: #3B81B4 ; padding:10px; border-top-left-radius:20px; border-bottom-left-radius:20px; z-index:10000; "> 
           <h6>Close</h6>
        </div>
