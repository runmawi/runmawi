...
<div class="iq-main-header d-flex align-items-center justify-content-between">
  <h4 class="main-title">
    ...
    <a href="<?php if ($order_settings_list[13]->header_name) { echo URL::to('/').'/'.$order_settings_list[13]->url ;} else { echo "" ; } ?>">
      ...
      <?php if ($order_settings_list[13]->header_name){ echo $order_settings_list[13]->header_name ; }
            else { echo "" ; } 
      ?>
    </a>
  </h4>  
  ...
  <div class="channel-partner home-sec list-inline row p-0 mb-0">
    <?php  if(isset($channels)) :
      foreach($channels as $channel): ?>
        <div class="items">
          <a href="<?php echo URL::to('/channel'.'/'.$channel->channel_slug  ) ?>" aria-label="channelpartnervideos">
                             <!-- block-images -->
            ...
            <a href="<?php echo URL::to('/channel'.'/'.$channel->slug) ?> " aria-label="Channel-Partner">
              ...
              <h5 style="font-size:1.0em; font-weight:500;"><?php echo __($channel->channel_name); ?></h5>
                            <!-- </div> -->
