...
<a type="button" class="btn btn-outline-danger bp mr-3" href="https://dev.nemisatv.co.za/cpp">Become a Partner</a>
            ...
            <div class="mt-3 ">
                <ul class="nav nav-pills   m-0 p-0" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                         <a class="nav-link" class="btn btn-secondary btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">More <i class="fa fa-angle-down" aria-hidden="true"></i>
</a>
                        <div class="dropdown-menu">
    <a class="nav-link dropdown-item" id="pills-kids-tab" data-toggle="pill" href="#pills-kids" role="tab" aria-controls="pills-kids" aria-selected="false">Comic & Kids</a>
...
<div class="tab-content" id="pills-tabContent">
              ...
              <div class="card" >
                  <div style="position: relative;">
                      <img class="w-100 " src="<?php echo  URL::to('/assets/img/r1.png')?>" style="">
                        ...
                        <p class="small bkm"><i class="fa fa-clock-o" aria-hidden="true"></i> 1H 15Min</p>
                  </div>
  ...
  <div class="card-body">
   ...
   <div class="d-flex small-t ">
       <a herf="" class="btn btn-success suce mr-3"><i class="fa fa-thumbs-up mr-2" aria-hidden="true"></i> 96</a>
