...
/* Dark mode and light Mode */
    ...
    body.light-theme .dropdown-menu.categ-head{
        ...
        body.light-theme .series_title h2{
           color: #000!important;
...
@media screen and (max-height: 450px) {
  ...
  .sidebar a {
   ...
   <ul id="" class="nav navbar-nav <?php if ( Session::get('locale') == 'arabic') { echo "navbar-right"; } else { echo "navbar-left";}?>">
                                       ...
                                       <li class="dropdown menu-item" >
                                           <a class="dropdown-toggle" id="down" href="<?php echo URL::to('/').$menu->url;?>" data-toggle="dropdown" >  
                                                 <a style="height:45px;"  class="d-flex  align-items-center" href="<?php echo  URL::to('/categoryList');?>"> <img class=""  src="<?php echo  $menu->image ?>" /> <?php echo __($menu->name);?>  
                                        ...
                                        ?>
                                          <li class="dropdown menu-item">
                                           <a class="dropdown-toggle" id="down" href="<?php echo URL::to('/').$menu->url;?>" data-toggle="dropdown" >  
                                                 <a style="height:45px;" class="d-flex align-items-center" href="<?php echo  URL::to('/Movie-list');?>">  <img class=""  src="<?php echo  $menu->image ?>" /><?php echo __($menu->name);?>  
                                                   <!--<i class="ri-arrow-down-s-line"></i>-->
                                                </a>
                                            </a>
                                            <ul class="dropdown-menu categ-head">
                                       ...
                                       $LiveCategory = App\LiveCategory::get();
                                        ?>
                                          <li class="dropdown menu-item">
                                            <a class="dropdown-toggle" id="down" href="<?php echo URL::to('/').$menu->url;?>" data-toggle="dropdown" >  
                                                 <a style="height:45px;" class="d-flex align-items-center" href="<?php echo  URL::to('/Live-list');?>">   <img class=""  src="<?php echo  $menu->image ?>" /><?php echo __($menu->name);?>  
                                                  <!-- <i class="ri-arrow-down-s-line"></i>-->
                                                </a>
                                          </a>
                                            <ul class="dropdown-menu categ-head">
                              ...
                              <?php }elseif ( $menu->in_menu == "audios") { 
                                 ...
                                 ?>
                              <li class="dropdown menu-item">
                                 <a class="dropdown-toggle" style="height:45px;" id="dn" href="<?php echo URL::to('/').$menu->url;?>" data-toggle="dropdown">  
                              ...
                              <?php }elseif ( $menu->in_menu == "tv_show") { 
                                          ...
                                          ?>
                                                <li class="dropdown menu-item">
                                                   <a class="" id="" href="<?php echo URL::to('/').$menu->url;?>" >                                                  <a class="d-flex justify-content-between" href="<?php echo  URL::to('/Movie-list');?>"> <?php echo __($menu->name);?>  
                                          ...
                                          <?php } else { ?>
                                          <li class="menu-item">
                                          <a class="akm" href="<?php if($menu->select_url == "add_Site_url"){ echo URL::to('/').$menu->url; }elseif($menu->select_url == "add_Custom_url"){ echo $menu->custom_url;  }?>">
                                               <!-- <img class=""  src="<?php echo  URL::to('/assets/img/home.png')?>" /> <span class="mt-2" ><?php echo __($menu->name);?></span> -->
                                               <img class=""  src="<?php echo  $menu->image ?>" /> <span class="" ><?php echo __($menu->name);?></span>
...
<g>
	...
	<path class="st0" d="M38.5,54.2H15.3l0,0v-2.8c0-9,6.8-16.7,15.8-17.2c4.3-0.5,8.4,1.1,11.5,3.6c0.1,0.1,0.5,0.1,0.4,0l1.8-1.8
	...
	<path class="st0" d="M62.2,48.6v-2.4c0-0.5-0.2-0.5-0.5-0.5H59c-0.2,0-0.4-0.1-0.5-0.4c-0.1-0.4-0.5-0.7-0.4-1.1
...
<g>
	...
	<path class="st0" d="M56.7,42.9c-1.5-1.5-3.5-2.2-5.5-2.2c-0.5,0-0.5-0.2-0.5-0.5V8.7c0-0.5-0.1-0.6-0.5-0.8s-0.5-0.5-0.8-0.5H13.5
