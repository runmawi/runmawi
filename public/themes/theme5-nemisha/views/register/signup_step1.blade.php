...
<nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
  ...
  <a class="navbar-brand" href="#"><img class="login-header-logo" src="<?php echo URL::to('/assets/img/co-creataz-final.svg'); ?>" width=75 height=75></a>
                      ...
                      <form onsubmit="return ValidationEvent()" action="<?php if (isset($ref) ) { echo URL::to('/').'/register1?ref='.$ref.'&coupon='.$coupon; } else { echo URL::to('/').'/register1'; } ?>" method="POST" id="stripe_plan" class="stripe_plan" name="member_signup" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-7 col-sm-8">
                                <input id="mobile" type="text" maxlength="10" minlength="8" class="form-control @error('email') is-invalid @enderror" name="mobile" placeholder="{{ __('Enter Mobile Number') }}" value="{{ old('mobile') }}" required autocomplete="off" autofocus> 
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="sign-up-buttons col-md-12 mt-3 " align="right">
                                  ...
                                  <input class="btn  btn-primary btn-block signup" style="border: #f3ece0 !important;color:#fff;font-size:20px;background-color: #ed1c24 !important;display: block;" type="submit" name="create-account" value="START EXPLORING TODAY">
