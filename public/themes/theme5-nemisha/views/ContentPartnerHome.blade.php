...
<section class="mt-5 mb-5">
    <div class="container-fluid">
        <div class="row ">
            ...
            <div class="col-2 col-lg-2">
            <a class="lkn" data-video="{{ @$Content_Partner->intro_video }}" data-toggle="modal" data-target="#videoModal" data-backdrop="static" data-keyboard="false" style="cursor: pointer;">	
