...
<section id="iq-favorites">
      <h3 class="vid-title text-center mt-4 mb-5">Live Artist Event</h3> 
                           ...
                           <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                            <a  href="{{ route('live_event_play',$artist_live_events->slug ) }}" >	
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img loading="lazy" data-src="<?php echo URL::to('/').'/public/uploads/images/'.$artist_live_events->image;  ?>" class="img-fluid" alt="">
...
<?php include(public_path('themes/theme5-nemisatv/views/footer.blade.php'));  ?>
