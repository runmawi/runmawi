...
h4.title{font-weight:normal; font-size:23px;}
...
.sign-info button.btn.btn-primary{
    font-size:25px;
            ...
            <div class="sign-user_card ">                    
               <div class="sign-in-page-data">
                    ...
                    <div class="row justify-content-center">
                        <h4 class="title"><?= "Login to your NXS account" ?></h4>
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="mt-4">
                                ...
                                <div class="d-flex justify-content-end links">
                                            ...
                                            <a href="{{ route('Reset_Password') }}" class="f-link mb-2">{{ __("Can't Login") }}?</a>
                                </div>
                                ...
                                <div class="sign-info mt-3">
                                    <button type="submit" class="btn btn-primary" style="width:100%;color:#fff!important;">LOGIN</button>                     
                                </div> 
