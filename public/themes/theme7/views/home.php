   ...
   <div class="thumb-cont" id="<?= $latest_video->id;?>"  style="background:url('<?php echo URL::to('/').'/public/uploads/images/'.$latest_video->image;  ?>') no-repeat;background-size: cover;">
      ...
      <div class="tab-sec">
         <div class="tab-content">
            <div id="overview<?= $latest_video->id;?>" class="container tab-pane active">
               <br>
            ...
            <div id="trailer<?= $latest_video->id;?>" class="container tab-pane ">
               <br>
            ...
            <div id="like<?= $latest_video->id;?>" class="container tab-pane ">
               <br>
               <h2>More Like This</h2>
            </div>
            <div id="details<?= $latest_video->id;?>" class="container tab-pane ">
               <br>
               <h2>Description</h2>
            </div>
         </div>
...
<!-- Trailer -->
<?php
   include(public_path('themes/theme7/views/partials/home/Trailer-script.php'));
