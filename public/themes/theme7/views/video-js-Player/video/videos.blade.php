...
{{-- video-js Script --}}
    ...
    <div class="container-fluid p-0">
        ...
        @else
            ...
            <div class="custom-skip-forward-button" onclick="skipForward(10)">
            ...
            <div class="custom-skip-backward-button" onclick="skipBackward(10)">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 512 512">
            ...
            <video id="my-video" class= "vjs-big-play-centered vjs-theme-city my-video-dimensions video-js vjs-play-control customVideoPlayer vjs-fluid vjs-controls-enabled vjs-workinghover vjs-v7 videojs-hls-source-selector videojs-hls-quality-selector vjs-has-started vjs-paused vjs-layout-x-large vjs-user-inactive" controls 
...
@php 
    ...
    include public_path('themes/theme7/views/video-js-Player/video/videos_script_file.blade.php');
    include public_path('themes/theme7/views/video-js-Player/video/videos_ads.blade.php');
    include public_path('themes/theme7/views/video-js-Player/video/player_script.blade.php');
