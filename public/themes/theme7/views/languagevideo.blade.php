                        ...
                        <div class="slider-inner h-100">
                            <div class="row align-items-center  h-100">
                                <div class="col-xl-6 col-lg-12 col-md-12">
                                    <h1 class="slider-text title text-uppercase" data-animation-in="fadeInLeft" data-delay-in="0.6">{{ strlen($item->title) > 13 ? substr($item->title, 0, 14) . '...' : $item->title }}</h1>
                                    ...
                                    <div class="d-flex align-items-center r-mb-23" id="lang-slider" data-animation-in="fadeInUp"  data-delay-in="1.2">
