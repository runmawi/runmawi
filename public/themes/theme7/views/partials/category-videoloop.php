                                    ...
                                    <a href="<?php echo URL::to('category'); ?><?= '/videos/' . $category_video->slug ?>">
                                        ...
                                        <div class="movie-time d-flex align-items-center pt-1">
                                            ...
                                            <a type="button" class="epi-name mt-3 mb-0 btn"
                                                ...
                                                <img class="d-inline-block ply" alt="ply" src="<?php echo URL::to('/') . '/assets/img/theme7_play_buttons.svg'; ?>"
                                    ...
                                    <a
                                        ...
                                        <div class="hover-buttons">
                                            <a type="button" class="text-white d-flex align-items-center"
                                                href="<?php echo URL::to('episode'); ?><?= '/' . @$Episode_video->series_slug . '/' . $Episode_video->slug ?>">
                                                <img class="ply mr-1" src="<?php echo URL::to('/') . '/assets/img/theme7_play_buttons.svg'; ?>" width="10%"
