...
<div class="row" id="signup-form" class="wrapper">
...
<?php endif; ?>
<script src="<?= THEME_URL . '/assets/js/jquery-3.3.1.min.js'; ?>"></script>
<script src="<?= THEME_URL . '/assets/js/jquery.steps.js'; ?>"></script>
