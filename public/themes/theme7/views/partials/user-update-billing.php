<h2 class="form-signin-heading"><i class="fa fa-credit-card"></i><?= __('Update Your Credit Card Info') ?> </h2>
      ...
      <div class="panel panel-default registration">
        ...
        <div class="panel-heading">
          ...
          <div class="row">
              ...
              <h1 class="panel-title col-lg-7 col-md-8 col-sm-6" style="line-height:40px;"><?= __('Update Your Info Below') ?></h1>
      ...
      <div class="panel-footer clearfix">
        <div class="pull-left col-md-7 terms" style="padding-left: 0;"></div>
          ...
          <div class="pull-right sign-up-buttons">
          	<a href="<?= ($settings->enable_https) ? secure_url('user') : URL::to('user') ?><?= '/' . $user->username; ?>/billing" class="btn" style="color: #98cb00;"><?= __('Cancel') ?></a>
            <button class="btn btn-primary" type="submit" name="create-account"><?= __('Update Credit Card') ?></button>
