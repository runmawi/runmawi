...
if (isset($latest_series)):
  ...
  <div class="iq-main-header d-flex align-items-center justify-content-between">
    <h4 class="main-title">
      ...
      <a
        href="<?php if ($order_settings_list[14]->header_name) {
          echo URL::to('/') . '/' . $order_settings_list[14]->url;
        } else {
          echo "";
        } ?>">
              ...
              <div class="border-bg">
                <div class="img-box">
                  <a class="playTrailer" href="<?php echo URL::to('/contentpartner' . '/' . $content_user->slug) ?>">
                    <img
                      src="<?php if ($content_user->picture == 'Default.png') {
                        echo URL::to('/') . '/public/uploads/images/' . $settings->default_video_image;
                      } else {
                        echo URL::to('/public/uploads/moderator_albums' . '/' . $content_user->picture);
                      } ?>"
                      class="img-fluid w-100" alt="content_user">
