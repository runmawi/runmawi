                ...
                <li class="slide-item">
                                ...
                                <a class="playTrailer" href="<?= URL::to('live/'. $latest_view_livestreams->slug ); ?>">
                                    ...
                                    <?php if($ThumbnailSetting->free_or_cost_label == 1) { ?>
                                        ...
                                        <?php }elseif( !empty($latest_view_livestreams->global_ppv || !empty($latest_view_livestreams->global_ppv) && $latest_view_livestreams->ppv_price == null)){ ?>
                                            <p class="p-tag1"><?php echo $latest_view_livestreams->global_ppv . ' ' . $currency->symbol; ?></p>
                  ...
                  <?php if($ThumbnailSetting->title == 1) { ?> 
                          ...
                          <p class="epi-name text-left m-0">
                            <?php echo strlen($latest_view_livestreams->title) > 17 ? substr($latest_view_livestreams->title, 0, 18) . '...' : $latest_view_livestreams->title; ?></p>
                                    <?php } ?>

                                    <div class="movie-time d-flex align-items-center pt-1">
                                        <?php if($ThumbnailSetting->age == 1) { ?>      <!-- Age -->
                                            <div class="badge badge-secondary p-1 mr-2"><?php echo $latest_view_livestreams->age_restrict . ' ' . '+'; ?></div>
                                        <?php } ?>
                                    ...
                                    <?php if(($ThumbnailSetting->published_year == 1) || ($ThumbnailSetting->rating == 1)) {?>
                                        <div class="movie-time d-flex align-items-center pt-1">
                                            ...
                                            <?php if($ThumbnailSetting->featured == 1 && $latest_view_livestreams->featured == 1) { ?>  <!-- Featured -->
                                                <div class="badge badge-secondary p-1 mr-2">
                                                    <span class="text-white">
                                    ...
                                    <div class="movie-time d-flex align-items-center pt-1">
                                        ...
                                        <a class="epi-name mt-3 mb-0 btn"
                                            href="<?= URL::to('live/'. $latest_view_livestreams->slug ); ?>">
                                            <img class="d-inline-block ply" alt="ply" src="<?php echo URL::to('/') . '/assets/img/theme7_play_buttons.svg'; ?>" width="10%"
                                                height="10%" /> Watch Now
                                        </a>
                                        </div>
            </div>
