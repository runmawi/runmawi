    ...
    <div class="row">
        <div class="col-sm-12 ">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
                <a href="<?php echo URL::to('/series/category') . '/' . $category->slug; ?>" class="category-heading"
                ...
                <h4 class="main-title"><a href="<?php echo URL::to('/series/category') . '/' . $category->slug; ?>">
                                    ...
                                    <div class="border-bg">
                                        <div class="img-box">
                                            <a class="playTrailer"
                                                ...
                                                <img src="<?php echo URL::to('/') . '/public/uploads/images/' . $series_video->image; ?>"
                                            ...
                                            <?php if ($ThumbnailSetting->free_or_cost_label == 1) { ?>
                                                ...
                                                <?php } elseif (!empty($series_video->ppv_price)) {
