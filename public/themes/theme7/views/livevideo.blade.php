...
@php
    include(public_path('themes/theme3/views/livevideo_ads.blade.php'));
@endphp
            ...
            <?php  } elseif ( ( ($video->access = "subscriber" && ( Auth::guest() == true || Auth::user()->role == "registered" ) ) ||  ( $video->access = "ppv" && Auth::check() == true ? Auth::user()->role != "admin" : Auth::guest() ) ) && $video->free_duration_status == 1 && $video->free_duration != null ) {  ?>       
                ...
                <div class="">
                    ...
                    <?php else: ?>
                        ...
                        <video id="live-stream-player" class="vjs-big-play-centered vjs-theme-city my-video video-js vjs-play-control 
                         vjs-control customVideoPlayer vjs-fluid vjs_video_1462 vjs-controls-enabled vjs-picture-in-picture-control vjs-workinghover vjs-v7 vjs-quality-selector vjs-has-started vjs-paused vjs-layout-x-large vjs-user-inactive" controls
                                    preload="auto" width="auto" height="auto" playsinline="playsinline" muted="muted" preload="yes" autoplay="autoplay" poster="<?= $Livestream_details->Player_thumbnail ?>">
                                    <source src="<?= $Livestream_details->livestream_URL ?>" type="<?= $Livestream_details->livestream_player_type ?>">
                        </video>
    ...
    <div class="container-fluid video-details">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-9 col-xs-12">
                <h1 class="trending-text text-uppercase mt-3"><?php echo __($video->title);?> <?php if( Auth::guest() ) { ?>  <?php } ?></h1>
                    <!-- Category -->
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-xs-12">
                 <ul class="list-inline p-0 mt-4 share-icons music-play-lists">
                      ...
                      <?php include(public_path('themes/theme7/views/partials/live-social-share.php')) ; ?>  
                  </ul>
            </div>
        ...
        -->                 
            ...
            <?php if( App\CommentSection::first() != null && App\CommentSection::pluck('livestream')->first() == 1 ): ?>
                <div class="">
                    <div class=" container-fluid video-list you-may-like overflow-hidden">
                        ...
                        <?php include(public_path('themes/theme7/views/comments/index.blade.php'));?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="">
                <div class=" container-fluid video-list you-may-like overflow-hidden">
                    ...
                    <div class="slider">   
                        <?php include(public_path('themes/theme7/views//partials/live_related_video.blade.php'));?>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php if( $paydunya_payment_setting != null && $paydunya_payment_setting->payment_type == "Paydunya" ){?>
                                    <label class="radio-inline mb-0 mt-2 mr-2 d-flex align-items-center text-black" style="gap:5px;">
                                        <input type="radio" class="payment_btn" id="important" name="payment_method" value="<?= $paydunya_payment_setting->payment_type ?>"  data-value="Paydunya" >
                                        <?php  echo $paydunya_payment_setting->payment_type ;  ?>
                                    </label>
                                <?php } ?>
                            </div>
                        </div>                    
                    ...
                    <div class="modal-footer">
                        ...
                        <?php if( $video->ppv_price != null &&  $video->ppv_price != " " ) {?>
                            ...
                            <div class="Paydunya_button">   <!-- Paydunya Button -->
                                <?php if( $paydunya_payment_setting != null && $paydunya_payment_setting->payment_type == "Paydunya" ){?>
                                        <button class="btn2  btn-outline-primary " onclick="location.href ='<?= URL::to('Paydunya_live_checkout_Rent_payment/'.$video->id.'/'.$video->ppv_price) ?>' ;" > Continue </button>
                                <?php } ?>
                            </div>
                        <?php } ?>
  ...
  window.onload = function(){ 
     ...
     $(document).ready(function(){
      ...
      $(".payment_btn").click(function(){
        ...
        $('.Razorpay_button,.Stripe_button,.paystack_button,.cinetpay_button,.Paydunya_button').hide();

        let payment_gateway =  $('input[name="payment_method"]:checked').val();

            if( payment_gateway  == "Stripe" ){

                $('.Razorpay_button,.paystack_button,.cinetpay_button,.Paydunya_button').hide();
                $('.Stripe_button').show();
