...
<ul class="list-group home-search" style="display: block; position: relative; z-index: 999999; margin-bottom: 0; border-radius: 0; ">
    ...
    <?php foreach ($latest_videos as $row) { ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            <div style="flex-shrink: 0; margin-right: 10px;">
                <img src="<?php echo URL::to('/') . '/public/uploads/images/' . $row->image; ?>" alt="<?php echo $row->title; ?>" style="max-width: 35px; max-height: 35px; width: auto; height: auto;">
            </div>
            <div>
                <a class="text-white" href="<?php echo URL::to('/') . '/category/videos/' . $row->slug; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title; ?></a>
            </div>
        </li>
    <?php } ?>
    ...
    <?php foreach ($latest_livestreams as $row) { ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            ...
            <div>
                <a class="text-white" href="<?php echo URL::to('/') . '/live' .'/'. $row->slug ; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title; ?></a>
            </div>
        </li>
    <?php } ?>
    ...
    <?php foreach ($latest_audio as $row) { ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            ...
            <div>
                <a class="text-white" href="<?php echo URL::to('/') . '/audio/' . $row->slug ; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title ; ?></a>
            </div>
        </li>
    <?php } ?>
    ...
    ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            ...
            <div>
                <a class="text-white" href="<?php echo URL::to('/') . '/episode' .'/'. $series_slug . '/'. $row->slug ; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title ; ?></a>
            </div>
        </li>
    <?php } ?>
    ...
    <?php foreach ($latest_Series as $row) { ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            ...
            <div>
                <a class="text-white" href="<?php echo URL::to('/') . '/play_series' .'/'. $row->slug ; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title ; ?></a>
            </div>
        </li>
    <?php } ?>
...
<ul class="list-group home-search" style="display: block; position: relative; z-index: 999999; margin-bottom: 0; border-radius: 0;">
    ...
    <?php foreach ($Series as $row) { ?>
        <li class="list-group-item" style="display: flex; align-items: center;">
            ...
            <div>
                <a href="<?php echo URL::to('/') . '/play_series' .'/'. $row->slug ; ?>" style="color: #fff !important; text-decoration: none;"><?php echo $row->title ; ?></a>
            </div>
        </li>
    <?php } ?>
