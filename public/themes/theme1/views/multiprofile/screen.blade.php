	...
	<div class="admin-section-title">
		...
		<div class="row">
            ...
            <div class="col-md-8" align="right">
                <a href="javascript:;" onclick="jQuery('#screen-new').modal('show');" class="btn btn-primary"><i class="fa fa-plus-circle"></i>{{ __('Update') }} </a>
            </div>
			...
			<div class="modal-content">
				...
				<div class="modal-body p-3">
					<form id="screenss" accept-charset="UTF-8" action="{{ URL::to('admin/ChooseProfileScreen_store') }}" method="post" enctype="multipart/form-data">
				        ...
				        <input name="screen_name" id="screen_name" placeholder="{{ __('Screen Name') }}"  class="form-control" value="" /><br />
