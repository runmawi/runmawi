...
<div class="container-fluid">
   <div class="row">
      <div class="col-sm-12 page-height">
         ...
         @if(isset($DocumentCategoryListPage['latest_Documents']) && count($DocumentCategoryListPage['latest_Documents']) > 0 )

            <div class="iq-main-header align-items-center justify-content-between">
               <h3 class="vid-title">{{ __($DocumentCategoryListPage['DocumentGenre_Name']) }}</h3>
            </div>
            <div class="favorites-contens">
               <ul class="category-page list-inline row p-0 mb-0">
                     @forelse($DocumentCategoryListPage['latest_Documents'] as $Document)
                           ...
                           <a  target="_blank" href="{{ url('public/uploads/Document/'.$Document->document) }}">
                              <div class="block-images position-relative">
                                 ...
                                 <div class="block-description">
                                    @if( $DocumentCategoryListPage['ThumbnailSetting']->title == 1)  <!-- Title -->
                                       <a  target="_blank" href="{{ url('public/uploads/Document/'.$Document->document) }}">
               ...
               <div class="col-md-12 pagination justify-content-end" >
                  {!! $DocumentCategoryListPage['latest_Documents']->links() !!}
               </div>
