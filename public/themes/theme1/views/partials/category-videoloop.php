                        ...
                        <div class="block-images position-relative">
                                <a href="<?php echo URL::to('category') ?><?= '/videos/' . $top_category_video->slug ?>">
                                        <!-- <img src="<?php echo URL::to('/').'/public/uploads/images/'.$top_category_video->image;  ?>"
                                            class="img-fluid" alt=""> -->
                                            <video  width="100%" height="auto" class="play-video" poster="<?php echo URL::to('/').'/public/uploads/images/'.$top_category_video->mobile_image;  ?>"  data-play="hover" >
                ...
                <?php  if(!empty($data['password_hash'])) { 
                    ...
                    <li class="slide-item">
                            ...
                            <a href="<?php echo URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">
                                    <!-- <img src="<?php echo URL::to('/').'/public/uploads/images/'.$category_video->mobile_image;  ?>"
                                        class="img-fluid" alt=""> -->
                       ...
                       <!-- </a> -->
                        ...
                        <div class="mt-2 d-flex justify-content-between">
                            <a href="<?php echo URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">
                                            <h6><?php  echo (strlen($category_video->title) > 19) ? substr($category_video->title,0,20).'...' : $category_video->title; ?></h6>
                                    </a>
