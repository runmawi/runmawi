                    ...
                    <li class="slide-item">
                        <div class="block-images position-relative">
                            <a href="<?php echo URL::to('category') ?><?= '/videos/' . $top_category_video->slug ?>">
                                <img loading="lazy" src="<?php echo URL::to('/').'/public/uploads/images/'.$top_category_video->image;  ?>"
                                            class="img-fluid" alt=""> -->
                    ...
                    <li class="slide-item">
                        <div class="block-images position-relative">
                            ...
                            <a href="<?php echo URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">
                                <img loading="lazy" src="<?php echo URL::to('/').'/public/uploads/images/'.$category_video->image;  ?>"
                                        class="img-fluid" alt=""> -->
