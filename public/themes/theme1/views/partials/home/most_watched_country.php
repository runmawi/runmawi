                ...
                <div class="block-images position-relative">
                    <div class="img-box">
                        <a href="<?php echo URL::to('category') ?><?= '/videos/' . $Most_watched_countries->slug ?>">
                            <img loading="lazy" data-src="<?php echo URL::to('/').'/public/uploads/images/'.$Most_watched_countries->player_image;  ?>" class="img-fluid" alt=""> -->
                            <!--<video width="100%" height="auto" class="play-video lazy" poster="<?php echo URL::to('/').'/public/uploads/images/'.$Most_watched_countries->player_image;  ?>" data-play="hover">
