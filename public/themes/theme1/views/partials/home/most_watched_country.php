        ...
        <ul class="favorites-slider list-inline  row p-0 mb-0">
                ...
                <li class="slide-item">
                    <a href="<?php echo URL::to('home') ?>">
                        <div class="block-images position-relative">
                                <div class="img-box">
                                    <a  href="<?php echo URL::to('category') ?><?= '/videos/' . $Most_watched_countries->slug ?>">
                                        ...
                                        <video width="100%" height="auto" class="play-video" poster="<?php echo URL::to('/').'/public/uploads/images/'.$Most_watched_countries->mobile_image;  ?>"  data-play="hover" >
                        ...
                        <a  href="<?php echo URL::to('category') ?><?= '/videos/' . $Most_watched_countries->slug ?>">
                                 <h6><?php  echo (strlen($Most_watched_countries->title) > 19) ? substr($Most_watched_countries->title,0,20).'...' : $Most_watched_countries->title; ?></h6>
                             </a>
                            <div class="badge badge-secondary p-1 mr-2">
                                <?php echo $Most_watched_countries->age_restrict ?>
                            </div>
                        </div>
