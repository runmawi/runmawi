...
<?php include public_path('themes/theme1/views/comments/commentbox.blade.php'); ?>
...
<div class="bg-border col-lg-6 p-2">
    ...
    <div class="media-body">
        ...
        <?php include public_path('themes/theme1/views/comments/comment_edit_modal.blade.php'); ?>
        <?php include public_path('themes/theme1/views/comments/comment_edit_reply_modal.blade.php'); ?>
        <?php include public_path('themes/theme1/views/comments/comment_reply_modal.blade.php'); ?>
