...
<section id="iq-favorites">
    <h3 class="vid-title text-center mt-4 mb-5">{{  $page_name." "."List" }}</h3>
                                ...
                                @if(isset($albums_list)) 
                                    @foreach($albums_list as $albums_lists)
                                        ...
                                        <li class="slide-item col-sm-2 col-md-2 col-xs-12">
                                            <a href="{{ URL::to('album').'/'.$albums_lists->slug }}">
                                                <div class="block-images position-relative">
                                                    <div class="img-box">
                                                        <img loading="lazy" data-src="<?php echo URL::to('/').'/public/uploads/albums/'.$albums_lists->album;  ?>" class="img-fluid loading" alt=""> 
                                                    </div>
                                                ...
                                                <div class="">
                                                    <div class="mt-2 d-flex justify-content-between p-0">
                                                        <h6><?php  echo (strlen($albums_lists->albumname) > 17) ? substr($albums_lists->albumname,0,18).'...' : $albums_lists->albumname; ?></h6>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
