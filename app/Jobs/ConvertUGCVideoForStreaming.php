...
class ConvertUGCVideoForStreaming implements ShouldQueue
{
     ...
     *
    * @param UGCVideo $video
     */
    public function __construct(UGCVideo $video)
    {
        $this->video = $video;
    }
    ...
    public function handle()
    {
        ...
        $converted_name = ConvertUGCVideoForStreaming::getCleanFileName($video);
