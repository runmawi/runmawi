...
class LiveStream extends Model
{
	...
	protected $fillable = array('id','video_category_id', 'slug' , 'status' ,'title', 'details', 'description', 'featured','banner', 'footer', 'duration', 'image', 'mp4_url','language' ,'year','created_at','free_duration','pre_post_ads','mid_ads','CPP_commission_percentage', 'price');
