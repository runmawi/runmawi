...
//        unset($data['tags']);
    ...
    // live stream video
        if(!empty($data['live_stream_video'])){
            ...
            $videos->hls()
                    ->x264()
                    ->addRepresentations([$r_144p,$r_360p,$r_480p,$r_720p])
        ...
        try {
            ...
            $email_log      = 'Mail Sent Successfully from Partner Content Live Stream Successfully Uploaded & Awaiting Approval !';
            $email_template = "44";
            $user_id = $user_id;
