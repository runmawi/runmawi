...
class AdminLiveEventArtist extends Controller
{
    ...
    public function create(Request $request){
        ...
        if ($current_date > $duedate)
        {
            ...
            $data = array(
                ...
                'post_route' => route('live_event_store'),
    ...
    public function store(Request $request)
    {
        ...
        $languages = $request['language'];
            ...
            if( $data['url_type'] == "Encode_video" ){
                return redirect()->route('live_event_artist')->with([
                                                            'Stream_key' => $Stream_key,
                                                            'Stream_error' => '1' ,
                ...
                return redirect()->route('live_event_artist')->with(array('message' => 'New PPV Video Successfully Added!', 'note_type' => 'success') );
            }
    }
    ...
    public function edit($id)
    {
        ...
        $data = array(
            ...
            'video' => $video,
            'post_route' => route('live_event_update',$id),
        ...
        return View::make('admin.live_event_artist.edit',$data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if(!empty($data['url_type']) && $video['url_type'] == "Encode_video" &&  $data['url_type'] == "Encode_video"   ){
            ...
            return redirect()->route('live_event_edit',$id)->with(
            ...
            return redirect()->route('live_event_edit',$id)->with(array('message' => 'Successfully Updated Video!', 'note_type' => 'success') );
        }
