                    ...
                    if (count($total_content) > 0) {
                        ...
                        if (!empty($total_content)) {
                            ...
                            foreach ($total_content as $key => $row) {
                                $video_url = URL::to('/category/videos') . '/' . $row->slug;
                      ...
                      <td><a href="'.$video_url.'">' .
                                    ...
                                    '</a></td>    
                      <td>' .
                                    $currency->symbol.' '.$row->total_amount .
                                    '</td>    
                      <td>' .
                                    $newDate .
                                    '</td>    
                ...
                if (
                    ...
                    if (count($total_content) > 0) {
                        foreach ($total_content as $each_user) {
                            ...
                            $video_url = URL::to('/category/videos') . '/' . $each_user->slug;
                ...
                if($mp4_url != '' && $pack != "Business" ) {
                    ...
                    $choose_time = $data['choose_time'];
                        if(!empty($choose_time)){
                            ...
                            $date_choosed = date_format($date,"Y/m/d");
...
// 
            ...
            public function IndexScheduledVideoss(Request $request)
            {
                if ($request->ajax()) {
                    ...
                    return datatables()->of($ScheduleVideos)
