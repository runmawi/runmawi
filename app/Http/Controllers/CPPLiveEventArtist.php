...
class CPPLiveEventArtist extends Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            return View('moderator.cpp.live_event_artist.index', $data);
    ...
    public function create(Request $request){
        ...
        if ($current_date > $duedate)
        {
            ...
            $data = array(
                ...
                'post_route' => URL::to('cpp/live-event-store'),
            ...
            return View('moderator.cpp.live_event_artist.create', $data);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $languages = $request['language'];
            ...
            if( $data['url_type'] == "Encode_video" ){
                ...
                return Redirect::to('cpp/live-event-artist')->with(array('message' => 'New PPV Video Successfully Added!', 'note_type' => 'success') );
            }
    }
    ...
    public function edit($id)
    {
        ...
        $data = array(
            ...
            'video' => $video,
            'post_route' => URL::to('cpp/live-event-update').'/'.$id,
        ...
        return View('moderator.cpp.live_event_artist.edit', $data);
