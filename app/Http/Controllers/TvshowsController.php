        ...
        try {
            ...
            if($this->Theme == "default" || $this->Theme == "theme6"){
                ...
                $data = [
                    ...
                    'multiple_compress_image' => (new FrontEndQueryController)->multiple_compress_image()->take(15) ,
                    'Series_based_on_category' => (new FrontEndQueryController)->Series_based_on_category()->take(15) ,
                    'Series_based_on_Networks' => (new FrontEndQueryController)->Series_based_on_Networks()->take(15) ,
                    'ThumbnailSetting'  => ThumbnailSetting::first(),
                    'default_vertical_image_url' => default_vertical_image_url(),
                    'default_horizontal_image_url' => default_horizontal_image_url(),
                    'order_settings_list' => $OrderHomeSetting, 
