...
class ChannelSeriesController extends Controller
{
    ...
    public function index(Request $request)
    {
          ...
          $search_value = $request->get('s');
            ...
            if(!empty($search_value)):
                ...
                $series = Series::where('user_id','=',$id)->where('uploaded_by','Channel')->orderBy('created_at', 'DESC')->paginate(9);
            endif;
    ...
    public function store(Request $request)
    {
       ...
       // $this->addUpdateSeriesTags($series, $tags);
        ...
        return Redirect::to('channel/series-list')->with(array('note' => 'New Series Successfully Added!', 'note_type' => 'success') );
    }
    ...
    public function edit($id)
    {
        ...
        // $id = $user->id;
            ...
            $series = Series::where('id','=',$id)->where('uploaded_by','Channel')->first();
            $results = Episode::all();
            $settings  = Setting::first();
            
            //$episode = Episode::all();
            $seasons = SeriesSeason::where('series_id','=',$id)->where('uploaded_by','Channel')->with('episodes')->get();
    ...
    public function update(Request $request)
    {
        ...
        return Redirect::to('channel/series/edit' . '/' . $id)->with(array('note' => 'Successfully Updated Series!', 'note_type' => 'success') );
    }
...
//        SeriesSubtitle::where('series_id', '=', $id)->delete();
        ...
        return Redirect::to('channel/series-list')->with(array('note' => 'Successfully Deleted Series', 'note_type' => 'success') );
    }
...
if($trailer != '' && $pack == "Business"  && $settings->transcoding_access  == 1) {
    ...
    public function destroy_season($id)
    {
        ...
        return Redirect::to('channel/series/edit' . '/' . $id)->with(array('note' => 'Successfully Deleted Season', 'note_type' => 'success') );
    }
    ...
    public function create_episode(Request $request)
    {
        ...
        return Redirect::to('channel/season/edit/'.$data['series_id'].'/'.$data['season_id'])->with(array('note' => 'New Episode Successfully Added!', 'note_type' => 'success') );
    }
    ...
    public function destroy_episode($id)
    {
        ...
        return Redirect::to('channel/season/edit' . '/' . $series_id.'/'.$season_id)->with(array('note' => 'Successfully Deleted Season', 'note_type' => 'success') );
    }
    ...
    public function update_episode(Request $request)
    {
        ...
        $episode = Episode::findOrFail($id);
        return Redirect::to('channel/season/edit' . '/' . $episode->series_id .'/'.$episode->season_id)->with(array('note' => 'Successfully Updated Episode!', 'note_type' => 'success') );
