...
Dropzone.options.yourDropzoneElement = {
    ...
    init: function() {
      ...
      myDropzone.on("uploadprogress", function(file, progress, bytesSent) {
        ...
        var progressTextElement = file.previewElement.querySelector(".dz-progress-text");
