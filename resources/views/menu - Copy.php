...
?>
  ...
  <?php if (!Auth::user()) { ?>
  <li class="blink_me">
    <a href="<?php echo URL::to('login') ?>"  style="color: #D7BC04;list-style: none;font-weight: bold;font-size: 16px;">
      <?php echo __('Refer and Earn');?>
    </a>
  </li>
  <?php } elseif ( Auth::user()->subscribed($stripe_plan) ) { ?>
  <li class="blink_me">
    <a href="<?php echo URL::to('refferal') ?>" style="color: #D7BC04;list-style: none; font-family: Overlock Black;
                                                       font-weight: bold;
                                                       font-size: 16px;">
      <?php echo __('Refer and Earn');?>
    </a>
  ...
  <?php } else { ?>
  <li class="blink_me">
    <a href="<?php echo URL::to('refferal') ?>" style="color: #D7BC04;list-style: none;
                                                        font-weight: bold;
                                                        font-size: 16px;">
      <?php echo __('Refer and Earn');?>
    </a>
