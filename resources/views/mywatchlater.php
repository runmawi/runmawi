...
<div class="container movlistt" id="home-content">
    ...
    <div class="new-art">
        <h4 class="Continue Watching text-left padding-top-40">My Watchlater Rental Videos</h4>
	    <div class="border-line" style="margin-bottom:15px;margin-top:20px;"></div>
    </div>
    
    <div class="row nomargin">
        <?php if(count($ppvwatchlater) > 0) { 
...
<div class="container movlistt" id="home-content">
    ...
    <div class="new-art">
        <h4 class="Continue Watching text-left padding-top-40">My Watchlater  Videos</h4>
	    <div class="border-line" style="margin-bottom:15px;margin-top:20px;"></div>
    </div>
