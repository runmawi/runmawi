         ...
         <?php 
                ...
                <div class="item <?php if($key == 0){echo 'active';}?> header-image" >
                    <a href="<?=$bannerdetails->link;  ?>">
                        <img src="<?php echo URL::to('/').'/public/uploads/videocategory/'.$bannerdetails->slider;  ?>" alt="Home Slider">
                    </a>
                </div>
        <?php $i++; } ?>
    </div>
...
<div class="container page-height" >
    ...
    <div class="container">
        ...
        ?>
         <div class="row">
          <h4 class="Continue Watching text-left"><?php echo __($category->name);?></h4>
