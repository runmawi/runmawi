      ...
      <div class="iq-sidebar">
         <div class="iq-sidebar-logo d-flex justify-content-between">
            <a href="index.html" class="header-logo">
               <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/fl-logo.png';?>" class="img-fluid rounded-normal" alt="">
               ...
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-menu-bt d-flex align-items-center">
                     ...
                     <div class="iq-navbar-logo d-flex justify-content-between">
                        <a href="index.html" class="header-logo">
                           <img src="<?=URL::to('/'). '/assets/admin/dashassets/images/logo.png';?>" class="img-fluid rounded-normal" alt="">
                           <div class="logo-title">
                              <span class="text-primary text-uppercase">Flicknexs</span>
                           </div>
                        </a>
                     ...
                     <ul class="navbar-nav ml-auto navbar-list">
                                 ...
                                 <div class="iq-card-body p-0">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/01.jpg';?>" alt="">
                                          </div>
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/02.jpg';?>" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/03.jpg';?>" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                                    ...
                                    <a href="#" class="iq-sub-card" >
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/04.jpg';?>" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                             <img class="avatar-40 rounded" src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/05.jpg';?>" alt="">
                                          </div>
                                          <div class="media-body ml-3">
                        ...
                        <li class="line-height pt-3">
                           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                              <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/1.jpg';?>" class="img-fluid rounded-circle mr-3" alt="user"> 
                           </a>
                           ...
                           <div class="table-view">
                              <table class="data-tables table movie_table" style="width:100%">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>
                                          <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/01.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                       </td>
                                       <td>Anna Sthesia</td>
                                       <td>0123456789</td>
                                       ...
                                       <td>
                                          ...
                                          <tr>
                                             <td>
                                                <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/03.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                             </td>
                                             <td>Brock Lee</td>
                                             <td>2586253125</td>
                                             ...
                                             <td>
                                                ...
                                                <tr>
                                                   <td>
                                                      <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/05.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                                   </td>
                                                   <td>Nick Allen</td>
                                                   <td>6523456856</td>
                                                   ...
                                                   <td>
                                                      ...
                                                      <tr>
                                                         <td>
                                                            <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/08.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                                         </td>
                                                         <td>Lynn Guini</td>
                                                         <td>2563456589</td>
                                                         ...
                                                         <td>
                                                            ...
                                                            <tr>
                                                               <td>
                                                                  <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/06.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                                               </td>
                                                               <td>Eric Shun</td>
                                                               <td>5625456589</td>
                                                               ...
                                                               <td>
                                                                  ...
                                                                  <tr>
                                                                     <td>
                                                                        <img src="<?= URL::to('/'). '/assets/admin/dashassets/images/user/10.jpg';?>" class="img-fluid avatar-50" alt="author-profile">
                                                                     </td>
                                                                     <td>Marge Arita</td>
                                                                     <td>2563456589</td>
