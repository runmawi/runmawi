         ...
         <div class="modal-body">
             <?php if($watchlater_video->type == 'embed'): ?>
					...
					<?php  elseif($watchlater_video->type == 'file'): ?>
						<div id="video_container" class="fitvid">
						<video id="videojs-seek-buttons-player"  autoplay onplay="playstart()" onended="autoplay1()" class="video-js vjs-default-skin" controls preload="auto" poster="<?= URL::to('/public/') . '/uploads/images/' . $watchlater_video->image ?>"  data-setup='{ "playbackRates": [0.5, 1, 1.5, 2] }' width="100%" style="width:100%;" data-authenticated="<?= !Auth::guest() ?>">
         ...
         <section id="iq-suggestede" class="s-margin">
            <div class="container-fluid">
             ...
             <?php  if(isset($suggested_videos)) :
					...
					<?php  elseif($watchlater_video->type == 'file'): ?>
                                        <video controls=""  id="videojs-seek-buttons-player" class="playvid" name="media"><source src="<?= $watchlater_video->trailer; ?>" type="video/mp4"></video>
                                        <?php endif; ?>
                                    </div>
                                    <div class="modal-footer" align="center" >
                                        <button type="button"   class="close btn btn-primary" data-dismiss="modal" aria-hidden="true" 
