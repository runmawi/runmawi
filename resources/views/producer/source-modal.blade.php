            ...
            <div class="modal-content left">
                ...
                <p>
                    @foreach ($sources_data['video'] as $item)
                        <div class="collection">
                            <a href="{{ route('producer.stats',['video', $item->id]) }}"> {{ @$item->title }}  </a>
                            <br>
                        </div>
                    @endforeach
                </p>
                ...
                <p>
                    @foreach ($sources_data['series'] as $item)
                        <div class="collection">
                            <a href="{{ route('producer.stats',['series', $item->id]) }}"> {{ @$item->title }}  </a>
                            <br>
                        </div>
                    @endforeach
                </p>
                ...
                <p>
                    @foreach ($sources_data['livestream'] as $item)
                        <div class="collection">
                            <a href="{{ route('producer.stats',['live_stream', $item->id]) }}"> {{ @$item->title }}  </a>
                            <br>
                        </div>
                    @endforeach
                </p>
