                    ...
                    <tr>
                      ...
                      <td><?php echo $language->name;?></td>
                        <td class="text-center">
                            <div class="actions"><a href="{{ URL::to('admin/languages/edit/') }}/{{$language->id}}" class="btn btn-black edit">Edit</a> <a href="{{ URL::to('admin/languages/delete/') }}/{{$language->id}}" class="btn btn-white delete">Delete</a></div>
