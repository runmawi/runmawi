                      ...
                      <td><?php echo $language->name;?></td>
                        <td class="">
                            <div class=" align-items-center list-user-action"><a href="{{ URL::to('admin/languages/edit/') }}/{{$language->id}}" class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit"><i class="ri-pencil-line"></i></a> <a href="{{ URL::to('admin/languages/delete/') }}/{{$language->id}}" class="iq-bg-danger" data-toggle="tooltip" data-placement="top" title=""
