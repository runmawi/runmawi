...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            data-original-title="Edit" href="{{ URL::to('admin/channel/role/edit/') }}/{{$role->id}}" ><i class="ri-pencil-line"></i></a> 
        <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
            data-original-title="Delete" href="{{ URL::to('admin/channel/role/delete/') }}/{{$role->id}}" ><i
