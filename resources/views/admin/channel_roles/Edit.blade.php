...
<!-- This is where -->
	...
	<div class="clear"></div>
                    ...
                    <form method="POST" action="{{ URL::to('admin/channel/role/update') }}" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-12">
                    ...
                    @foreach($permission as $permissions)
                               ...
                               <div  class="col-md-4 d-flex align-items-center justify-content-between" style="width: 33%; float:left;">
                                        ...
                                        <div>  <label  style="color:#000000!important;">{{$permissions->name}}</label></div>
                                           <label class="switch">
                            <input class="form-check-input" type="checkbox" name="user_permission[]" value="{{$permissions->id}}" {{ (in_array($permissions->id, $channelspermission)) ? ' checked' : '' }}> 
