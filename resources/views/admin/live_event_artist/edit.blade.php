...
<div id="content-page" class="content-page">
     <div class=" d-flex">
        ...
        <a class="black" href="{{ URL::to('admin/livestream/create') }}">Add New Live Event Artist Videos</a>
    </div>
...
<!-- This is where -->
	...
	@if(!empty($video->id))
        <div class="d-flex justify-content-between">
            <div>
		<h4>Edit Live Event Artist</h4> </div>
            <div>
	...
	<div class="clear"></div>
		...
		<form method="POST" action="{{ route('live_event_update',$video->id) }}" accept-charset="UTF-8" file="1" enctype="multipart/form-data" style="padding: 15px;" id="liveEdit_video">
            ...
            @endif
                ...
                <div class="col-sm-6">
                    ...
                    <div class="mt-0">
                        <label class="switch">
                            <input name="tips" id="tips" class="tips" type="checkbox" @if(!empty($video->tips) && $video->tips == 1){{ 'checked="checked"' }}@elseif(!isset($video->active)){{ 'checked="checked"' }}@endif >
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="p1">Add a Donations of the Livestream below:</p>
                    <div class="panel-body">
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="mt-1">
                        <label class="switch">
                            <input name="chats" id="chats" class="chats" type="checkbox" @if(!empty($video->chats) && $video->chats == 1){{ 'checked="checked"' }}@elseif(!isset($video->active)){{ 'checked="checked"' }}@endif  >
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
...
$( document ).ready(function() {
		...
		if( Stream_error == 1){
			...
			if (result.value) {
				...
				@endphp
				location.href = "{{ route( 'live_event_edit' ,$video->id )  }}";
			}
			})
		}
	});
