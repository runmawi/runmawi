                                 ...
                                 <tr>
                                    ...
                                    <td colspan="2">
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          onclick="return confirm('Are You Approving Video ?')"  href="{{ route('CPP_Approval_live_event_artist',$video->id ) }}">  <i class="fa fa-check-circle" style="font-size:24px;color:blue"></i></span></a>
