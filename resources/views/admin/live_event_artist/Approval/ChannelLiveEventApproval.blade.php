         ...
         <div class="container-fluid p-0">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <a href="{{ route('approval_live_event_artist') }}"><button type="button" class="btn btn-default">CPP Uploaded Videos</button></a>
                     </div>
                     <div class="col-md-6">
                        <a href="{{ route('channelapproval_live_event_artist') }}"><button type="button" class="btn btn-default" >Channel Uploaded Videos</button></a>
                     </div>
                  </div>
               </div>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="2">
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          onclick="return confirm('Are You Approving Video ?')"  href="{{ route('Channel_Approval_live_event_artist',$video->id ) }}">  <i class="fa fa-check-circle" style="font-size:24px;color:blue"></i></span></a>
                                          <a class="iq-bg-success" 
                                              onclick="return confirm('Are You Rejecting Video ?')" href="{{ route('CPP_Reject_live_event_artist',$video->id ) }}"> <i class="fa fa-close" style="font-size:24px;color:white;background:red;border-radius:50%"></i></span></a>
                                       </div>
                                    </td>
                                 </tr>
                                 @endforeach
