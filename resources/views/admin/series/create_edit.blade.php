				...
				<div class="col-md-6">
					<div class="panel panel-primary mt-3" data-collapsed="0"> 
						...
						<div class="panel-body col-sm-8 p-0" style="display: block;"> 
							...
							@endif
							<input type="file" multiple="true" class="form-group image series_image" name="image" id="series_image" accept="image/png, image/webp, image/jpeg"/>
				...
				<div class="col-md-6">
					<div class="panel panel-primary mt-3" data-collapsed="0"> <div class="panel-heading"> 
						...
						<div class="panel-body col-sm-8 p-0" style="display: block;"> 
							...
							@endif
							<input type="file" multiple="true" class="form-group" name="player_image" id="series_player_image" accept="image/png, image/webp, image/jpeg"/>
