            ...
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <a href="{{ URL::to('/admin/assign_Series/channel_partner') }}"><button type="button" class="btn btn-default" >Move Series Channel </button></a>
                     </div>
                  </div>
               </div>
                        <h4>Channel Uploaded Series</h4>
                     ...
                     <form action="{{ URL::to('/admin/MoveSeries/channel-partner') }}"  method= "post">
