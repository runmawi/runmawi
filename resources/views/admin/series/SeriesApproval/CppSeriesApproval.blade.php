                                 ...
                                 <tr>
                                    ...
                                    <td colspan="2">
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          onclick="return confirm('Do you want to approve this Live Stream ?')"  href="{{ URL::to('admin/CPPSeriesApproval') . '/' . $video->id }}">  <i class="fa fa-check-circle" style="font-size:24px;color:green;"></i></a>
                                          <a class="iq-bg-success" 
                                              onclick="return confirm('Do you want to reject this Live Stream  ?')" href="{{ URL::to('admin/CPPSeriesReject') . '/' . $video->id }}"> <i class="fa fa-close" style="font-size:20px;color:white;background:red;border-radius:50%;"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 @endforeach
