                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <div class="iq-card-header-toolbar d-flex align-items-baseline">
                                <div class="form-group mr-2"> <a href="{{ route('email_settings') }}"
                                        class="btn btn-primary"> Email Setting </a> </div>
                            </div>
                        </div>
                            ...
                            <div class="table-view">
                                <table id="template"
                                    ...
                                    @forelse ($email_logs as $key => $email_logs_details)
                                        @php
                                            $name = App\User::where('id', $email_logs_details->user_id)
                                                ->pluck('username')
                                                ->first();
                                        @endphp
                                        ...
                                        <tbody>
                                            ...
                                            <td> {{ $email_logs_details->user_id ? $email_logs_details->user_id : '-' }}
                                            </td>
                                            <td> {{ $email_logs_details->created_at ? $email_logs_details->created_at : '-' }}
                                            </td>
                                        </tbody>
                                    @empty
                                    @endforelse
