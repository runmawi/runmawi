					 ...
					 <table class="table plan_table iq-card text-center">
						...
						<tbody>
							...
							<tr>
                               ...
                               <td class="list-user-action"><a href="{{ URL::to('/') }}/admin/subscription-plans/edit/{{ $plan[0]->id }}" class="iq-bg-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"></a>
							    <a  onclick="return confirm('Are you sure?')" href="{{ URL::to('/')}}/admin/subscription-plans/delete/{{ $plan[0]->id }}" class="iq-bg-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"></a></td>
                           </tr>
