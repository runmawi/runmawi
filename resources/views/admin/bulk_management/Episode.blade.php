...
<div class="table-view">
    <table class="table text-center  table-striped table-bordered table series_table iq-card " style="width:100%">
        <thead>
            <tr class="r1">
            <th>Episode ID</th>
            <th>Title</th>
                ...
                <div class="media align-items-center">
                    <div class="iq-movie">
                        <a href="javascript:void(0);"><img
                            src="{{ URL::to('/') . '/public/uploads/images/' . $Episode->image }}"
