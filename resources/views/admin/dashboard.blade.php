  ...
  <!--[hook_admin_dashboard_widgets_start]-->
      ...
      <div class="col-sm-4 col-xs-6">
				<div class="tile-stats tile-red">
					...
					<div class="num" data-start="0" data-end="{{ $total_subscription }}" data-postfix="" data-duration="1500" data-delay="0">0</div>
			...
			<div class="col-sm-4 col-xs-6">
				<div class="tile-stats tile-green">
					...
					<div class="num" data-start="0" data-end="{{ $total_recent_subscription }}" data-postfix="" data-duration="1500" data-delay="600">0</div>
...
<!--
			<div class="col-sm-3 col-xs-6">
				<div class="tile-stats tile-blue">
					...
					<div class="num" data-start="0" data-end=" {{ $total_ppvvideos }}" data-postfix="" data-duration="1500" data-delay="1800">0</div>
					<h3>PPV videos</h3>
					<p>Total PPV videos on your site.</p>
				</div>
			</div>
-->
            <!-- column -->
  ...
  <!--[hook_admin_dashboard_widgets_start]-->		
    ...
    <div id="google_analytics_login_container">
      <div id="google_analytics_login">
        <img src="{{ URL::to('/') }}/assets/admin/admin/images/admin-bg.jpg" />
    ...
    <script src="{{ URL::to('/') }}/assets/admin/js/ganalytics/Chart.min.js"></script>
    <script src="{{ URL::to('/') }}/assets/admin/js/ganalytics/moment.min.js"></script>
    <script src="{{ URL::to('/') }}/assets/admin/js/ganalytics/active-users.js"></script>
    <script src="{{ URL::to('/') }}/assets/admin/js/ganalytics/view-selector2.js"></script>
