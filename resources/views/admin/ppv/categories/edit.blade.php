...
<div class="modal-body">
	<form id="update-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/ppv/categories/update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                        ...
                        <img src="{{ URL::to('/') . '/public/uploads/ppvcategory/' . $categories[0]->image }}" class="movie-img" width="200"/>
                        @endif
