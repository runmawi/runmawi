...
<div id="content-page" class="content-page">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="new-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/document/genre/store') }}" method="post" enctype="multipart/form-data">
										...
										<div class="form-group ">
											<label>Active :</label>
											<input type="radio" checked id="active"  id="active" name="active" value="1">Yes
											<input type="radio" id="active" name="active" value="0">No
										</div>
									...
									<tr id="{{ $category->id }}">
										...
										<td>
											...
											<a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
																	data-original-title="Edit" href="{{ URL::to('admin/document/genre/edit/') }}/{{$category->id}}" ><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"></a> 
												<a class="iq-bg-danger" data-toggle="tooltip" data-placement="top" title=""
													onclick="return confirm('Are you sure?')"  data-original-title="Delete" href="{{ URL::to('admin/document/genre/delete/') }}/{{$category->id}}" ><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"></a></div>
										</td>
									</tr>
								@endforeach
							</table>
	...
	<script>
		...
		$.ajax({
					type: "POST", 
					dataType: "json", 
					url: "{{ url('admin/document/genre/active') }}",
						data: {
							_token  : "{{csrf_token()}}" ,
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
        ...
        <script type="text/javascript">
			...
			function updateOrder(data) {
				...
				$.ajax({
					url:'<?= URL::to('admin/document/genre/order');?>',
					type:'post',
