...
<div id="content-page" class="content-page">
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-12">
				<h3><i class="entypo-archive"></i> Live Stream Categories</h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-black"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
		</div>
	</div>
            ...
            <table class="table table-bordered">
                <tr class="table-header">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions"><a href="{{ URL::to('admin/livestream/categories/edit/') }}/{{$category->id}}" class="btn btn-black edit">Edit</a> <a href="{{ URL::to('admin/livestream/categories/delete/') }}/{{$category->id}}" class="btn btn-white delete">Delete</a></div>
