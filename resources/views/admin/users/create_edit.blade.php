...
@stop
 ...
 <div className="iq-card">
            <form method="POST" action="" id="update_profile_form" accept-charset="UTF-8" file="1" enctype="multipart/form-data" >
         <div class="row">
             <div class="col-md-6 mt-2">
			<div id="user-badge">
			 ...
			 <div class="panel-options"> <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a> </div></div> 
				<div class="panel-body" > 
                    ...
                    <label class="mb-1"> Username</label>
					<input type="text" class="form-control mb-3" name="username" id="username" value="" />
				</div>
			</div>
                 </div>
                 <div class="panel panel-primary mt-2" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" > 
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
					       <input type="text" class="form-control mb-3" name="mobile" id="mobile" value="" />
                    </div></div>
				</div>
			</div>
             </div>
			...
			<div class="panel panel-primary mt-2" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" > 
					...
					<label class="mb-1">User Email Address</label>
					<input type="text" class="form-control mb-3" name="email" id="email" value="" />
				</div>
			</div>
             </div>
             </div>
...
<div class="mt-3"></div>
 ...
 <div class="mt-2 p-2"  >
			<input class="btn btn-primary" type="hidden" name="_token" value="" />
