                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            ...
                            <input type="date" id="start_time" name="start_time"
                                style="background: rgba(250, 250, 250, 1);border-color: transparent;">
                        </div>
                        ...
                        <table class="table text-center" id="player_table" style="width:100%">
                            <thead>
                                <tr class="r1">
                                    ...
                                    <th>Amount</th>
                                    <th>Expired date</th>
                                    <th>Unseen expiry date</th>
                                    <th>Purchased Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    @foreach ($Livestream_purchase as $key => $Livestream_purchases)
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $Livestream_purchases->username ?? null }}</td>
                    ...
                    success: function(value) {
                        ...
                        function drawChart() {
                            ...
                            var chart = new google.visualization.LineChart(document
                                .getElementById('google-line-chart'));
                            chart.draw(data, {
                                // width: 400,
                                // height: 240
                            });
