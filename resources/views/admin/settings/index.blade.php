                ...
                <div class="row" id="wrapper">
                    ...
                    <div class="col-sm-4" id="sidebar-wrapper">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a class="list-group-item list-group-item-action list-group-item-light p-3" id="subscription_setting" href="#!">Coupon Settings</a>
                                ...
                                <div class="panel panel-primary mt-3" data-collapsed="0">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group color-picker align-items-center justify-content-between" style="width: ;">
                            ...
                            <div lass="container-fluid row mt-3 " id="email" class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="panel panel-primary" data-collapsed="0">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <p class="p1">Google Analytics API Integration (This will integrate with your dashboard analytics)</p>
                                            </div>
                                            <div class="panel-options">
                                                <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                                            </div>
                                    ...
                                    <div class="panel panel-primary" data-collapsed="0">
                                        ...
                                        <div class="panel-body" style="display: block;">
                                            <div class="form-group add-profile-pic">
                                                ...
                                                <textarea id="summary-ckeditor" name="signature" class="form-control" placeholder="Email signature" value="@if(!empty($settings->signature)){{ $settings->signature }}@endif">
<?php echo $settings->signature; ?>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <form method="POST" action="{{ URL::to('admin/settings/script_settings') }}" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
                                <div class="col-md-6">
                                    ...
                                    <textarea rows="5" class="form-control" name="header_script" id="summaryheader" placeholder="Header Script"></textarea>
                                </div>
                                <h5>Footer Script CDN:</h5>
                                <textarea rows="5" class="form-control" name="footer_script" id="summaryfooter" placeholder="Footer Script"></textarea>
                            ...
                            <form method="POST" action="{{ URL::to('admin/app_settings/update') }}" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <div class="panel panel-primary" data-collapsed="0">
                                            <div class="panel-heading">
                                                <div class="panel-title"><label>Android URL</label></div>
                                                <div class="panel-options">
                                                    <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-primary" data-collapsed="0">
                                            <div class="panel-heading">
                                                <div class="panel-title"><label>IOS URL</label></div>
                                                <div class="panel-options">
                                                    <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
                                                </div>
                                            </div>
