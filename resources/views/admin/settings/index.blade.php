                        ...
                        <div class="panel panel-primary p-0" data-collapsed="0"> <div class="panel-heading"> 
                            ...
                            <table class="table" id="dynamicTable">  
                                ...
                                @forelse($rtmp_url as $key => $url)
                                    <tr>  
                                        <td class="col-md-4" ><input type="text" name="rtmp_url[0][url]" placeholder="rtmp://75.119.145.126:1935/show/" class="form-control rtmp_urls" value="{{ $url->rtmp_url }}" readonly/></td>  
                                        <td class="col-md-5" ><input type="text" name="hls_url[0][hls_url]" placeholder="http://75.119.145.126:9090/hls/streamkey/index.m3u8" class="form-control rtmp_urls" value="{{ $url->hls_url }}" readonly/></td>  
                                        <td class="col-md-4">
                                ...
                                @empty
                                    <tr>  
                                        <td ><input type="text" name="rtmp_url[0][url]" placeholder=" rtmp://75.119.145.126:1935/show" class="form-control" /></td>  
                                        <td ><input type="text" name="hls_url[0][hls_url]" placeholder="http://75.119.145.126:9090/hls/streamkey/index.m3u8" class="form-control" /></td>  
...
// Append 
       ...
       $(".add").click(function(){
           ++i;
           $("#dynamicTable").append('<tr><td class="col-md-4"><input type="text" name="rtmp_url['+i+'][url]" placeholder="rtmp://123.456.789.123/hls/"  class="form-control" /></td> <td class="col-md-5"> <input type="text" name="hls_url['+i+'][hls_url]" placeholder="http://75.119.145.126:9090/hls/streamkey/index.m3u8"  class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
       });
