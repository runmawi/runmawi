...
<!--				<input type="text" class="form-control" name="login_content" id="login_content" placeholder="Login Content" value="@if(!empty($settings->login_content)){{ $settings->login_content }}@endif" />-->
