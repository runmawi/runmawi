                ...
                <div class="panel-body"> 
                        ...
                        <!-- <div class="row"> -->
                           ...
                           <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group color-picker d-flex align-items-center justify-content-between" style="width: ;">
                                <div><label class="mt-1"> @if (@$order_settings_list[11]->header_name) {{ @$order_settings_list[11]->header_name }} @else {{ ""  }} @endif </label></div>
                               
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                         <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input  type="checkbox"  name="videoCategories"   @if ($settings->videoCategories == 1) {{ "checked='checked'" }} @else {{ "" }} @endif>
                                        <span class="slider round"></span>
                                        </label>
                                           <div class="ml-2">ON</div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="input-group color-picker d-flex align-items-center justify-content-between" style="width: ;">
                                <div><label class="mt-1"> @if (@$order_settings_list[12]->header_name) {{ @$order_settings_list[12]->header_name }} @else {{ ""  }} @endif </label></div>
                               
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                         <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input  type="checkbox"  name="liveCategories"   @if ($settings->liveCategories == 1) {{ "checked='checked'" }} @else {{ "" }} @endif>
                                        <span class="slider round"></span>
                                        </label>
                                           <div class="ml-2">ON</div>
                                    </div>
                        ...
                        <!-- </div> -->
                            ...
                            <div class="col-sm-4">
                                <div class="input-group color-picker d-flex align-items-center justify-content-between" style="width: ;">
                                <div><label class="mt-1">  @if (@$order_settings_list[10]->header_name) {{ @$order_settings_list[10]->header_name }} @else {{ ""  }} @endif  </label></div>
                               
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                           <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input type="checkbox"  @if ($settings->video_schedule  == 1) {{ "checked='checked'" }} @else {{ "" }} @endif name="video_schedule" id="video_schedule">
                                        <span class="slider round"></span>
                                        </label>
                                        <div class="ml-2">ON</div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="input-group color-picker d-flex align-items-center justify-content-between" style="width: ;">
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                        <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                            <input type="checkbox"  @if ($settings->continue_watching  == 1) {{ "checked='checked'" }} @else {{ "" }} @endif name="continue_watching" id="continue_watching">
                                            <span class="slider round"></span>
                                        </label>
                                        <div class="ml-2">ON</div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div><label class="mt-1"> @if (@$order_settings_list[11]->header_name) {{ @$order_settings_list[11]->header_name }} @else {{ ""  }} @endif </label></div>
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                         <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input  type="checkbox"  name="videoCategories"   @if ($mobilesettings->videoCategories == 1) {{ "checked='checked'" }} @else {{ "" }} @endif>
                                        <span class="slider round"></span>
                                        </label>
                                           <div class="ml-2">ON</div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div><label class="mt-1"> @if (@$order_settings_list[12]->header_name) {{ @$order_settings_list[12]->header_name }} @else {{ ""  }} @endif </label></div>
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                         <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input  type="checkbox"  name="liveCategories"   @if ($mobilesettings->liveCategories == 1) {{ "checked='checked'" }} @else {{ "" }} @endif>
                                        <span class="slider round"></span>
                                        </label>
                                           <div class="ml-2">ON</div>
                                    </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div><label class="mt-1"> @if (@$order_settings_list[19]->header_name) {{ @$order_settings_list[19]->header_name }} @else {{ ""  }} @endif </label></div>
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-around">
                                         <div class="mr-2">OFF</div>
                                        <label class="switch mt-2">
                                        <input  type="checkbox"  name="SeriesGenre"   @if ($mobilesettings->SeriesGenre == 1) {{ "checked='checked'" }} @else {{ "" }} @endif>
                                        <span class="slider round"></span>
                                        </label>
                                           <div class="ml-2">ON</div>
                                    </div>
