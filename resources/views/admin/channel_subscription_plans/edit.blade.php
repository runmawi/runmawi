...
<!--<div class="modal-header">
    ...
    <div class="modal-body">
    	<form  accept-charset="UTF-8" action="{{ URL::to('admin/channel-subscription-plans/update') }}" method="post" id="subscription_edit">
            ...
            <div class="row d-flex col-md-12">
              ...
              <div class="mt-3 ml-3">
                <a type="button" class="btn btn-primary" data-dismiss="modal" href="{{ URL::to('admin/channel-subscription-plans') }}">Close</a>
