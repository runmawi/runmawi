                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="new-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/channel-subscription-plans/store') }}" method="post">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($plans as $k => $plan)
                                        <tr>
                                            ...
                                            <td class="">
												<a href="{{ URL::to('/') }}/admin/channel-subscription-plans/edit/{{ $plan[0]->id }}"
												...
												<a onclick="return confirm('Are you sure?')"
                                                    href="{{ URL::to('/') }}/admin/channel-subscription-plans/delete/{{ $plan[0]->id }}"
                    ...
                    success: function (data) {
                        if (data.message == 'false') {
                            swal.fire({
                                ...
                                location.href = '{{ URL::to('admin/channel-subscription-plans') }}';
                            });
                        }
                    },
                });
