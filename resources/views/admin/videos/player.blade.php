...
<video id="video" src="https://cph-p2p-msl.akamaized.net/hls/live/2000341/test/master.m3u8" controls width="200px" height="200px"></video>
<script>
if(Hls.isSupported())
{
...
{
    video.src = 'https://cph-p2p-msl.akamaized.net/hls/live/2000341/test/master.m3u8';
...
<?php  } elseif($video->access == 'subscriber' && Auth::user()->role == 'registered' || $video->access == 'ppv' && Auth::user()->role == 'registered'){  ?>
<div id="subscribers_only"style="background: url(<?=URL::to('/') . '/public/uploads/images/' . $video->image ?>);background-position:center; background-repeat: no-repeat; background-size: cover; height: 400px; margin-top: 20px;">
