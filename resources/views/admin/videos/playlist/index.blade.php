...
<div id="content-page" class="content-page">
    <div class="mt-5 d-flex">
                       ...
                       <a class="black" style="background:#fafafa!important;color: #006AFF!important;" href="{{ URL::to('admin/videos/playlist') }}">Manage Video PlayList</a>
    ...
    <div class="container-fluid p-0">
	   <div class="admin-section-title">
            <div class="iq-card">
                <div class="row">
                    <div class="col-md-6">
                        <h4><i class="entypo-archive"></i> Video PlayList</h4>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">New Video PlayList</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>

                            </div>

                            <div class="modal-body">
                                <form id="new-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/videos/playlist/store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="text" id="title" name="title" value="" class="form-control" placeholder="Enter Name">
                                    @if ($errors->has('name'))
		...
		<div class="panel panel-primary category-panel" data-collapsed="0">
			...
			<div class="panel-heading">
				<div class="panel-title">
					<p>Organize the playlist below: </p>
				</div>
				...
				<div id="nestable" class="nested-list dd with-margins">
                            ...
                            <table class="table table-bordered iq-card text-center" id="categorytbl">
                                <tr class="table-header r1">
                                    <th><label>PlayList Image</label></th>
                                    <th><label>Video PlayList Name</label></th>
                                    <th><label>Operation</label></th>
                                </tr>
                                    @foreach($AdminVideoPlaylist as $PlayList)
                                    <tr id="{{ $PlayList->id }}">
                                    	<td valign="bottom" class=""><img src="{{ URL::to('/') . '/public/uploads/images/' . $PlayList->image }}" width="50" height="50"></td>
                                        <td valign="bottom"><p>{{ $PlayList->title }}</p></td>
                                        <td>
                                            <div class=" align-items-center list-user-action">
                                                <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                                             data-original-title="Edit" href="{{ URL::to('admin/videos/playlist/edit/') }}/{{$PlayList->id}}" ><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"></a> 
                                            <a class="iq-bg-danger" data-toggle="tooltip" data-placement="top" title=""
											onclick="return confirm('Are you sure?')"  data-original-title="Delete" href="{{ URL::to('admin/videos/playlist/delete/') }}/{{$PlayList->id}}" ><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"></a></div>
