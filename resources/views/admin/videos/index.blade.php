...
@section('content')
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-8">
				<h3><i class="entypo-video"></i> Videos</h3><a href="{{ URL::to('admin/videos/create') }}" class="btn btn-black"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
			<div class="col-md-4">	
			...
			<div class="col-sm-6 col-md-4">
				...
				<article class="album">
					...
					<header>
						...
						<a href="{{ URL::to('category/videos/') . '/' . $video->slug }}" target="_blank">
