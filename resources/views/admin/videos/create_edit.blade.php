...
@endif    
	...
	@if(!empty($video->id))
		<h3>{{ $video->title }}</h3> 
		<a href="{{ URL::to('/') . '/channelVideos/play_videos/' . $video->id }}" target="_blank" class="btn btn-black">
		...
		@endif
			...
			<div class="panel panel-primary" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" style="display: block;"> 
					...
					<div class="new-video-file" @if(!empty($video->type) && $video->type == 'file'){{ 'style="display:block"' }}@else style = "display:none" @endif>
						...
						<input type="text" class="form-control" name="video" id="video" value="@if(!empty($video->mp4_url)){{ $video->mp4_url }}@endif" />
						<hr />
			...
			<div class="panel panel-primary" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" style="display: block; padding:0px;">
					<textarea class="form-control" name="details" >@if(!empty($video->details)){{ htmlspecialchars($video->details) }}@endif</textarea>
				</div> 
			</div>
			...
			<div class="panel panel-primary" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" style="display: block;"> 
					...
					<textarea class="form-control" name="description" id="summary-ckeditor">@if(!empty($video->description)){{ strip_tags($video->description) }}@endif</textarea>
				</div> 
			</div>
			<div class="row"> 
			<div class="col-sm-6">
			...
			<div class="panel panel-primary" data-collapsed="0"> <div class="panel-heading"> 
				...
				<div class="panel-body" style="display: block;color:black;"> 
