        ...
        <div class="container-fluid">
            <div class="iq-card">
                ...
                <div id="admin-container">
                    ...
                    <!-- <ol class="breadcrumb"> <li> <a href="{{ URL::to('/admin/pages') }} "><i class="fa fa-newspaper-o"></i>All Pages</a> </li> <li class="active">
    @if (!empty($page->id))
...
@else
    ...
    @endif
                    ...
                    <div class="admin-section-title">
                        @if (!empty($page->id))
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ URL::to('page') . '/' . $page->slug }}" target="_blank"
                                        class="btn btn-info">
                                        <i class="fa fa-eye"></i> Preview <i class="fa fa-external-link"></i></a>
                                </div>
                            </div>
                        @else
                    ...
                    <form method="POST" id="page_form" action="{{ $post_route }}" accept-charset="UTF-8" file="1"
                        ...
                        <div class="row mt-4">
                                ...
                                <div class="panel panel-primary" data-collapsed="0">
                                    ...
                                    <div class="panel-body" style="display: block;">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            ...
                                            value="@if (!empty($page->title)) {{ $page->title }} @endif" />
                                    </div>
                                </div>
                            ...
                            <div class="@if (!empty($page->created_at)) col-sm-3 @else col-sm-4 @endif">
                                <div class="panel panel-primary" data-collapsed="0">
                                    <div class="panel-heading">
                                        <div class="panel-title"><label>SEO URL Slug</label></div>
                                        <div class="panel-options"> <a href="#" data-rel="collapse"><i
                                                    class="entypo-down-open"></i></a> </div>
                                    </div>
                                    <div class="panel-body" style="display: block;">
                                        <p class="p1">(Example: slug-name)</p>
                                        <input type="text" class="form-control" name="slug" id="slug"
                                            placeholder="slug-name"
                                            value="@if (!empty($page->slug)) {{ $page->slug }} @endif" />
                                    </div>
                                </div>
                            </div>
                            ...
                            @if (!empty($page->created_at))
                                <div class="col-sm-3">
                                    <div class="panel panel-primary" data-collapsed="0">
                                        <div class="panel-heading">
                                            <div class="panel-title"><label>Created Date</label></div>
                                            <div class="panel-options"> <a href="#" data-rel="collapse"><i
                                                        class="entypo-down-open"></i></a> </div>
                                        </div>
                                        <div class="panel-body" style="display: block;">
                                            ...
                                            <input type="text" class="form-control" name="created_at" id="created_at"
                                                placeholder=""
                                                value="@if (!empty($page->created_at)) {{ $page->created_at }} @endif" />
                                        </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title"><label>Page Content</label></div>
                                <div class="panel-options"> <a href="#" data-rel="collapse"><i
                                            class="entypo-down-open"></i></a> </div>
                            </div>
                            <div class="panel-body mt-3" style="display: block; padding:0px;">
                                <textarea class="form-control" name="body" id="summary-ckeditor">
@if (!empty($page->body))
{{ $page->body }}
@endif
</textarea>
