...
@section('content')
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-12">
				<h3><i class="entypo-archive"></i> PPV Categories</h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-black"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">New PPV Category</h4>
				</div>
				
				<div class="modal-body">
					<form id="new-cat-form" accept-charset="UTF-8" action="{{ URL::to('admin/ppv/categories/store') }}" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-bordered">
                <tr class="table-header">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions"><a href="{{ URL::to('admin/ppv/categories/edit/') }}/{{$category->id}}" class="btn btn-black edit">Edit</a> <a href="{{ URL::to('admin/ppv/categories/delete/') }}/{{$category->id}}" class="btn btn-white delete">Delete</a></div>
                            @if(count($category->childs))

                                @include('admin.videos.categories.manageChild',['childs' => $category->childs])
