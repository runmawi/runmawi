...
-->
				<td>
					<a href="{{ URL::to('admin/user/edit') . '/' . $user->id }}" class="btn btn-xs btn-black"><span class="fa fa-edit"></span> Edit</a>
					<a href="{{ URL::to('admin/user/delete') . '/' . $user->id }}" class="btn btn-xs btn-white delete"><span class="fa fa-trash"></span> Delete</a>
				</td>
			</tr>
			@endforeach
	</table>
