                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">PayPerView Payment</h4>
                            </div>
                            ...
                            <div class="table-view">
                                <table id="ppv_payment_view_table" class="table table-striped table-bordered table movie_table " style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($payperView as $key => $payment)
                                            <tr>
                                                ...
                                                <td> <p class="mb-0">{{ $payment->status }}</p></td>

                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <a class="iq-bg-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"
                                                            href="{{ URL::to('admin/ppvpayment/view') . '/' . $payment->video_id }}">
