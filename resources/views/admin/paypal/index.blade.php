...
<div class="admin-section-title">
		<div class="row">
			<div class="col-md-12">
				<h3><i class="entypo-archive"></i> Paypal Plans </h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-black"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
		</div>
	</div>
					 ...
					 <ol id="tree1" class="dd-list">
                        ...
                        @foreach($plans as $plan )
                            ...
                            <li class="dd-item">
                               ...
                               <div class="actions"><a href="{{ URL::to('/') }}/admin/paypalplans/edit/{{ $plan->id }}" class="btn btn-black edit">Edit</a> <a href="{{ URL::to('/')}}/admin/paypalplans/delete/{{ $plan->id }}" class="btn btn-white delete">Delete</a></div>
                            </li>
