			...
			<div class="login-block">
                ...
                <div class="panel-heading"><h1>Choose You Plan</h1></div>
                     <div class="panel-body">
                       ...
                       <div class="tab">
                          <button class="tablinks active" onclick="openCity(event, 'stripe_pg') " id="defaultOpen"> Stripe Payment</button>
                          <button class="tablinks" onclick="openCity(event, 'paypal_pg')"> Paypal Payment</button>
                        </div>
