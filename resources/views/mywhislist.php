...
<div class="container movlistt page-height" id="home-content">
    
    <div class="new-art">
        <h4 class="Continue Watching text-left padding-top-40">My Wishlist PPV Videos</h4>
	    <div class="border-line" style="margin-bottom:15px;margin-top:20px;"></div>
    </div>
    
    <div class="row nomargin">
        <?php if(isset($ppvwatchlater) && !empty($ppvwatchlater)) { 
            foreach($ppvwatchlater as $video): ?>
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 new-art">
                <article class="block expand">
                    <a class="block-thumbnail" href="<?= URL::to('/') ?><?= '/category/videos/' . $video->slug ?>">
    ...
    <div class="new-art">
        <h4 class="Continue Watching text-left padding-top-40">My Wishlist Channels Videos</h4>
	    <div class="border-line" style="margin-bottom:15px;margin-top:20px;"></div>
    </div>
    
    <div class="row nomargin">
        <?php if(isset($channelwatchlater) && !empty($channelwatchlater)) { 
