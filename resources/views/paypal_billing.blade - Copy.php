    ...
    <div class="row justify-content-center">	
            ...
            <h1 class="my_profile">
                ...
                $sub_id = Auth::user()->paypal_id;
                    $ch = curl_init();
                    curl_setopt($ch, CURLOPT_URL, 'https://api.paypal.com/v1/billing/subscriptions/'.$sub_id.'/transactions?start_time=2018-01-21T07:50:20.940Z&end_time=2020-12-21T07:50:20.940Z');
