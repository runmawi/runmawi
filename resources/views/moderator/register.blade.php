                  ...
                  <div class="sign-in-from w-100 m-auto">
                      ...
                      <form action="{{ URL::to('cpp/moderatoruser/store') }}" method="POST" id="stripe_plan" class="stripe_plan" name="member_signup" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-8">
                                <input id="mobile" type="text" maxlength="10" minlength="8" class="form-control @error('email') is-invalid @enderror" name="mobile_number" placeholder="{{ __('Enter Mobile Number') }}" value="{{ old('mobile_number') }}" required autocomplete="off" autofocus> 
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <input type="file" accept="video/mp4,video/x-m4v,video/*" name="intro_video" id="intro_video">
                                </div>
