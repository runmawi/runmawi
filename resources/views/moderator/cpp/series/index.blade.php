...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex">
        <a class="black" style="background:#fafafa!important;color: #006AFF!important;" href="{{ URL::to('cpp/series-list') }}"> Series List</a>
        <a class="black" href="{{ URL::to('cpp/series/create') }}"> Add New Series</a></div>
         <div class="iq-card">
		<div class="row align-items-center p-2">
            ...
            <div class="col-md-2 mb-2">
                <a href="{{ URL::to('cpp/series/create') }}" class="btn btn-primary mt-2"><i class="fa fa-plus-circle"></i> Add New</a>
            </div>
		</div>
			...
			<tr>
				...
				<td>
					<div class=" align-items-center list-user-action">
						...
						<a href="{{ URL::to('cpp/series/edit') . '/' . $series_value->id }}" class="iq-bg-success ml-2"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"> <!--Edit--></a>
						<a href="{{ URL::to('cpp/series/delete') . '/' . $series_value->id }}" class="iq-bg-danger ml-2"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"><i
