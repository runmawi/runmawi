...
<div id="content-page" class="content-page">
     <div class=" d-flex">
        <a class="black" href="{{ URL::to('cpp/live-event-artist') }}">All Live Event Artist Videos</a>
        <a class="black" href="{{ URL::to('cpp/livestream/create') }}">Add New Live Event Artist Videos</a>
    </div>
