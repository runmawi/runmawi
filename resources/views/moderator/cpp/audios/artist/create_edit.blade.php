...
<div id="content-page" class="content-page">
    <div class="d-flex">
        ...
        <a class="black" href="{{ URL::to('cpp/artists') }}"> All Artists </a>
        <a class="black" style="background:#fafafa!important;color: #006AFF!important;" href="{{ URL::to('cpp/artists/create') }}">Add New Artist</a></div>
                
        <div class="iq-card">

        <!--<ol class="breadcrumb"> <li> <a href="{{ Url::to('/cpp/artist_list') }}"><i class="fa fa-newspaper-o"></i>Manage Artist</a> </li> <li class="active">@if(!empty($artist->id)) <strong>{{ $artist->name }}</strong> @else <strong>Create Artist</strong> @endif</li> </ol>-->
                    ...
                    <div class="col-sm-6 mt-3" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <select class="form-control" name="artist_type" id="artist_type" >
                                ...
                                <option value="Publisher" @if (!empty($artist->artist_type) && $artist->artist_type == 'Publisher'){{ 'selected' }} @endif > {{ 'Music Publisher' }} </option>
                                <option value="Writer" @if (!empty($artist->artist_type) && $artist->artist_type == 'Writer'){{ 'selected' }} @endif > {{ 'Music Writer' }} </option>
                                <option value="Co-Writer" @if (!empty($artist->artist_type) && $artist->artist_type == 'Co-Writer'){{ 'selected' }} @endif > {{ 'Co-Writer' }} </option>
...
<script>
    $('form[id="artist_form"]').validate({
        rules: {
            ...
            artist_slug: {
                    remote: {
                        url:"{{ URL::to('cpp/artist_slug_validation') }}",
                        type: "get",
                        data: {
                            _token: "{{csrf_token()}}" ,
        ...
        messages: {
            ...
            artist_email: "This field is required",
            parent_id: {
