        ...
        <div class="col-md-12">
            <div class="iq-card-header  justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Content Partners Payouts Analytics :</h4>
                </div>
            </div>
...
<script>
    ...
    $.ajaxSetup({
     ...
     $(document).ready(function(){
        ...
        $('#start_time').change(function(){
            ...
            var url = "{{ URL::to('cpp/payouts_startdate_analytics/')  }}";
       ...
       if(start_time != "" && end_time == ""){
        ...
        var start_time =  $('#start_time').val();
        var end_time =  $('#end_time').val();
        var url = "{{ URL::to('cpp/payouts_enddate_analytics/')  }}";
    ...
    $(document).ready(function(){
        ...
        var url = "{{ URL::to('cpp/payouts_exportCsv/')  }}";
