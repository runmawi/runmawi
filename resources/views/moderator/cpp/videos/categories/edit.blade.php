...
<div class="modal-body">
	<form id="update-cat-form" accept-charset="UTF-8" action="{{ URL::to('/cpp/videos/categories/update') }}" method="post" enctype="multipart/form-data">
...
<div class="modal-footer">
	<a type="button" class="btn btn-danger" data-dismiss="modal" href="{{ URL::to('cpp/videos/categories') }}">Close</a>
