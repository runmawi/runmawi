...
<!-- This is where -->
 ...
 -->
                        ...
                        <div class="form-group row">
                            ...
                            <img class="w-50" src="<?php if($moderators->picture == "Default.png") { echo  URL::to('/public/uploads/avatars/profile.png') ; }else { echo  URL::to('/public/uploads/picture').'/'.$moderators->picture; }?>"  />
                            @endif
                        </div>
