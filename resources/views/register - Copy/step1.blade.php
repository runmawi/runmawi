...
<!--
                <form action="<php echo URL::to('/').'/register8';  ?>" method="POST">
                      @csrf
                ...
                <div class="panel-body">
                    <form action="<?php if (isset($ref) ) { echo URL::to('/').'/register1?ref='.$ref.'&coupon='.$coupon; } else { echo URL::to('/').'/register1'; } ?>" method="POST" id="payment-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-sm-offset-1 col-form-label text-md-right">{{ __('Username') }} <span style="color:#bca504">*</span></label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-sm-offset-1 col-form-label text-md-right">{{ __('E-Mail Address') }} <span style="color:#bca504">*</span></label>
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-4 col-sm-offset-1 col-form-label text-md-right">{{ __('Phone Number') }} <span style="color:#bca504">*</span></label>
                            
                            <div class="form-group">
                            <div class="col-sm-2">
                              <select name="ccode" >
                                @foreach($jsondata as $code)
                                <option value="{{ $code['dial_code'] }}" <?php if($code['dial_code']) { echo "selected='seletected'"; } ?>> {{ $code['name'].'-'. $code['dial_code'] }}</option>
                                @endforeach
                            </select>
                            </div>
                            <div class="col-sm-4">
    ...
    -->
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-sm-offset-1 col-form-label text-md-right">
                                {{ __('Password') }} <span style="color:#bca504">*</span>
                            </label>
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                <span style="color:#bca504">(Password should be at least 8 characters in length and should include at least one upper case letter, one number, and one special character.)</span>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-sm-offset-1 col-form-label text-md-right">{{ __('Confirm Password') }} <span style="color:#bca504">*</span>
                            </label>
                            <div class="col-md-6">
