...
<div id="content-page" class="content-page">
    <div class="d-flex">
    <a class="black" href="{{ URL::to('channel/artists') }}">All Artists</a>
    <a class="black" style="background:#fafafa!important;color: #006AFF!important;" href="{{ URL::to('channel/artists/create') }}">Add New Artist</a></div>
    <!-- This is where -->
    <div class="iq-card">
        <!--<ol class="breadcrumb"> <li> <a href="{{ Url::to('/channel/artist_list') }}"><i class="fa fa-newspaper-o"></i>Manage Artist</a> </li> <li class="active">@if(!empty($artist->id)) <strong>{{ $artist->name }}</strong> @else <strong>Create Artist</strong> @endif</li> </ol>-->
...
<script>
    $('form[id="artist_form"]').validate({
        rules: {
            ...
            artist_slug: {
                    remote: {
                        url:"{{ URL::to('channel/artist_slug_validation') }}",
                        type: "get",
                        data: {
                            _token: "{{csrf_token()}}" ,
