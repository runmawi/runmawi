...
<div class="admin-section-title">
    ...
    <a class="black" href="{{ URL::to('channel/artists/create') }}">Add New Artist</a></div>
	...
	<div class="row mt-3">
        ...
        <div class="col-md-3 text-right">
             <a href="{{ URL::to('channel/artists/create') }}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create Artist</a>
        </div>
	</div>
		...
		<tr>
			...
			<td>
				<p class=" align-items-center list-user-action">
					<a href="{{ URL::to('channel/artists/edit') . '/' . $artist->id }}" class="iq-bg-warning"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"> </a>
					<a href="{{ URL::to('channel/artists/delete') . '/' . $artist->id }}" onclick="return confirm('Are you sure?')" class="iq-bg-danger"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"></a>
				</p>
			</td>
		</tr>
		@endforeach
