                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="embed_url" value="<?php echo URL::to('/channel/embededcode');?>">
                            <input type="hidden" id="mp4url" value="<?php echo URL::to('/channel/mp4url');?>">
                            <input type="hidden" id="m3u8url" value="<?php echo URL::to('/channel/m3u8url');?>">
                        </div>
                    <hr />
                </div>
