               ...
               <div class="row">
                   <div class="col-sm-6 form-group mt-3" id="ppv_price">
                     ...
                     <div class="col-sm-6 form-group mt-3" id="ppv_price">
                        ...
                        <input type="text" id="tag-input1" class="tagged form-control1" data-removeBtn="true" name="searchtags" >                     <!-- <input type="text" class="form-control" id="#inputTag" name="searchtags" value="" data-role="tagsinput"> -->
                     </div>
...
<script type="text/javascript">
   ...
   if (($("#page").val() == 'Edit') && ($("#status").val() == 0)) {
   	setInterval(function(){ 
   		$.getJSON('<?php echo URL::to("/channel/get_processed_percentage/");?>'+'/'+$("#id").val(), function(data) {
