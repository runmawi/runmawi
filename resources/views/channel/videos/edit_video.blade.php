        ...
        <div class="mt-5 d-flex">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <input type="hidden" id="embed_url" value="<?php echo URL::to('/channel/UpdateEmbededcode');?>">
                  <input type="hidden" id="mp4url" value="<?php echo URL::to('/channel/Updatemp4url');?>">
                  <input type="hidden" id="m3u8url" value="<?php echo URL::to('/channel/Updatem3u8url');?>">
