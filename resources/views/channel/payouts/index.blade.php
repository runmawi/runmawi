        ...
        <div class="col-md-12">
            <div class="iq-card-header  justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Channel Partners Payouts :</h4>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($last_paid_amount as $keys => $paid_amount)
                                                @if ($payout->channel_id == $keys && $paid_amount  )
                                                    {{ $paid_amount }}
                                                    <!-- @break -->
                                                    @break
                                                @else                                
                                        ...
                                        <!-- <td>{{ @$last_paid }}</td>    -->
                                        <td>
                                            <a href="{{ URL::to('/admin/channel/view_payouts/') }}/{{ $payout->channel_id }}"  class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="Edit"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/view.svg';  ?>"></a>
                                            <a href="{{ URL::to('/admin/channel/edit_payouts/') }}/{{ $payout->channel_id }}"  class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
