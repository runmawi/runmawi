...
<div id="content-page" class="content-page">
    ...
    <div class="d-flex">
		<a class="black" style="background:#fafafa!important;color: #006AFF!important;" href="{{ URL::to('channel/live-event-artist') }}">All Live Event Artist Videos</a>
		<a class="black"  href="{{ URL::to('channel/live-event-create') }}">Add New Live Event Artist Videos</a>
	</div>
         	...
         	<div class="iq-card">
				<div class="row">
					...
					<div class="col-md-6" align="right">	
						<a href="{{ URL::to('channel/live-event-create') }}" class="btn btn-primary mb-3"><i class="fa fa-plus-circle"></i> Add New</a>
					</div>
				</div>    
			...
			<table class="data-tables table livestream_table iq-card text-center p-0" style="width:100%">
				...
				<tbody>
					...
					<tr>
						...
						<?php if($video->active == 0 || $video->active == 1 && $video->status == 0){ ?>
                        	<td> <p class = "bg-warning video_active"><?php echo "Pending"; ?></p></td>
						<?php }elseif($video->active == 1 && $video->status == 1){ ?>
						...
						<td class=" align-items-center list-inline">								
                            <!-- <a href="{{ URL::to('channel/live_event_play',$video->slug ) }}" target="_blank" class="iq-bg-warning"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/view.svg';  ?>"></a> -->
							<a href="{{  URL::to('channel/live-event-edit' ,$video->id)  }}" class="iq-bg-success ml-2 mr-2"><img class="ply " src="<?php echo URL::to('/').'/assets/img/icon/edit.svg';  ?>"></a>
							<a href="{{  URL::to('channel/live-event-destroy' ,$video->id)  }}" onclick="return confirm('Are you sure?')" class="iq-bg-danger"><img class="ply" src="<?php echo URL::to('/').'/assets/img/icon/delete.svg';  ?>"></a>
						</td>
					</tr>
					@endforeach
				</tbody>
