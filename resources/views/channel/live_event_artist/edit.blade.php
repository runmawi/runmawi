...
<div id="content-page" class="content-page">
     <div class=" d-flex">
        <a class="black" href="{{ URL::to('channel/live-event-artist') }}">All Live Event Artist Videos</a>
        <a class="black" href="{{ URL::to('channel/livestream/create') }}">Add New Live Event Artist Videos</a>
    </div>
