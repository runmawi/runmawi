<?php if(isset($videos)) :
            foreach($videos as $slider_video): ?>
    <?php 
        $i = 1;
             ...
             <div class="row h-100">
                <div class="col-xl-6 col-lg-12 col-md-12">
                   ...
                   <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft"
                      data-delay-in="0.6"><?php echo __($slider_video->title); ?></h1>
                   <div class="d-flex align-items-center" data-animation-in="fadeInUp" data-delay-in="1">
                      <span class="badge badge-secondary p-2"><?php echo __($slider_video->year); ?></span>
<!--                      <span class="ml-3"><?php echo __($slider_video->language); ?></span>-->
                   </div>
                   <div data-animation-in="fadeInUp" data-delay-in="1.2" style="overflow: hidden !important;text-overflow: ellipsis !important;height: 90px; margin-bottom: 20px;">
                    <?php echo __($slider_video->description); ?>
                   </div>
                   <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp" data-delay-in="1.2">
                      <a href="<?php echo URL::to('category') ?><?= '/videos/' . $slider_video->slug ?>" class="btn btn-hover"><i class="fa fa-play mr-2"
             ...
             <div class="trailor-video">
                <a href="<?php echo URL::to('category') ?><?= '/videos/' . $slider_video->slug ?>" class="video-open playbtn">
