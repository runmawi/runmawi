                          ...
                          <a  href="<?php echo URL::to('category') ?><?= '/videos/' . $cont_video->slug ?>">
                             ...
                             <!-- block-images -->
                                <div class="img-box">
                                  ...
                                  <img src="<?php echo URL::to('/').'/public/uploads/images/'.$cont_video->player_image;  ?>" class="img-fluid lazy" alt="">
                                  <!--   <video width="100%" height="auto" class="play-video lazy" poster="<?php echo URL::to('/').'/public/uploads/images/'.$cont_video->player_image;  ?>"  data-play="hover" >
