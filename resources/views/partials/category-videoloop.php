        ...
        <div class="col-sm-12 overflow-hidden">
            <div class="iq-main-header d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo URL::to('/category/').'/'.$category->slug;?>" class="category-heading" style="text-decoration:none;color:#fff" >
                    <h4  class="movie-title"><?php echo __($category->name);?></h4>
                </a>
            </div>
                     ...
                     <div class="block-images position-relative">
                        ...
                        <div class="block-description">
                           ...
                           <div class="hover-buttons">
                               <a type="button" class="btn btn-primary" href="<?php echo URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">
...
-->
  ...
  <?php  if(isset($videos)) :
              ...
              <div class="modal fade bd-example-modal-xl4<?= $latest_video->id;?>" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
          ...
          <div class="modal-body playvid">
                             <?php if($latest_video->type == 'embed'): ?>
                                    ...
                                    <?php  elseif($latest_video->type == 'file'): ?>
                                        <div id="video_container" class="fitvid">
                                        <video id="videojs-seek-buttons-player"  onplay="playstart()"  class="video-js vjs-default-skin" controls preload="auto" poster="<?= URL::to('/public/') . '/uploads/images/' . $latest_video->image ?>"  data-setup='{ "playbackRates": [0.5, 1, 1.5, 2] }' width="100%" style="width:100%;" data-authenticated="<?= !Auth::guest() ?>">
                                    ...
                                    <?php  else: ?>
                                        ...
                                        <video id="videojs-seek-buttons-player" onplay="playstart()"   class="video-js vjs-default-skin" controls preload="auto" poster="<?= Config::get('site.uploads_url') . '/images/' . $latest_video->image ?>"  data-setup='{ "playbackRates": [0.5, 1, 1.5, 2] }' width="100%" style="width:100%;" data-authenticated="<?= !Auth::guest() ?>">
 ...
 <?php endforeach; 
		...
		<a class="block-thumbnail-trail" href="<? URL::to('category') ?><?= '/videos/' . $latest_video->slug ?>" >
				...
				<?php if (!empty($latest_video->trailer)) { ?>
                        <video class="trail-vid" width="30%" height="auto" class="play-video" poster="<?php echo URL::to('/').'/public/uploads/images/'.$latest_video->image;  ?>" data-play="hover" muted="muted">
