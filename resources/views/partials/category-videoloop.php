          ...
          <p class="p-tag">FREE!</p>
                                ...
                                <div class="block-description">
                                    ...
                                    <div class="hover-buttons">
                                        <a type="text-white" class="text-white"
                                            href="<?php echo URL::to('category') ?><?= '/videos/' . $category_video->slug ?>">
                                     ...
                                     <div>
                        <a class="text-white" href="<?php echo URL::to('category') ?><?= '/wishlist/' . $category_video->slug ?>" ><i class="fa fa-plus" aria-hidden="true"></i> Add to Watchlist
                       </a>
                    </div>
                                    
                                     <!--btn btn-primary btn-hover <div class="block-social-info">
                            ...
                            <div class="block-images position-relative">
                                ...
                                <div class="block-description">
                                    ...
                                    <div class="hover-buttons">
                                     ...
                                     <div>
                         <a class="text-white"><i class="fa fa-plus" aria-hidden="true"></i> Add to Watchlist
                       </a>
                    </div>
                                    <!--
                           <div>
