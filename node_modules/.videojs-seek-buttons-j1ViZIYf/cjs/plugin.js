...
var Button = _video.default.getComponent('Button'); // Default options for the plugin.
...
seekButtons.VERSION = _package.version;
/**
...
var SeekButton = /*#__PURE__*/function (_Button) {
  (0, _inheritsLoose2.default)(SeekButton, _Button);
...
_video.default.registerComponent('SeekButton', SeekButton); // Register the plugin with video.js.


registerPlugin('seekButtons', seekButtons);
var _default = seekButtons;
