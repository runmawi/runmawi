...
},{"./settings-menu-item.js":4}],4:[function(require,module,exports){
(function (global){
/**
...
var _srcComponentsSettingsMenuButton = require('../src/components/settings-menu-button');

var _srcComponentsSettingsMenuButton2 = _interopRequireDefault(_srcComponentsSettingsMenuButton);

var _srcComponentsSettingsMenuItem = require('../src/components/settings-menu-item');

var _srcComponentsSettingsMenuItem2 = _interopRequireDefault(_srcComponentsSettingsMenuItem);

_qunit2['default'].module('videojs-settings-menu', {
...
_qunit2['default'].test('It registers the settings menu button component', function (assert) {
  assert.expect(1);

  assert.strictEqual(_videoJs2['default'].getComponent('SettingsMenuButton'), _srcComponentsSettingsMenuButton2['default'], 'Settings menu button was registered');
});

_qunit2['default'].test('It registers the settings menu item component', function (assert) {
  assert.expect(1);

  assert.strictEqual(_videoJs2['default'].getComponent('SettingsMenuItem'), _srcComponentsSettingsMenuItem2['default'], 'Settings menu item was registered');
});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"../src/components/settings-menu-button":3,"../src/components/settings-menu-item":4,"global/document":2}]},{},[5]);
