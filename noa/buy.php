...
if ($conn->connect_error) {
    ...
    $check_video_id="97";  /// TEST VIDEO 97
    $check_user_id = "219636"; // 8131883976 NOA USERID 196861, 219620 - TEST USER 8131883970   195777, (219636 - 8131883902, 8131883901 - 219635)
    $check_ppv_plan ="720p";
    $pay_by="noa";
   ...
   $sql = "INSERT INTO ppv_purchases (user_id, video_id, to_time, total_amount, admin_commssion, moderator_commssion, status, created_at, updated_at, moderator_id, payment_gateway, platform, ppv_plan, payment_id)
    ...
    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully $created_at ";
    } else {
