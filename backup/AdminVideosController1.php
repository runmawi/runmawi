...
class AdminVideosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($mp4_url != '') {   
              ...
              //upload new file
              $file = $mp4_url;
              $mp4_url1  = $file->getClientOriginalName();
              $file->move($path, $mp4_url1);
            
              $data['mp4_url']  = URL::to('/').'/public/uploads/videos/'.$file->getClientOriginalName();
...
//        VideoSubtitle::where('video_id', '=', $id)->delete();
    ...
    public function update(Request $request)
    {
        ...
        $video = Video::findOrFail($id);
           ...
           $image = (isset($data['image'])) ? $data['image'] : '';
           $trailer = (isset($data['trailer'])) ? $data['trailer'] : '';
           $mp4_url2 = (isset($data['video_upload'])) ? $data['video_upload'] : '';
           $files = (isset($data['subtitle_upload'])) ? $data['subtitle_upload'] : '';
